...
<div id="<?= $modal_id ?>" tabindex="-1" aria-hidden="true" class="flex h-full flex-grow hidden"  onclick="closeModalById('<?= $modal_id ?>')">
    <div class="mx-auto w-full max-w-xl ">
        <div onclick="event.stopPropagation()">
            <div class="mx-auto px-2 max-w-sm pt-20 lg:px-8 flex justify-between items-center ">
                ...
                <button type="button" class="text-gray-800 dark:text-gray-500 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="authentication-modal" onclick="closeModalById('<?= $modal_id ?>')">
