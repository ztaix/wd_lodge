                        ...
                        <div class="text-gray-700 dark:text-gray-400  bg-white border border-gray-200 rounded-lg dark:bg-slate-800 dark:border-gray-800">
                            ...
                            <div class="px-4">
                                ...
                                <div id="booking_details_customer_block_toedit" class="flex space-x-4 my-2 group cursor-pointer">
                                    ...
                                    <div class="w-full font-medium text-slate-400 dark:text-gray-500">
                                ...
                                <p class="text-xs italic text-slate-400 dark:text-slate-500 flex justify-between mx-2">
                                ...
                                <div id="booking_details_fullblocked_div" class="w-full inline-flex justify-between text-base border-b-2 ">
                                    <h5 id="booking_details_service_h5" class="flex items-center justify-start ml-2 text-lg font-extrabold text-gray-700 dark:text-gray-400">Titre du service</h5>
                                    <h5 id="booking_details_fullblocked_h5" class=" flex items-center justify-end mr-2 text-lg font-extrabold text-red-300 dark:text-red-500">FullBlocked</h5>
                                </div>
                                ...
                                <div class="flex items-center justify-between text-base text-gray-700 dark:text-gray-400 my-2">
                                    ...
                                    <div class="inline-flex w-full h-6 bg-slate-300 rounded-lg dark:bg-gray-700">
                                        <div id="booking_details_progress_div" class="bg-green-600 text-xs font-medium text-green-100 text-center p-0.5 leading-none rounded-lg h-full flex items-center justify-center"></div>
                                        <div id="booking_details_progress_rest_div" class="flex flex-grow text-xs font-medium text-gray-500 text-center p-0.5 leading-none rounded-lg h-full items-center justify-center"></div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center justify-between text-base my-2">
                                    ...
                                    <span id="booking_details_end_span" class="ml-3"></span>
                                </div>

                                <p class="text-basemy-2">
