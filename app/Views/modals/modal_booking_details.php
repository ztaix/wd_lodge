...
<div id="<?= $modal_id ?>" tabindex="-1" aria-hidden="true" class="fixed max-w-md lg:max-w-lg flex flex-grow hidden top-0" >
    <div class="relative  mx-auto">
        ...
        <div class="px-2 py-2 lg:px-8 flex justify-between items-center bg-white rounded-b-lg shadow-md ">
            ...
            <!-- Modal Body -->
        <div class="flex justify-center px-4 pb-4 sm:px-9 sm:pb-9">
            ...
            <div class="flex flex-col">
                ...
                <div class="bg-white border border-gray-200 rounded-lg dark:bg-slate-800 dark:border-gray-800 shadow-2xl">
                    ...
                    <div id="booking_details_div_img" class="flex justify-center items-center rounded-t">
                    ...
                    <div class="px-4">
                        ...
                        <p class="flex items-center justify-between text-base text-gray-700 dark:text-gray-400 my-2">
                            ...
                            <span class='text-xs italic text-slate-300 dark:text-slate-400'>(taxe voyageur et frais de ménages inclus)</span>
                        </span>
                        </p>
