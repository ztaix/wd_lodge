        ...
        <div class="h-full overflow-scroll">
            ...
            <div class="px-6 py-6 lg:px-8 flex justify-between items-center">
                ...
                <div class="flex-grow text-center">
                    <h3 class="text-center text-2xl font-bold text-gray-800 dark:text-white">Modifier Service</h3>
                </div>    
                <div >
            ...
            <div class="h-full overflow-scroll px-4 py-2 bg-slate-200">
                <h3 id="modal-title_edit_service" class="flex items-center text-lg leading-6 font-medium"><!-- JavaScript  --></h3>
                <div class="relative shadow rounded-lg mb-3">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody id="ServiceDetailsContainer">
