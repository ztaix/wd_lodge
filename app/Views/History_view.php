        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    <button type="button" onclick="openModal('addEventModal')" class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                    ...
                    <div class="flex items-center space-x-3 w-full md:w-auto">
                        ...
                        <div id="filterDropdown" class="z-10 w-48 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600 hidden" 
                        style="position: absolute; margin-top: 6rem; right: 10px">
                ...
                <table id="history_list" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">Début</th>
                    ...
                    <div id="items-container">
                        <tbody>
                            ...
                            ?>
                            <tr class="border-b dark:border-gray-700 row_booking service_<?= $booking['Service_id']; ?>"
                                ...
                                <td class="px-4 py-3"><?= sql_date_to_dmY($booking['start']); ?></td>
                                <td class="px-4 py-3"><?= sql_date_to_dmY($booking['end']); ?></td>
