...
async function showBookingDetailsFromID(i) {
  ...
  let n;
  try {
    const f = await window.ajaxCall(
      'booking/getBookingFromID?id=' + encodeURIComponent(i),
      'GET',
      null
    );
    f.success
      ? (n = f.data)
      : (showBanner(f.message, !1), console.error(f.message));
  } catch (e) {
    showBanner(e.message, !1), console.error('Échec getBookingsFromID: ', e);
  }
  let t = n.paids_values ? n.paids_values.split(',').map(Number) : [0],
    r = t.reduce((e, t) => e + t, 0),
    i = document.getElementById('booking_details_Type_doc'),
    o =
      ((i.innerHTML = `<span class="text-md font-bold tracking-tight p-2" >${n.Type_doc} # ${n.id}</span> `),
      i.classList.add('rounded-md'),
      'Devis' === n.Type_doc
        ? i.classList.add(
            'bg-slate-400',
            'text-slate-800',
    ...
    s = document.getElementById('booking_details_fullblocked_h5'),
    a =
      (1 == n.fullblocked
        ? (o.classList.add('border-red-300', 'dark:border-red-500'),
          (s.style.display = 'block'),
          (s.innerText = 'Privatisé'))
        : (o.classList.remove('border-red-300', 'dark:border-red-500'),
  ...
  if (((l.innerText = 0 < r ? r + ' Fr' : '0'), 0 < r)) {
    ...
    l.style.width = 24 < e ? e + '%' : '24px';
  } else l.style.width = '24px';
  var c;
  ...
  let d = document.getElementById('booking_details_comment_span'),
    u = d.parentElement,
    h =
      ((d.innerText = n.Comment),
      0 < n.Comment.length
    ...
    o =
      ((i.onclick = function () {
        ajaxCall('booking/deleteBooking', 'POST', { id: t }, function (e) {
          if (!0 === e.success) {
            if ((calendar.refetchEvents(), ModalInStack('ListEventModal'))) {
              document
...
function updateCustomerinfo(t = null) {
...
function updateCustomerFields(n) {
  ...
  e.forEach(({ modal: e, prefix: t }) => {
    ModalInStack(e) &&
      (r(t + '_name_span', n.Name),
      r(t + '_phone_span', n.Phone),
      r(t + '_email_span', n.Email),
      r(t + '_comment_span', n.Comment));
  });
}
  ...
  let t = document.getElementById('ConfirmDeleteModal'),
    ...
    i =
      ((r.onclick = function () {
        ...
        ajaxCall('customer/update', 'POST', { customer_info: t }, function (e) {
          !0 === e.success
            ? (showBanner('Suppression réalisée avec succès', !0),
              ModalInStack('updateCustomerModal') &&
                closeModalById('updateCustomerModal'),
