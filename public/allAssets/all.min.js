async function ajaxCall(t, e, n, r, i) {
  var o,
  ...
  if ('GET' !== e) o = JSON.stringify(n);
  else if (n) {
    let e = new URLSearchParams(n).toString();
    'null=' === e && (e = ''), (t += '?' + e);
  }
  return fetch(baseurl + t, {
    method: e,
    headers: s,
    body: 'GET' !== e ? o : null,
  })
    ...
    .then((e) => ('function' == typeof r && r(e), e))
    .catch((e) => {
      var t, n;
      return (
        401 === e.status
          ...
          : 'function' == typeof i
            ? i(e)
            : ((n = e.error || 'Erreur lors de la requête réseau'),
              showBanner(n, !1)),
        Promise.reject(e)
      );
    });
...
function totalBookingPriceCal(e, t, n, r, i) {
  let o = parseInt(e) + parseInt(t) * parseInt(n) * parseInt(i) + parseInt(r);
  return o;
}
function sumArray(e) {
  let t = e ? e.split(',').map(Number) : [0],
    n = t.reduce((e, t) => e + t, 0);
  return n;
}
function lightenHexColor(e, t) {
  let n = parseInt(e.substring(1, 3), 16),
    ...
    s = r.toString(16).padStart(2, '0'),
    a = i.toString(16).padStart(2, '0');
  return '#' + o + s + a;
}
async function existFile(e) {
  try {
    const t = await fetch(e),
      n = t.headers.get('Content-Type');
    if (n && n.includes('image')) return !0;
  } catch (e) {
    return console.log('Erreur lors de la requête:', e), !1;
  }
}
function check_date(e) {
  ...
  if (!n) return console.log('Erreur, Format de date invalide');
  if ('DD/MM/YYYY' === n) {
    const [o, s, a] = e.split('/');
    e = `${a}-${s}-` + o;
  } else if ('DD-MM-YYYY' === n) {
    const [l, c, d] = e.split('-');
    e = `${d}-${c}-` + l;
  }
  let i;
  if ('DD/MM/YYYY' === n || 'DD-MM-YYYY' === n || 'YYYY-MM-DD' === n) {
    const [u, h, p] = e.split('-');
    i = new Date(u, h - 1, p);
  } else {
    const f = e.split(/[- :]/);
    i = new Date(f[0], f[1] - 1, f[2], f[3] || 0, f[4] || 0, f[5] || 0);
  }
  return i instanceof Date && !isNaN(i.getTime())
    ? i
    : (console.log('Erreur, Format de date invalide ou date invalide'), null);
}
function format_date(e, t = 0, n = !1, r = !1) {
  let i = check_date(e);
  if (!i) return 'Date invalide';
  if ((i.setDate(i.getDate() + t), r)) return i;
  let o = String(i.getDate()).padStart(2, '0'),
    s = String(i.getMonth() + 1).padStart(2, '0'),
    a = i.getFullYear(),
    l = String(i.getHours()).padStart(2, '0'),
    c = String(i.getMinutes()).padStart(2, '0');
  return (
    (result =
      !0 === n
        ? shortenYearInDate(`${o}-${s}-` + a)
        : 'HH:MM DD/MM/YY' == n
          ? `${l}h${c} ${o}/${s}/` + a
          : 'DD-MM' == n
            ? o + '-' + s
            : 'DD/MM' == n
              ...
              : 'DD/MM/YYYY' == n
                ...
                : 'DD' == n
                  ? '' + o
                  : 'DD-Mois-YY' == n
                    ? `${o} ${moisFrancais[s].substring(0, 3)}. ` + a
                    : 'DD-Mois' == n
                      ? ` ${o} ` + moisFrancais[s]
                      : 'Mois' == n
                        ? moisFrancais[s]
...
function DaysDifferenceStartEnd(e, t) {
  let n = check_date(e),
    r = check_date(t),
...
function shortenYearInDate(e) {
  let t = e.split('-'),
    n = t[2].substring(2);
  return `${t[0]}-${t[1]}-` + n;
}
function format_date_toSql(e) {
  let [t, n, r] = e.split('-');
  return `${r}-${n}-${t} 00:00:00`;
}
...
function updateCountdown(o) {
  let s = document.getElementById('footer_ttl');
  countdownInterval = setInterval(function () {
    o--;
    const e = Math.floor(o / 86400),
      t = Math.floor((o % 86400) / 3600),
      n = Math.floor((o % 3600) / 60),
      r = Math.floor(o % 60);
    let i;
    (i =
      0 < e
        ...
        : 0 < t
          ...
          : 0 < n
            ? n + 'min' + (0 < r ? ' et ' + r + 's' : '')
            : r + 's'),
      (s.textContent = 'Temps restant : ' + i),
      o <= 0 &&
        (clearInterval(countdownInterval), (s.textContent = 'Temps écoulé!'));
  }, 1e3);
}
function availableListServices(e, t, n) {
  let r = [];
  const i = format_date(e, 0, !1, !0),
    o = n.some(
      (e) =>
        '1' === e.fullblocked &&
        i >= format_date(e.start, 0, !1, !0) &&
        i < format_date(e.end, 0, !1, !0)
    ),
    s = n.some(
      (e) =>
        i >= format_date(e.start, 0, !1, !0) &&
  ...
  if (o) r = [];
    ...
    const a = n.reduce(
      (e, t) => (format_date(t.end, 0, !1, !0) > i && e.add(t.Service_id), e),
      new Set()
    );
    r = t.filter(
      (t) =>
        ...
        (!a.has(t.Service_id) ||
          n.some(
            (e) =>
              ...
              format_date(e.end, 0, !1, !0) === i
          ))
    );
  }
  return r;
}
function updatePayments(e, l) {
  ajaxCall('paids/upsert', 'POST', { payments: e }, function (r) {
    if (!0 === r.success) {
      let t = !0,
        n = [];
      for (var i in r.data)
        if (r.data.hasOwnProperty(i)) {
          let e = r.data[i];
          e.success || (t = !1),
            e.errors && 0 < e.errors.length && n.push(...e.errors);
        }
      if (t) {
        var o,
          s,
          a = 0;
        for (o in r.data)
          r.data.hasOwnProperty(o) &&
            ((s = r.data[o].data.value),
            isNaN(parseFloat(s)) || (a += parseFloat(s)));
        let e = Object.keys(l);
        (l[e[0]].encaissement = a), finalizeUpdate(l);
      } else
        showBanner('Echec de la mise à jour des paiements !', !1),
          console.log('Erreurs: ', n);
    }
  });
}
function finalizeUpdate(e) {
  updateModal(e),
    closeModalById('addEventModal'),
    calendar && calendar.refetchEvents(),
    showBanner('Evènement mis à jour avec succès !', !0);
}
function showDateCalendarFromClic(r) {
  ajaxCall('booking/getBookingsFromDate', 'GET', { date: r })
    .then((e) => {
      const t = format_date(r),
        n = format_date(r, 1);
      e.success && 0 < e.data.events.length
        ? showBookingList(e.data.events, r)
        : (resetForm('addEventModal', t, n),
          updateTotalInfo(),
          updatePrice(),
          openModal('addEventModal'));
    })
    .catch(({ error: e }) => {
      console.error('Erreur lors de la requête AJAX: ', e);
    });
}
function customerDocType(e) {
  currentDocType = 'Facture' === currentDocType ? 'Devis' : 'Facture';
  var t = document.getElementById('customerDocType_bgtoggleDot');
  'Devis' === currentDocType
    ? t.classList.add('devis')
    : t.classList.remove('devis'),
    setTimeout(function () {
      get_booking_list_from_customer(e);
    }, 350);
}
function verifyToken(e = !1) {
  (extending = e ? '?extend=true' : ''),
    ajaxCall(
      ...
      function (e) {
        e.success
          ? (localStorage.setItem('timeLeft', e.timeLeft),
            startTokenCountdown())
          : showBanner(e.message, !1);
      },
      function (e, t, n) {
        console.error('Token invalide ou erreur lors de la vérification:', n);
      }
    );
}
function urlLocation() {
  let e = window.location.href.split('?')[0].split('/'),
    t = e.pop() || e.pop(),
    n = t.toLowerCase().replace(/[^a-z0-9]/g, '');
  return (
    (n =
      '' == n || 'public' == n || baseurl == window.location.href
        ? 'calendar'
        : n),
    n
  );
...
function showBanner(e, t) {
  const n = document.getElementById('banner_update'),
    r = document.getElementById('banner_update-text');
  (r.innerHTML += '<p>' + e + '</p>'),
    (n.style.backgroundColor = t
      ? 'rgba(0, 128, 0, 0.9)'
      : 'rgba(255, 0, 0, 0.9)'),
    n.classList.remove('banner_update-exit'),
    n.classList.add('banner_update-visible'),
    setTimeout(() => {
      n.classList.remove('banner_update-visible'),
        n.classList.add('banner_update-exit'),
        (r.innerHTML = '');
    }, 3500);
}
function showSearch() {
  const e = document.getElementById('SearchListEventModal');
  e.classList.add('banner_search-visible'),
    e.classList.remove('hidden'),
    (e.style.display = 'flex');
}
async function resetForm(r, i = !1, o = !1, s = !1) {
  if ('addEventModal' == r) {
    const a = [
      'Modaleventid',
      'ModaleventType_doc',
    ...
    a.forEach((e) => {
      'ModaleventType_doc' == e
        ? ((document.getElementById(e).value = 'Devis'),
          (document.getElementById(e).checked = !1))
        : 'ModaleventQtTraveller' == e || 'ModaleventQt' == e
          ? (document.getElementById(e).value = 1)
          : 'payments-subcontainer' == e
            ? (document.getElementById(e).innerText = '')
            : 'Modaleventfullblocked' == e ||
                1 == document.getElementById(e).value
              ? (document
                  .getElementById(r)
                  .classList.remove(
                    'border',
                ...
                (document.getElementById(e).checked = !1))
              : 'ModaleventService_id' == e
                ? s
                  ? (document.getElementById(e).value = s)
                  : ((s = discountservice[0].Service_id),
                    (document.getElementById(e).value =
                      discountservice[0].Service_id))
                : 'ModaleventCustomer_id' == e
    ...
    let e = '',
      ...
      n =
        (i || o
          ? i && !o
            ? ((e = i), (t = format_date(e, 1)))
            : i && o && ((e = i), (t = o))
          : ((e = format_date(getToday())), (t = format_date(e, 1))),
        document.querySelectorAll('div[id^="temp_"]'));
    0 < n.length &&
      n.forEach((e) => {
        e.parentNode.removeChild(e);
      }),
      await loadAndInitDatepicker(s, e, t);
  }
}
function openModal(e) {
  if (!isAnimating) {
    ...
    let t = document.getElementById(e),
      n = document.getElementById(e + '-shadow_modal');
    if (t) {
      let e = currentZIndex;
      if (
        (modalStack[modalStack.length - 1] &&
          modalStack[modalStack.length - 1].style &&
          (e = modalStack[modalStack.length - 1].style.zIndex),
        (n.style.zIndex = parseInt(e) + 1),
        n.classList.add('animate_shadow_modal'),
        n.classList.remove('close-animate_shadow_modal'),
        n.classList.remove('hidden'),
        (t.style.zIndex = parseInt(e) + 2),
        t.classList.add('animate'),
        t.classList.remove('close-animate'),
        t.classList.remove('hidden'),
        0 < modalStack.length)
      ) {
        let e = modalStack[modalStack.length - 1];
        e.classList.add('blur-lg');
      }
      (currentZIndex += 1), modalStack.push(t), ShadowmodalStack.push(n);
    }
    e = document.getElementById(urlLocation());
    e.classList.add('blur-lg'),
...
function closeModal() {
  ...
  isAnimating ||
    ...
    1 < modalStack.length
      ? ((e = modalStack.pop()),
        (t = ShadowmodalStack.pop()),
        (n = modalStack[modalStack.length - 1]),
        e.classList.add('close-animate'),
        e.classList.remove('animate'),
        t.classList.add('close-animate_shadow_modal'),
        t.classList.remove('animate_shadow_modal'),
        n.classList.remove('blur-lg'),
        setTimeout(() => {
    ...
    0 === modalStack.length &&
      ((n = document.getElementById(urlLocation())),
      n.classList.remove('blur-lg'),
...
function closeModalById(n) {
  if (!isAnimating) {
    isAnimating = !0;
    let e = document.getElementById(n),
      t = document.getElementById(n + '-shadow_modal');
    if (e)
      if (
        (e.classList.add('close-animate'),
        e.classList.remove('animate'),
        ...
        let e = modalStack[modalStack.length - 2];
        e.classList.remove('blur-lg');
      } else {
        var r = document.getElementById(urlLocation());
        r.classList.remove('blur-lg'),
          document.getElementById('footer').classList.remove('blur-lg');
      }
    (modalStack = modalStack.filter((e) => e.id !== n)),
      setTimeout(function () {
        isAnimating = !1;
      }, 350);
  }
...
function closex(e) {
  let t = document.getElementById(e);
  t.classList.remove('banner_update-visible'),
    t.classList.add('banner_update-exit'),
    t.addEventListener(e, function () {
      t.classList.remove('banner_update-exit');
    });
}
function ModalInStack(t) {
  return modalStack.some(function (e) {
    return e.id === t;
  });
}
function shadowUndermodal(e) {
  return `<div id="${e}-shadow_modal" class="fixed inset-0 bg-black opacity-50 hidden" onclick="closeModalById('${e}')"></div>`;
}
function handleAddEventClick(e = !1, t = !1) {
  resetForm('addEventModal', e, !1, t), openModal('addEventModal');
}
function updateCustomersFormFields(e) {
  (document.getElementById('customer_id').value = e.customer_id),
    (document.getElementById('customer_name').value = e.name),
    (document.getElementById('customer_phone').value = e.phone),
    (document.getElementById('customer_email').value = e.email),
    (document.getElementById('customer_comment').value = e.comment);
  let t = document.getElementById('update_customer_submit_form');
  t.onclick = function () {
    updateCustomerinfo();
  };
}
...
function updateModal(e) {
  let t = Object.keys(e),
    n = e[t],
    r = totalBookingPriceCal(n.Price, n.QtTraveller, n.Tax, n.Fee, n.Qt);
  if (
    (ModalInStack('ListEventModal') &&
      isNaN(parseFloat(t)) &&
      ((document.getElementById('booking_total_' + t).innerText = r),
      (document.getElementById('booking_Comment_' + t).innerText = n.Comment),
      (document.getElementById('booking_startDay_' + t).innerText =
        getDayOfWeek(format_date(n.start))),
      (document.getElementById('booking_start_' + t).innerText = format_date(
        n.start,
        0,
        'DD/MM'
      )),
      (document.getElementById('booking_endDay_' + t).innerText = getDayOfWeek(
        format_date(n.end)
      )),
      (document.getElementById('booking_end_' + t).innerText = format_date(
        n.end,
        0,
        'DD/MM'
      )),
      (document.getElementById('booking_title_' + t).innerHTML =
        (services_list.find((e) => e.Service_id === n.Service_id) || {}).Title +
        ' (' +
        DaysDifferenceStartEnd(n.start, n.end) +
        ' nuits)'),
      (document.getElementById('badge_id_' + t).innerText = t),
      (document.getElementById('badge_type_' + t).innerText = n.Type_doc),
      (document.getElementById('booking_paid_' + t).innerText = n.encaissement),
      (document.getElementById('booking_paid_status_' + t).innerHTML =
        n.encaissement >= r
          ? "<b class='text-green-500 dark:text-green-100'>PAYE</b>"
          : n.encaissement < r && 0 < n.encaissement
            ? "<b class='text-orange-500 dark:text-orange-100'>PARTIEL</b>"
            : "<b class='text-red-500 dark:text-red-100'>IMPAYE</b>")),
    ModalInStack('DetailsEventModal'))
  ) {
    let e = document.getElementById('booking_details_progress_rest_div'),
      t =
        (document.getElementById('booking_details_customer_name_span'),
        n.encaissement < r
          ? (e.innerText = r - n.encaissement + ' Fr')
          : e.classList.add('hidden'),
        document.getElementById('booking_details_progress_div'));
    if (
      ((t.innerText = 0 < n.encaissement ? n.encaissement + ' Fr' : '0'),
      0 < n.encaissement)
    ) {
      let e = Math.min(Math.round((n.encaissement / r) * 1e4) / 100, 100);
      t.style.width = 24 < e ? e + '%' : '24px';
    } else t.style.width = '24px';
  }
}
function applyScrollAnimation() {
  document.querySelectorAll('.scroll-container').forEach((e) => {
    const t = e.querySelector('.scroll-text_smooth');
    t && t.offsetWidth > e.offsetWidth
      ? t.classList.add('animate-text')
      : t.classList.remove('animate-text');
  });
}
function generateSearchRows(e, t) {
  let n = format_date(e.start.slice(0, 10)),
    r = format_date(e.end.slice(0, 10)),
    i = totalBookingPriceCal(e.Price, e.QtTraveller, e.Tax, e.Fee, e.Qt),
    o = generateStatusPaid(e.total_paid, i);
  const s =
    t % 2 == 0
...
function handleSearchInput() {
  const e = document.getElementById('default-search').value.trim(),
    t = document.getElementById('searchResults');
  e ? performSearch(e, t) : clearSearchResults(t);
}
...
function updateClassList(e, t, n) {
  e.classList.remove(...n), e.classList.add(...t);
}
function performSearch(t, n) {
  ajaxCall('booking/search', 'GET', { text: t }, (e) => {
    (n.innerHTML = ''),
      'success' === e.status && 0 < e.data.length
        ? ((n.innerHTML = e.data
            .map((e, t) => generateSearchRows(e, t))
            .join('')),
          updateClassList(
            n,
        ...
        : ((n.innerHTML = `<div class='p-4 bg-white dark:bg-slate-700 shadow-lg animate'>Aucun résultat trouvé pour: <b>${t}</b></div>`),
          updateClassList(
            n,
            ['animate', 'bg-white', 'dark:bg-slate-700', 'shadow-lg'],
            ['close-animate']
...
function generateStatusPaid(e, t) {
  let n = '',
    r = '',
    i = parseInt(t),
    o = parseInt(e);
  return (
    (r =
      o >= i
        ? ((n = "<b class='text-green-600 dark:text-green-200'>PAYÉ</b>"),
          'green')
        : 0 < o
          ? ((n =
              "<b class='text-orange-600 dark:text-orange-200'>PARTIEL</b>"),
            'orange')
          : ((n = "<b class='text-red-600 dark:text-red-200'>IMPAYÉ</b>"),
            'red')),
    { html: n, color: r }
  );
}
function header_modal(e, t) {
  return (html = `
...
async function showBookingDetailsFromID(e = 0) {
  let t = empty(e) ? 0 : e;
  openModal('DetailsEventModal', !1),
    (document.getElementById('header_DetailsEventModal').innerHTML =
      header_modal('Détails réservation', 'DetailsEventModal'));
  let n;
  try {
    const g = await window.ajaxCall(
      'booking/getBookingFromID?id=' + encodeURIComponent(t),
      'GET',
      null
    );
    g.success
      ? (n = g.data)
      : (showBanner(g.message, !1), console.error(g.message));
  } catch (e) {
    showBanner(e.message, !1), console.error('Échec getBookingsFromID: ', e);
  }
  let r = n.paids_values ? n.paids_values.split(',').map(Number) : [0],
    i = r.reduce((e, t) => e + t, 0),
    o = document.getElementById('booking_details_Type_doc'),
    s =
      ((o.innerHTML = `<span class="text-md font-bold tracking-tight p-2" >${n.Type_doc} # ${n.id}</span> `),
      o.classList.add('rounded-md'),
      'Devis' === n.Type_doc
        ? o.classList.add(
            'bg-slate-400',
            'text-slate-800',
      ...
      existFile(baseurl + 'uploads/' + n.img).then((e) => {
        e
          ? (document.getElementById('booking_details_img').src =
              baseurl + 'uploads/' + n.img)
          : (document
            ...
            (document.getElementById('booking_details_div_img').style.height =
              '150px'),
      ...
      (document.getElementById('booking_details_service_h5').innerText =
        n.service_title),
      document.getElementById('booking_details_fullblocked_div')),
    a = document.getElementById('booking_details_fullblocked_h5'),
    l =
      (1 == n.fullblocked
        ? (s.classList.add('border-red-300', 'dark:border-red-500'),
          (a.style.display = 'block'),
          (a.innerText = 'Privatisé'))
        : (s.classList.remove('border-red-300', 'dark:border-red-500'),
          (a.style.display = 'none')),
      (document.getElementById('booking_details_qt_span').innerText = n.Qt),
      ...
      (document.getElementById('booking_details_start_span').innerText =
        format_date(n.start)),
      (document.getElementById('booking_details_end_span').innerText =
        format_date(n.end)),
      (document.getElementById('booking_details_price_span').innerHTML =
        totalBookingPriceCal(n.Price, n.QtTraveller, n.Tax, n.Fee, n.nDays) +
        ' Fr'),
      document.getElementById('booking_details_progress_rest_div')),
    c =
      (parseInt(i) <
      totalBookingPriceCal(n.Price, n.QtTraveller, n.Tax, n.Fee, n.nDays)
        ? (l.innerText =
  ...
  if (((c.innerText = 0 < i ? i + ' Fr' : '0'), 0 < i)) {
    ...
    c.style.width = 24 < e ? e + '%' : '24px';
  } else c.style.width = '24px';
  var d;
  (document.getElementById('booking_details_customer_name').innerText =
    ...
    (document.getElementById('booking_details_customer_created').innerText =
      'Client depuis ' +
      new Date(n.customer_created)
        .toLocaleDateString('fr-FR', { year: 'numeric', month: 'long' })
        .replace(/^\w/, (e) => e.toUpperCase())),
    (document.getElementById('booking_details_created_span').innerHTML =
      'Créé le  ' + format_date(n.Created_at, 0, 'DD/MM/YYYY')),
    (document.getElementById('booking_details_updated_span').innerHTML =
      'Modifié à ' + format_date(n.Updated_at, 0, 'HH:MM DD/MM/YY'));
  let u = document.getElementById('booking_details_comment_span'),
    h = u.parentElement,
    p =
      ((u.innerText = n.Comment),
      0 < n.Comment.length
        ? h.classList.remove('hidden')
        : h.classList.add('hidden'),
      (document.getElementById('booking_details_pdf').href =
        baseurl + 'generatePDF/booking/' + n.id),
      ...
      document
        ...
        .addEventListener('click', function (e) {
          ...
          (t.style.display = 'block'),
            (t.style.zIndex = 999),
            ajaxCall('sendmail/' + n.id, 'GET', null, function (e) {
              console.log(e),
                !0 === e.success
                  ? showBanner('Ok envoyé', !0)
                  : showBanner("Erreur lors de l'envoi", !1),
                (t.style.display = 'none');
            });
        }),
      document.getElementById('booking_details_update_button')),
    f =
      ((p.onclick = function () {
        update_add_formEvent(n);
      }),
      document.getElementById('booking_details_delete_button'));
  f.onclick = function (e) {
    deleteEvent(e, n.id, 'DetailsEventModal');
  };
}
async function update_add_formEvent(t) {
  function createPaymentElement(e, t) {
    const n = t ? t.value : '',
      r = t.paid_id,
      i = `
    ...
    return (o.innerHTML = i), o.firstElementChild;
  }
  openModal('addEventModal');
  let e = document.getElementById('add_submit_form');
  e.onclick = function () {
    updateEventFromDetails();
  };
  try {
    let e = await getPaidFromBookingId(t.id),
      r = document.getElementById('payments-subcontainer');
    (r.innerHTML = ''),
      0 < e.length &&
        e.forEach((e, t) => {
          const n = createPaymentElement(t, e);
          r.appendChild(n);
        });
  } catch (e) {
    console.error('Erreur lors de la récupération des paids: ', e);
  }
  t &&
    (await loadAndInitDatepicker(t.Service_id, t.start, t.end),
    (document.getElementById('addEventModal_title').innerText =
      'Modifier #' + t.id),
    (document.getElementById('Modaleventid').value = t.id),
    (document.getElementById('ModaleventCustomer_id').value = t.Customer_id),
    $('#ModaleventCustomer_id').trigger('change'),
    (document.getElementById('ModaleventService_id').value = t.Service_id),
    loadServiceDetails(t.Service_id),
    (document.getElementById('Modaleventfullblocked').checked =
      1 === parseInt(t.fullblocked)),
    updateFullblocked_RedSwitch(parseInt(t.fullblocked)),
    (document.getElementById('ModaleventQtTraveller').value = parseInt(
      t.QtTraveller
    )),
    (document.getElementById('ModaleventQt').value = t.Qt),
    (document.getElementById('ModaleventNights').innerText = t.Qt + ' Nuit(s)'),
    (TypeDoc = document.getElementById('ModaleventType_doc')),
    (TypeDoc.value = t.Type_doc),
    (TypeDoc.checked = 'Facture' === t.Type_doc),
    updateToggleLabel(TypeDoc.checked),
    (document.getElementById('ModaleventPrice').value = t.Price),
    (document.getElementById('ModaleventComment').value = t.Comment),
    (GlobalEDITING_book = !0),
    updateTotalInfo(),
    updatePrice(GlobalEDITING_book));
}
function deleteEvent(e, t, n = !1) {
  e.stopPropagation(), openModal('ConfirmDeleteModal');
  let r = document.getElementById('ConfirmDeleteModal'),
    i =
      ((r.style.zIndex = '999'),
      document.getElementById('ConfirmDeleteModal_yes_button')),
    o =
      ((i.onclick = function () {
        ajaxCall('booking/deleteBooking', 'POST', { id: t }, function (e) {
          if (!0 === e.success) {
            if (
              (calendar && calendar.refetchEvents(),
              ModalInStack('ListEventModal'))
              ...
              document
                .getElementById('booking_' + t)
                .classList.add('line-through'),
                (document.getElementById('badge_id_' + t).style.cssText =
                  'background-color: gray;'),
                (document.getElementById('booking_a_' + t).style.cssText =
                  'cursor : default;');
              let e = document.querySelectorAll('#booking_a_' + t + ' svg');
              e.forEach(function (e) {
                e.style.color = 'gray';
              });
            }
            if ('history' == urlLocation()) {
              let e = document.querySelector('.row_booking_' + t);
              e &&
                (setTimeout(() => {
            ...
            showBanner('Suppression réalisée avec succès', !0),
              closeModalById('ConfirmDeleteModal'),
              n && closeModalById(n);
          }
        });
      }),
      document.getElementById('ConfirmDeleteModal_no_button'));
  o.onclick = function () {
    closeModalById('ConfirmDeleteModal');
  };
}
function updateCustomerinfo(n = null) {
  var e = document.getElementById('customerForm'),
    e = new FormData(e),
    r = {};
  e.forEach(function (e, t) {
    ...
    (n = r),
    ajaxCall('customer/update', 'POST', n, function (t) {
      if (!0 === t.success) {
        let e = t.delete;
        updateCustomerFields(n, e),
          ModalInStack('updateCustomerModal') &&
            closeModalById('updateCustomerModal'),
          showBanner('Modification réalisée avec succès', !0);
      } else showBanner('Échec de la modification', !1);
    });
}
function updateCustomerFields(o, e = 0) {
  const n = (e, t) => {
  ...
  if (
    (t.forEach(({ modal: e, prefix: t }) => {
      ModalInStack(e) &&
        (n(t + '_name_span', o.Name),
        n(t + '_phone_span', o.Phone),
        n(t + '_email_span', o.Email),
        n(t + '_comment_span', o.Comment));
    }),
    'customer' == urlLocation())
  ) {
    let i = document.querySelector('.row_customer_' + o.Customer_id);
    if (i) {
      (i.dataset.name = o.Name),
        (i.dataset.phone = o.Phone),
        (i.dataset.email = o.Email),
        (i.dataset.comment = o.Comment);
      let e = document.querySelector('.service_' + o.Customer_id),
        t =
          (e && (e.innerHTML = `<b>${o.Name}</b>`),
          i.querySelector('td:nth-child(2)')),
        n =
          (t && (t.textContent = o.Email), i.querySelector('td:nth-child(3)')),
        r =
          (n && (n.textContent = o.Phone),
          document.getElementById('comment_' + o.Customer_id));
      r && (r.textContent = o.Comment);
    }
  }
}
function setupButtonAction(t) {
  let e = document.getElementById('update_customer_submit_form');
  e.onclick = function () {
    let e = '' !== document.getElementById('customer_id').value;
    (e ? updateCustomerInfo : CreateCustomer)(t);
  };
}
function startTokenCountdown() {
  if (localStorage.getItem('token')) {
    let e = parseInt(localStorage.getItem('timeLeft'), 10);
    countdownInterval && clearInterval(countdownInterval), updateCountdown(e);
  }
}
function createDayMarker({
  ...
  if (
    ((s.className = `absolute flex justify-${n} w-full z-20`),
    'IN' === e || 'OUT' === e)
  ) {
    let e = document.createElement('div'),
      t =
        ((e.className = `triangle ${n} ${o} ` + i),
        s.appendChild(e),
        document.createElement('div'));
    (t.className = `count justify-${n} my-0.5 mx-1 font-bold z-10`),
      (t.textContent = 0 < r ? r.toString() : ' '),
      s.appendChild(t);
  } else {
    s.className = `absolute flex justify-${n} h-full w-full z-20`;
    let e = document.createElement('div');
    (e.className = `calendar_booked ${o} flex flex-col w-full`),
      (e.textContent = ' '),
      s.appendChild(e);
  }
  return s;
...
function updateEventFromDetails() {
  let i = {},
    e = Array.from(document.querySelectorAll('[id]')).filter(
      (e) =>
        'string' == typeof e.id &&
        e.id.startsWith('Modalevent') &&
        !e.id.includes('bgtoggle')
    );
  e.forEach((e) => {
    const t = e.id.replace('Modalevent', '');
    var n;
    'checkbox' !== e.type || e.id.includes('Type_doc')
      ? 'Start' === t || 'End' === t
        ? (i[t.toLowerCase()] = format_date_toSql(e.value))
        : 'Datepicker' === t
          ? ((n = e.value.split(' - ')),
            (i.start = format_date_toSql(n[0])),
            (i.end = format_date_toSql(n[1])))
          : (i[t] = e.value)
      : (i[t] = e.checked ? 1 : 0);
  }),
    ajaxCall('booking/updateBooking', 'POST', i, function (r) {
      if (!0 === r.success) {
        let e = {},
          n = ((e[r.id] = r.data), []),
          t =
            (document.querySelectorAll('.payment-row').forEach((e, t) => {
              if (!0 === e.id.startsWith('temp_'))
                n.push({
                  booking_id: i.id,
                  type_paid: document.getElementById('rowPaidType' + e.id)
                    .value,
                  value: document.getElementById('rowPaid' + e.id).value,
                });
              else {
                let e = document.getElementById('rowPaidid' + t).value;
                e &&
                  n.push({
                    id: e,
                    booking_id: i.id,
                    type_paid: document.getElementById('rowPaidType' + t).value,
                    value: document.getElementById('rowPaid' + t).value,
                  });
              }
            }),
            n.filter((e) => void 0 !== e));
        0 < t.length ? updatePayments(t, e) : finalizeUpdate(e);
      } else showBanner('Echec de la mise à jour ! <br>' + r.error, !1);
    });
}
function addEvent() {
  let o = {},
  ...
  [
    ...
    { id: 'Modaleventfullblocked', key: 'fullblocked', isCheckbox: !0 },
    ...
    { id: 'ModaleventDatepicker', key: 'start', isDate: !0 },
  ].forEach(({ id: e, key: t, isCheckbox: n, isDate: r }) => {
    let i = document.getElementById(e);
    n
      ? ((o[t] = i.checked ? 1 : 0), (s = i))
      : r
        ? ((n = i.value.split(' - ')),
          (o.start = format_date_toSql(n[0])),
          (o.end = format_date_toSql(n[1])))
        : (o[t] = i.value),
      (s[e] = i);
  }),
    o.start && o.end
      ? ajaxCall('booking/addBooking', 'POST', o, function (o) {
          if (!0 === o.success) {
            let n = o.id,
              r = [],
              i = document.querySelectorAll('.payment-row');
            if (0 < i.length) {
              i.forEach((e, t) => {
                if (!0 === e.id.startsWith('temp_'))
                  r.push({
                  ...
                  e &&
                    r.push({
                      id: e,
                      Booking_id: n,
                      type_paid: document.getElementById('rowPaidType' + t)
                        .value,
                      value: document.getElementById('rowPaid' + t).value,
                    });
                }
              });
              let e = r.filter((e) => void 0 !== e),
                t = { booking_data: o.data };
              updatePayments(e, t);
            }
            showBanner(
            ...
            let t = "Erreur(s) lors de l'ajout";
            for (const e in o.error)
              if (e.toLowerCase().includes('customer')) {
                t += '<br><h2>Le champ : <u> Client</u> est manquant !</h2>';
      ...
      : showBanner('Le formulaire est incomplet', !1);
}
function logout() {
  localStorage.removeItem('token'),
    ajaxCall(
      ...
      null,
      function (e) {
        console.log(e.message), (window.location.href = baseurl + 'auth');
      },
      function (e, t, n) {
        console.error('Erreur lors de la déconnexion:', n);
      }
    );
}
function showBookingList(e, c) {
  const t = c.split('-'),
    n = [t[2], t[1], t[0]].join('/');
  let r = document.getElementById('modal-title'),
    d = document.getElementById('bookingListContainer');
  (d.innerHTML = ''), (r.innerHTML = getDayOfWeek(format_date(n)) + ' ' + n);
  const h = new Date().toISOString().split('T')[0];
  e.sort((e, t) => {
    let n = e.start.split(' ')[0],
      r = t.start.split(' ')[0],
      i = e.end.split(' ')[0],
      o = t.end.split(' ')[0],
      s = n === h,
    ...
    if (l && !c) return -1;
    if (!l && c) return 1;
    let d = e.service_title.toLowerCase(),
      u = t.service_title.toLowerCase();
  ...
  let u = 0,
    i =
      (e.forEach((e) => {
        u++;
        let t = c == e.start.slice(0, 10),
          n = c == e.end.slice(0, 10),
          r = e.paids_values ? e.paids_values.split(',').map(Number) : [0],
          i = r.reduce((e, t) => e + t, 0),
          o = totalBookingPriceCal(
            e.Price,
            e.QtTraveller,
            e.Tax,
            e.Fee,
    ...
    <div class="flex flex-wrap justify-end font-bold rounded-b-lg border-b-2 dark:bg-black-50 border-slate-300 dark:border-slate-900 text-slate-400 dark:text-slate-600">
      ...
      availableListServices(n, services_list, e)),
    o = document.getElementById('ListEventModal').querySelector('h1'),
    s = o.parentElement;
  0 < i.length
    ? ((d.innerHTML += `          
    ...
    `;
      ...
      document.querySelectorAll('.add-event-link').forEach((r) => {
        r.addEventListener('click', (e) => {
          e.preventDefault();
          r.getAttribute('data-index');
          const t = r.getAttribute('data-date'),
            n = r.getAttribute('data-service-id');
          handleAddEventClick(t, n);
        });
      }),
      (o.innerHTML = '<b>Ajouter une réservation</b>'),
      s.classList.add('cursor-pointer'),
      (s.onclick = () => handleAddEventClick(n, i[0].Service_id)))
    : ((o.innerHTML = '<b>Complet</b>'),
      s.classList.remove('cursor-pointer'),
      (s.onclick = null)),
    openModal('ListEventModal');
}
function ShowCreateCustomer(e = '', t) {
  (document.getElementById('header_updateCustomerModal').innerHTML =
    header_modal('Client', 'updateCustomerModal')),
    (document.getElementById('customer_id').value = ''),
    (document.getElementById('customer_name').value = e),
...
function CreateCustomer(r) {
  ...
  ajaxCall('customer/create', 'POST', i, function (t) {
    if (t.success) {
      let e = t.data;
      var n;
      r && 'function' == typeof r && r(e),
        window.location.href.includes('Customers') &&
          ((n = `<tr class="border-b dark:border-gray-700 row_customer_${e.id}" data-id="${e.id}" data-Name="${i.Name}" data-Comment="${i.Comment}" data-Email="${i.Email}" data-Phone="${i.Phone}" onclick="get_booking_list_from_customer(this)">
          ...
          $(n).addClass('blinking').insertBefore('#items-container tr:first')),
        ModalInStack('updateCustomerModal') &&
          closeModalById('updateCustomerModal'),
        showBanner(`Le client ${e.Name} a été créé avec succès`, !0);
    } else
      showBanner(t.error, !1),
        console.error('Erreurs de validation de données:', t.errors);
  });
}
function showUpdateCustomer(t) {
  openModal('updateCustomerModal', !1),
    (document.getElementById('header_updateCustomerModal').innerHTML =
      header_modal('Client', 'updateCustomerModal'));
  let n;
  ajaxCall(
    'customer/get_customer_info?customer_id=' + t,
    'GET',
    null,
    function (e) {
      if (!0 === e.success)
        return (
          ...
          updateCustomersFormFields(n),
          n
        );
      console.error(
        "Échec get_customer_info: aucun enregistrement trouvé pour l'id : " + t
      );
    }
  );
}
function Deletepaid(e) {
  let t = Array.isArray(e) ? e : [e],
    n =
      ...
      t.filter((e) => 'string' == typeof e && !e.startsWith('temp')));
  0 < n.length &&
    ajaxCall('paids/delete', 'POST', { ids: n }, function (t) {
      !0 === t.success
        ? (showBanner('Suppression réussi', !0),
          Object.keys(t.data).forEach((e) => {
            t.data[e] && ((e = document.getElementById(e)), e) && e.remove();
          }))
        : showBanner('Échec de la suppression', !1);
    });
}
function DeleteCustomer(e, n) {
  e.stopPropagation(), openModal('ConfirmDeleteModal');
  let t = document.getElementById('ConfirmDeleteModal'),
    r =
      ((t.style.zIndex = '999'),
      document.getElementById('ConfirmDeleteModal_yes_button')),
    i =
      ((r.onclick = function () {
        var t = { Customer_id: n, delete: !0 };
        ajaxCall('customer/update', 'POST', t, function (e) {
          !0 === e.success
            ? (showBanner('Suppression réalisée avec succès', !0),
              ModalInStack('updateCustomerModal') &&
                closeModalById('updateCustomerModal'),
              ModalInStack('CustomerInfoModal') &&
                closeModalById('CustomerInfoModal'),
              closeModalById('ConfirmDeleteModal'),
              setTimeout(() => {
                $('.row_customer_' + t.Customer_id).addClass('fade_out');
              }, 200),
              setTimeout(() => {
                $('.row_customer_' + t.Customer_id).css('display', 'none');
              }, 700))
            : showBanner('Échec de la suppression', !1);
        });
      }),
...
function get_booking_list_from_customer(a) {
  ModalInStack('CustomerInfoModal')
    ? (closeModalById('CustomerInfoModal'),
      setTimeout(function () {
    ...
    : openModal('CustomerInfoModal'),
    (document.getElementById('header_CustomerInfoModal').innerHTML =
      header_modal('Client', 'CustomerInfoModal'));
  let l = document.getElementById('CustomerInfoModal_th'),
    c = document.getElementById('CustomerInfoModal_tbody'),
    d =
      (c.addEventListener('click', function (e) {
        if (e.target.classList.contains('booking-row')) {
          const t = e.target.getAttribute('data-booking-id');
          showBookingDetailsFromID(t);
        }
      }),
      (c.innerHTML = ''),
      0),
  ...
  ajaxCall(
    ...
    'GET',
    { Customer_id: a, Type_doc: currentDocType },
    function (i) {
      if (!emptyObj(i.customers) && i.success) {
        l.style.visibility = 'visible';
        let e = i.bookings,
          t = i.customers;
        const s = 1 < i.bookings.length;
        e.forEach(function (e) {
          let t = e.paids_values ? e.paids_values.split(',').map(Number) : [0],
            n = t.reduce((e, t) => e + t, 0),
            r =
              ((d += n),
              totalBookingPriceCal(e.Price, e.QtTraveller, e.Tax, e.Fee, e.Qt)),
            i = ((u += r), document.createElement('tr')),
            o =
              (i.classList.add(
                'hover:bg-slate-50',
              ...
              s && i.classList.add('border-b'),
              i.setAttribute('data-booking-id', e.id),
              [
                `<td scope="row" class="pl-3 py-3 text-center whitespace-nowrap">${e.Type_doc.charAt(0)} #${e.id}</td>`,
                `<th scope="row" class="px-3 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">${e.service_title}</th>`,
          ...
          (i.innerHTML = o.join('')),
            (i.onclick = function () {
              showBookingDetailsFromID(e.id);
            }),
            c.appendChild(i);
        });
        let n = Math.min(Math.round((d / u) * 1e4) / 100, 100),
          r =
            ((document.getElementById('history_customer_block_toedit').onclick =
              ((o = a),
              function () {
                showUpdateCustomer(o);
              })),
            ...
            (document.getElementById(
              'history_customer_comment_span'
            ).innerText = t.Comment),
            (document.getElementById(
              'history_customer_created_span'
            ).innerText = t.Created_at),
            document.getElementById('modal-title_customer_finance_total'));
        if (
          ((r.innerHTML = `
        <div class=" py-4 lg:px-4 w-full">
          ...
          let e = l.querySelectorAll('th'),
            t = e.length,
            n = document.createElement('tr');
          n.classList.add('booking-row', 'text-center', 'font-bold'),
            (n.innerHTML = `<td  colspan="${t}">
      ...
      } else showBanner(i.error, !1);
      var o;
    }
  );
}
async function getPaidFromBookingId(e) {
  try {
    const t = await ajaxCall('paids/bookings/' + e, 'GET', null);
    return t;
  } catch (e) {
    throw (console.error('Erreur lors de la récupération des paids: ', e), e);
  }
}
function createPaymentHtml(t, e, n) {
  let r = {
      0: ['rounded-tl-lg', 'rounded-tr-lg'],
      [n - 1]: ['rounded-bl-lg', 'rounded-br-lg'],
    },
    i = ['', ''];
  return (
    (i =
...
function loadAndInitDatepicker(n, i = !1, o = !1) {
  return new Promise((e, t) => {
    var r = document.querySelector('.loader');
    (r.style.display = 'block'),
      window.fromServicepicker && window.fromServicepicker.destroy(),
      ajaxCall(`booking/datepicker/${n}/true`, 'GET', null, function (s) {
        if (s.success) {
          let t = Object.keys(s.data).map((e) => {
            let t = s.data[e],
              n = Object.values(t.details_bookings).some((e) => e.is_first_day),
              r = Object.values(t.details_bookings).some((e) => e.is_last_day),
              i = format_date(t.start, 0, !1);
            if ('Date invalide' === i)
              return (
                console.log('Date invalide pour la réservation', t.start), null
              );
            let o = t.fullblocked;
            return { date: i, fullblocked: o, hasFirstDay: n, hasLastDay: r };
          });
          const n = processBookingDates(t);
          (window.fromServicepicker = new easepick.create({
            ...
            LockPlugin: {
              ...
              inseparable: !1,
              filter(e, t) {
                return n.includes(e.format('DD-MM-YYYY'));
              },
            },
            RangePlugin: {
              tooltipNumber(e) {
              ...
              locale: { one: 'Nuit', other: 'Nuits' },
            },
            onShow(e) {
              let t = document.getElementById('datepicker-header'),
                n = e.picker.outerNode;
            ...
            setup(e) {
              ...
              t.forEach(
                ...
                e.on('view', (e) => {
                  let { view: t, date: n, target: o } = e.detail,
                    s = n ? n.format('DD-MM-YYYY') : null;
                  if ('CalendarDay' === t && a[s]) {
                    let e,
                      t,
                      n = a[s].FirstDay,
                      r = a[s].LastDay,
                      i;
                    n && !r
                      ? ((i = o.querySelector('.start-date-triangle')),
                        i ||
                          ((e = document.createElement('span')),
                          (e.className = 'day-unavailable start-date-triangle'),
                          (e.innerHTML += `<svg class="w-2 h-2 text-slate-500 dark:text-white"  aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
                    </svg>`),
                          o.append(e)))
                      : !n && r
                        ? ((i = o.querySelector('.end-date-triangle')),
                          i ||
                            ((e = document.createElement('span')),
                            (e.className = 'day-unavailable end-date-triangle'),
                            (e.innerHTML += `<svg class="w-2 h-2 text-slate-500 dark:text-white"  aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
                    </svg>`),
                            o.append(e)))
                        : n &&
                          ...
                          i
                            ...
                            : ((e = document.createElement('span')),
                              (e.className =
                                'day-unavailable start-date-triangle'),
                              (e.innerHTML = `<svg class="w-2 h-2 text-slate-500 dark:text-white"  aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
                    </svg>`),
                              o.append(e),
                              ...
                              (t.className =
                                'day-unavailable end-date-triangle'),
                              (t.innerHTML = `<svg class="w-2 h-2 text-slate-500 dark:text-white"  aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
                    </svg>`),
                              o.append(t)));
                  }
                ...
                e.on('select', (e) => {
                  let t = DaysDifferenceStartEnd(e.detail.start, e.detail.end);
                  (document.getElementById('ModaleventQt').value = t),
            ...
            i &&
              o &&
              (window.fromServicepicker.setStartDate(format_date(i, 0, !1, !0)),
              window.fromServicepicker.setEndDate(format_date(o, 0, !1, !0))),
            updateTotalInfo(),
            updatePrice(GlobalEDITING_book),
            (GlobalEDITING_book = !1),
            (r.style.display = 'none'),
            e(window.fromServicepicker);
        }
      });
  });
}
function processBookingDates(e) {
  let t = e.filter(({ hasFirstDay: e, hasLastDay: t }) => !e && !t),
    n = t.map(({ date: e }) => {
      let [t, n, r] = e.split('-');
      return `${t}-${n}-` + r;
    });
...
!(function (e, t) {
  ...
  'object' == typeof module && 'object' == typeof module.exports
    ...
    : t(e);
})('undefined' != typeof window ? window : this, function (oe, E) {
  'use strict';
  function m(e, t, n) {
    var r,
      i,
  ...
  function F(e) {
    return e.replace(Ue, 'ms-').replace(ze, W);
  }
  function B() {
    ...
    if (d && d[3] !== c) {
      for (l /= 2, c = c || d[3], d = +l || 1; s--; )
        de.style(e, t, d + c),
          ...
          (d /= o);
      (d *= 2), de.style(e, t, d + c), (n = n || []);
    }
    return (
      n &&
        ((d = +d || +l || 0), (i = n[1] ? d + (n[1] + 1) * n[2] : +n[2]), r) &&
        ((r.unit = c), (r.start = d), (r.end = i)),
      i
    );
  }
  function re(e, t) {
    for (var n, r, i, o, s, a, l = [], c = 0, d = e.length; c < d; c++)
      (r = e[c]).style &&
        ((n = r.style.display),
        t
          ? ('none' === n &&
    ...
    var n =
      void 0 !== e.getElementsByTagName
        ...
        : void 0 !== e.querySelectorAll
          ...
          : [];
    return void 0 === t || (t && fe(e, t)) ? de.merge([e], n) : n;
  }
  function Ee(e, t) {
  ...
  function Ae(e, t, n, r, i) {
    for (
      ...
      if ((o = e[h]) || 0 === o)
        if ('object' === x(o)) de.merge(u, o.nodeType ? [o] : o);
        else if (xt.test(o)) {
          for (
            s = s || d.appendChild(t.createElement('div')),
              a = (wt.exec(o) || ['', ''])[1].toLowerCase(),
              a = f[a] || f._default,
              s.innerHTML = a[1] + de.htmlPrefilter(o) + a[2],
              c = a[0];
            c--;

          )
            s = s.lastChild;
          de.merge(u, s.childNodes), ((s = d.firstChild).textContent = '');
        } else u.push(t.createTextNode(o));
    for (d.textContent = '', h = 0; (o = u[h++]); )
      if (r && -1 < de.inArray(o, r)) i && i.push(o);
      else if (
        ((l = Ke(o)), (s = Se(d.appendChild(o), 'script')), l && Ee(s), n)
      )
        ...
        de.event.add(e, r, {
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[r]) {
              ...
              n &&
                (v.set(this, r, de.event.trigger(n[0], n.slice(1), this)),
                e.stopPropagation(),
                (e.isImmediatePropagationStopped = Ne));
          },
        }))
      : void 0 === v.get(e, r) && de.event.add(e, r, Ne);
  }
  function Re(e, t) {
    return (
      (fe(e, 'table') &&
    ...
    if (1 === t.nodeType) {
      if (v.hasData(e) && (o = v.get(e).events))
        for (i in (v.remove(t, 'handle events'), o))
          for (n = 0, r = o[i].length; n < r; n++) de.event.add(t, i, o[i][n]);
      a.hasData(e) && ((e = a.access(e)), (e = de.extend({}, e)), a.set(t, e));
    }
  }
  function $e(n, r, i, o) {
    r = k(r);
    var e,
      ...
      p = r[0],
      f = y(p);
    if (f || (1 < u && 'string' == typeof p && !ce.checkClone && Dt.test(p)))
      return n.each(function (e) {
        var t = n.eq(e);
        f && (r[0] = p.call(this, e, t.html())), $e(t, r, i, o);
      });
    if (
      u &&
      ...
      for (a = (s = de.map(Se(e, 'script'), Ie)).length; d < u; d++)
        (l = e),
          d !== h &&
            ((l = de.clone(l, !0, !0)), a) &&
            de.merge(s, Se(l, 'script')),
          i.call(n[d], l, d);
      if (a)
        for (
          c = s[s.length - 1].ownerDocument, de.map(s, We), d = 0;
          d < a;
          d++
        )
          (l = s[d]),
            Et.test(l.type || '') &&
              ...
              (l.src && 'module' !== (l.type || '').toLowerCase()
                ...
                : m(l.textContent.replace(At, ''), l, c));
    }
    return n;
  }
  function Be(e, t, n) {
    for (var r, i = t ? de.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || de.cleanData(Se(r)),
        r.parentNode &&
          (n && Ke(r) && Ee(Se(r, 'script')), r.parentNode.removeChild(r));
    return e;
  }
  function Ge(e, t, n) {
    var r,
    ...
    return (
      (n = n || Rt(e)) &&
        ...
        i && (r = r && (r.replace(be, '$1') || void 0)),
        '' !== r || Ke(e) || (r = de.style(e, t)),
        !ce.pixelBoxStyles()) &&
        Mt.test(r) &&
        Nt.test(t) &&
        ((i = o.width),
  ...
  function it(e, t, n, r, i, o) {
    ...
    for (; s < 4; s += 2)
      'margin' === n && (c += de.css(e, n + u[s], !0, i)),
        r
          ? ('content' === n && (l -= de.css(e, 'padding' + u[s], !0, i)),
            'margin' !== n &&
              (l -= de.css(e, 'border' + u[s] + 'Width', !0, i)))
          : ((l += de.css(e, 'padding' + u[s], !0, i)),
            'padding' !== n
              ? (l += de.css(e, 'border' + u[s] + 'Width', !0, i))
              : (a += de.css(e, 'border' + u[s] + 'Width', !0, i)));
    return (
      !r &&
        0 <= o &&
        (l +=
  ...
  function ot(e, t, n) {
    ...
    return (
      ((!ce.boxSizingReliable() && i) ||
        (!ce.reliableTrDimensions() && fe(e, 'tr')) ||
        'auto' === s ||
        (!parseFloat(s) && 'inline' === de.css(e, 'display', !1, r))) &&
        e.getClientRects().length &&
        ((i = 'border-box' === de.css(e, 'boxSizing', !1, r)), (o = a in e)) &&
        (s = e[a]),
      (s = parseFloat(s) || 0) +
  ...
  function dt() {
    Wt &&
      (!1 === S.hidden && oe.requestAnimationFrame
        ? oe.requestAnimationFrame(dt)
        : oe.setTimeout(dt, de.fx.interval),
      de.fx.tick());
  }
  function ht() {
    return (
  ...
  function yt(i, e, t) {
    var n,
      ...
      c,
      d = 0,
      u = yt.prefilters.length,
      h = de.Deferred().always(function () {
        delete p.elem;
      }),
      p = function () {
        if (o) return !1;
        for (
          ...
          f.tweens[n].run(t);
        return (
          h.notifyWith(i, [f, t, e]),
          t < 1 && r
            ? e
            : (r || h.notifyWith(i, [f, 1, 0]), h.resolveWith(i, [f]), !1)
        );
      },
      f = h.promise({
        elem: i,
        ...
        stop: function (e) {
          ...
          if (!o) {
            ...
            e
              ? (h.notifyWith(i, [f, 1, 0]), h.resolveWith(i, [f, e]))
              : h.rejectWith(i, [f, e]);
          }
          return this;
        },
    ...
    for (r in m)
      if (
        ((a = v[(s = F(r))]),
        (l = m[r]),
        Array.isArray(l) && ((a = l[1]), (l = m[r] = l[0])),
        r !== s && ((m[s] = l), delete m[r]),
        (c = de.cssHooks[s]) && 'expand' in c)
      )
        for (r in ((l = c.expand(l)), delete m[s], l))
          r in m || ((m[r] = l[r]), (v[r] = a));
      else v[s] = a;
    for (; d < u; d++)
      if ((n = yt.prefilters[d].call(f, i, g, f.opts)))
        return (
          y(n.stop) &&
            (de._queueHooks(f.elem, f.opts.queue).stop = n.stop.bind(n)),
          n
        );
    return (
      de.map(g, vt, f),
      ...
      de.fx.timer(de.extend(p, { elem: i, anim: f, queue: f.opts.queue })),
      f
    );
  }
  function Tt(e) {
  ...
  function Pt(n, e, r, i) {
    ...
    else for (var t in e) Pt(n + '[' + t + ']', e[t], r, i);
  }
  function Ut(o) {
    return function (e, t) {
  ...
  var se = [],
    ...
    me =
            ...
            if (null != (e = arguments[s]))
              for (t in e)
                (n = e[t]),
                  '__proto__' !== t &&
                    o !== n &&
                    (l && n && (de.isPlainObject(n) || (r = Array.isArray(n)))
                      ? ((i = o[t]),
                        (i =
                          r && !Array.isArray(i)
                            ? []
                            : r || de.isPlainObject(i)
                              ? i
                              : {}),
                        (r = !1),
                        (o[t] = de.extend(l, i, n)))
      ...
      de.extend({
        ...
        makeArray: function (e, t) {
          ...
          return (
            null != e &&
              (c(Object(e))
                ? de.merge(t, 'string' == typeof e ? [e] : e)
                : M.call(t, e)),
            t
          );
        },
        ...
        isXMLDoc: function (e) {
          ...
          return !ge.test(t || (e && e.nodeName) || 'HTML');
        },
        merge: function (e, t) {
      ...
      'function' == typeof Symbol &&
        (de.fn[Symbol.iterator] = se[Symbol.iterator]),
      de.each(
    ...
    i =
      (!(function () {
        function I(e, t, n, r) {
            ...
            if (11 !== u && (a = j.exec(e)))
              if ((i = a[1])) {
                ...
                if ((i = a[3]) && t.getElementsByClassName)
                  return C.apply(n, t.getElementsByClassName(i)), n;
              }
            if (!(p[e + ' '] || (h && h.test(e)))) {
              if (((c = e), (d = t), 1 === u && (O.test(e) || R.test(e)))) {
                for (
                  ((d = (f.test(e) && U(t.parentNode)) || t) == t &&
                    ce.scope) ||
                    ((s = t.getAttribute('id'))
          ...
          return re(e.replace(be, '$1'), t, n, r);
        }
        function W() {
          var r = [];
          return function e(t, n) {
            return (
              r.push(t + ' ') > w.cacheLength && delete e[r.shift()],
              (e[t + ' '] = n)
            );
          };
        }
            ...
            e != x &&
              ...
              (ce.getById = $(function (e) {
                return (
                  ...
                  !x.getElementsByName ||
                    !x.getElementsByName(de.expando).length
                );
              })),
              (ce.disconnectedMatch = $(function (e) {
                return r.call(e, '*');
              })),
              (ce.scope = $(function () {
                ...
                ? ((w.filter.ID = function (e) {
                  ...
                  (w.find.ID = function (e, t) {
                    if (void 0 !== t.getElementById && S)
                      return (t = t.getElementById(e)), t ? [t] : [];
                  }))
                : ((w.filter.ID = function (e) {
                    var t = e.replace(g, m);
                    return function (e) {
              ...
              $(function (e) {
                ...
                (n.appendChild(e).innerHTML =
                  ...
                  e.querySelectorAll('[selected]').length ||
                    h.push('\\[' + ue + '*(?:value|' + y + ')'),
                  e.querySelectorAll('[id~=' + D + '-]').length || h.push('~='),
                      ...
                      (1 &
                        (n =
                          (e.ownerDocument || e) == (t.ownerDocument || t)
                            ...
                            : 1) ||
                      (!ce.sortDetached && t.compareDocumentPosition(e) === n)
                        ? e === x ||
                          (e.ownerDocument == he && I.contains(he, e))
                          ? -1
                          : t === x ||
                              (t.ownerDocument == he && I.contains(he, t))
                            ? 1
                            : o
                              ? le.call(o, e) - le.call(o, t)
                              : 0
                        : 4 & n
                          ? -1
                          : 1));
        ...
        function Y(e, t) {
          ...
          for (s = e, a = [], l = w.preFilter; s; ) {
            for (o in ((n && !(r = M.exec(s))) ||
              (r && (s = s.slice(r[0].length) || s), a.push((i = []))),
            (n = !1),
            (r = R.exec(s)) &&
              ((n = r.shift()),
              i.push({ value: n, type: r[0].replace(be, ' ') }),
              (s = s.slice(n.length))),
            w.filter))
              !(r = u[o].exec(s)) ||
                (l[o] && !(r = l[o](r))) ||
          ...
          return t ? s.length : s ? I.error(e) : d(e, a).slice(0);
        }
        function Q(e) {
          ...
          return e.first
            ...
            : function (e, t, n) {
                ...
                if (n) {
                  ...
                  for (; (e = e[a]); )
                    if (1 === e.nodeType || d)
                      if (((i = e[D] || (e[D] = {})), l && fe(e, l)))
                        e = e[a] || e;
                      else {
                        if ((r = i[c]) && r[0] === A && r[1] === u)
                          return (o[2] = r[2]);
          ...
          return (
            ...
            F(function (e, t, n, r) {
              var i,
                ...
                h = !p || (!e && f) ? u : Z(u, l, p, n, r);
              if (
                (g ? g(h, (a = v || (e ? p : d || m) ? [] : t), n, r) : (a = h),
                m)
              )
                for (i = Z(a, c), m(i, [], n, r), o = i.length; o--; )
                  (s = i[o]) && (a[c[o]] = !(h[c[o]] = s));
              if (e) {
                if (v || p) {
                  if (v) {
                  ...
                  for (o = a.length; o--; )
                    (s = a[o]) &&
                      -1 < (i = v ? le.call(e, s) : l[o]) &&
                      (e[i] = !(t[i] = s));
                }
              } else
                (a = Z(a === t ? a.splice(d, a.length) : a)),
                  v ? v(null, t, a, r) : C.apply(t, a);
            })
          );
        }
        function te(e) {
          for (
            ...
            if ((t = w.relative[e[a].type])) d = [J(K(d), t)];
            else {
        ...
        function ne(e, t) {
          var n,
            ...
            s = c[e + ' '];
          if (!s) {
            for (t = t || Y(e), n = t.length; n--; )
              ((s = te(t[n]))[D] ? i : o).push(s);
            (s = c(
              e,
              ((m = o),
              (y = 0 < (v = i).length),
              ...
              (r = function (e, t, n, r, i) {
                ...
                for (
                  ...
                  if (b && o) {
                    for (
                      s = 0, t || o.ownerDocument == x || (V(o), (n = !S));
                      (a = m[s++]);
        ...
        function re(e, t, n, r) {
          ...
          if (((n = n || []), 1 === d.length)) {
            if (
              ...
              if (!(t = (w.find.ID(s.matches[0].replace(g, m), t) || [])[0]))
                return n;
            ...
            for (
              ...
              if (
                (l = w.find[a]) &&
                (r = l(
                  s.matches[0].replace(g, m),
                  (f.test(o[0].type) && U(t.parentNode)) || t
                ))
              ) {
                if ((o.splice(i, 1), (e = r.length && Q(o)))) break;
                return C.apply(n, r), n;
              }
          }
          return (
            (c || ne(e, d))(
        ...
        try {
          C.apply((se = ae.call(he.childNodes)), he.childNodes),
            se[he.childNodes.length].nodeType;
        } catch (t) {
          C = {
            apply: function (e, t) {
              xe.apply(e, ae.call(t));
            },
            call: function (e) {
              xe.apply(e, ae.call(arguments, 1));
            },
          };
        }
        for (t in ((I.matches = function (e, t) {
          return I(e, null, null, t);
        }),
        (I.matchesSelector = function (e, t) {
          if ((V(e), S && !p[t + ' '] && (!h || !h.test(t))))
            try {
              var n = r.call(e, t);
              if (
                n ||
        ...
        (I.contains = function (e, t) {
          return (e.ownerDocument || e) != x && V(e), de.contains(e, t);
        }),
        (I.attr = function (e, t) {
          (e.ownerDocument || e) != x && V(e);
          var n = w.attrHandle[t.toLowerCase()],
            n =
              n && pe.call(w.attrHandle, t.toLowerCase())
                ? n(e, t, !S)
                : void 0;
        ...
        (de.uniqueSort = function (e) {
          ...
          if (
            ((s = !ce.sortStable),
            (o = !ce.sortStable && ae.call(e, 0)),
            ve.call(e, a),
            s)
          ) {
            for (; (t = e[i++]); ) t === e[i] && (r = n.push(i));
            for (; r--; ) ye.call(e, n[r], 1);
          }
          return (o = null), e;
        }),
        (de.fn.uniqueSort = function () {
          return this.pushStack(de.uniqueSort(ae.apply(this)));
        }),
        ((w = de.expr =
          {
            cacheLength: 50,
                  ...
                  : function (e, t, n) {
                      ...
                      if (c) {
                        if (m) {
                          for (; l; ) {
                            for (o = e; (o = o[l]); )
                              if (y ? fe(o, d) : 1 === o.nodeType) return !1;
                            a = l = 'only' === p && !a && 'nextSibling';
                          }
                          return !0;
                        }
                        if (((a = [v ? c.firstChild : c.lastChild]), v && u)) {
                          for (
                            h =
                              (s =
                                (r = (i = c[D] || (c[D] = {}))[p] || [])[0] ===
                          ...
                          for (
                            ...
                            (o =
                              (++s && o && o[l]) || ((h = s = 0), a.pop())) &&
                            ((y ? !fe(o, d) : 1 !== o.nodeType) ||
                              !++h ||
                              (u && ((i = o[D] || (o[D] = {}))[p] = [A, h]),
                              o !== e));

                          );
                        return (h -= g) === f || (h % f == 0 && 0 <= h / f);
                      }
                    };
              },
              PSEUDO: function (e, o) {
            ...
            pseudos: {
              ...
              lang: F(function (n) {
                return (
                  P.test(n || '') || I.error('unsupported lang: ' + n),
                  (n = n.replace(g, m).toLowerCase()),
                  function (e) {
                    var t;
                    do {
                      if (
              ...
              target: function (e) {
                var t = oe.location && oe.location.hash;
        ...
        { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 }))
          w.pseudos[t] = B(t);
        for (t in { submit: !0, reset: !0 }) w.pseudos[t] = _(t);
        (G.prototype = w.filters = w.pseudos),
          (w.setFilters = new G()),
          (ce.sortStable = D.split('').sort(a).join('') === D),
          V(),
          (ce.sortDetached = $(function (e) {
          ...
          (I.setDocument = V),
          (I.tokenize = Y),
          (I.escape = de.escapeSelector),
          (I.getText = de.text),
          (I.isXML = de.isXMLDoc),
          (I.selectors = de.expr),
          (I.support = de.support),
          (I.uniqueSort = de.uniqueSort);
      })(),
      function (e, t, n) {
  ...
  var Te,
        ...
        if (e) {
          ...
          if (r[1]) {
            if (
              ...
              De.test(r[1]) && de.isPlainObject(t))
            )
              for (var r in t) y(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
          } else
            (n = S.getElementById(r[2])) && ((this[0] = n), (this.length = 1));
        }
        return this;
      }).prototype = de.fn),
      (Te = de(S)),
        ...
        function (r, i) {
          de.fn[r] = function (e, t) {
            ...
            return (
              ...
              1 < this.length &&
                (Oe[r] || de.uniqueSort(n), Me.test(r)) &&
                n.reverse(),
              this.pushStack(n)
            );
          };
    ...
    Pe =
      ((de.Callbacks = function (r) {
        ...
        r =
          'string' == typeof r
            ? ((e = r),
              (i = {}),
              de.each(e.match(C) || [], function (e, t) {
                i[t] = !0;
              }),
              i)
            : de.extend({}, r);
        var o,
          ...
          d = -1,
          u = function () {
            for (a = a || r.once, s = o = !0; c.length; d = -1)
            ...
            remove: function () {
              return (
                de.each(arguments, function (e, t) {
                  for (var n; -1 < (n = de.inArray(t, l, n)); )
                    l.splice(n, 1), n <= d && d--;
                }),
                this
              );
      ...
      de.extend({
                  ...
                  return function () {
                      ...
                      e = function () {
                        ...
                        if (!(i < c)) {
                          ...
                          (t =
                            ...
                            y(t)
                              ? a
                                ? t.call(e, l(c, o, N, a), l(c, o, q, a))
                                : (c++,
                                  t.call(
                                    e,
                                    l(c, o, N, a),
                                    l(c, o, q, a),
                                    l(c, o, N, o.notifyWith)
                                  ))
                              : (s !== N && ((n = void 0), (r = [e])),
                                (a || o.resolveWith)(n, r));
                        }
                        ...
                        : function () {
                            try {
                              ...
                              de.Deferred.exceptionHook &&
                                de.Deferred.exceptionHook(e, t.error),
                                c <= i + 1 &&
                                  (s !== q && ((n = void 0), (r = [e])),
                                  o.rejectWith(n, r));
                            }
                    ...
                    i
                      ...
                      : (de.Deferred.getErrorHook
                          ? (t.error = de.Deferred.getErrorHook())
                          : de.Deferred.getStackHook &&
                            (t.error = de.Deferred.getStackHook()),
                        oe.setTimeout(t));
                  };
                }
                var c = 0;
        ...
        when: function (e) {
          ...
          if (
            n <= 1 &&
            (L(e, o.done(s(t)).resolve, o.reject, !n),
    ...
    d =
      ...
      ('loading' !== S.readyState && !S.documentElement.doScroll)
        ? oe.setTimeout(de.ready)
        : (S.addEventListener('DOMContentLoaded', P),
          oe.addEventListener('load', P)),
    ...
    tt =
      ...
      function (e, t) {
        return (
          ...
          ('' === e.style.display && Ke(e) && 'none' === de.css(e, 'display'))
        );
      }),
    nt = {};
  de.fn.extend({
  ...
  var st,
    ...
    h = S.createDocumentFragment().appendChild(S.createElement('div')),
    f =
      ((w = S.createElement('input')).setAttribute('type', 'radio'),
      w.setAttribute('checked', 'checked'),
      w.setAttribute('name', 't'),
      h.appendChild(w),
      (ce.checkClone = h.cloneNode(!0).cloneNode(!0).lastChild.checked),
      (h.innerHTML = '<textarea>x</textarea>'),
      (ce.noCloneChecked = !!h.cloneNode(!0).lastChild.defaultValue),
      (h.innerHTML = '<option></option>'),
      (ce.option = !!h.lastChild),
      {
        thead: [1, '<table>', '</table>'],
    ...
    _t =
              ...
              (u = p = (h = St.exec(e[l]) || [])[1]),
                ...
                u &&
                  ...
                  (d = a[u]) ||
                    ...
                    c.setup && !1 !== c.setup.call(t, r, h, s)) ||
          ...
          if (m && (l = m.events)) {
            for (c = (t = (t || '').match(C) || ['']).length; c--; )
              if (
                ...
                for (
                  u = de.event.special[p] || {},
                    h = l[(p = (r ? u.delegateType : u.bindType) || p)] || [],
                    a =
                      a[2] &&
                      new RegExp(
                        '(^|\\.)' + f.join('\\.(?:.*\\.|)') + '(\\.|$)'
                ...
                s &&
                  ...
                  ((u.teardown && !1 !== u.teardown.call(e, f, m.handle)) ||
                    de.removeEvent(e, p, m.handle),
                  delete l[p]);
              } else for (p in l) de.event.remove(e, p + t[c], n, r, !0);
            de.isEmptyObject(l) && v.remove(e, 'handle events');
          }
        },
        dispatch: function (e) {
          var t,
          ...
          if (
            ...
            for (
              o = de.event.handlers.call(this, a, e), t = 0;
        ...
        special: {
          ...
          click: {
            ...
            trigger: function (e) {
              e = this || e;
              return (
                bt.test(e.type) && e.click && fe(e, 'input') && He(e, 'click'),
                !0
              );
            },
            _default: function (e) {
      ...
      de.each({ focus: 'focusin', blur: 'focusout' }, function (r, i) {
        function o(e) {
          var t, n;
          S.documentMode
            ? ((t = v.get(this, 'handle')),
        ...
        (de.event.special[r] = {
          setup: function () {
            var e;
            if ((He(this, r, !0), !S.documentMode)) return !1;
    ...
    Mt =
      (de.extend({
        ...
        clone: function (e, t, n) {
          ...
          if (
            ...
            for (s = Se(d), r = 0, i = (o = Se(e)).length; r < i; r++)
              (a = o[r]),
                (l = s[r]),
          ...
          if (t)
            if (n)
              for (
                o = o || Se(e), s = s || Se(d), r = 0, i = o.length;
                r < i;
                r++
              )
                Fe(o[r], s[r]);
          ...
          return (
            0 < (s = Se(d, 'script')).length && Ee(s, !u && Se(e, 'script')), d
          );
        },
      ...
      de.fn.extend({
        ...
        prepend: function () {
          return $e(this, arguments, function (e) {
            ...
            (1 !== this.nodeType &&
              11 !== this.nodeType &&
              9 !== this.nodeType) ||
              ((t = Re(this, e)), t.insertBefore(e, t.firstChild));
          });
        },
        before: function () {
          return $e(this, arguments, function (e) {
        ...
        empty: function () {
          for (var e, t = 0; null != (e = this[t]); t++)
            1 === e.nodeType && (de.cleanData(Se(e, !1)), (e.textContent = ''));
          return this;
        },
        clone: function (e, t) {
          return (
          ...
          return d(
            ...
            function (e) {
              ...
              if (
                'string' == typeof e &&
                !_t.test(e) &&
                !f[(wt.exec(e) || ['', ''])[1].toLowerCase()]
              ) {
                e = de.htmlPrefilter(e);
                try {
                  for (; n < r; n++)
                    1 === (t = this[n] || {}).nodeType &&
                      (de.cleanData(Se(t, !1)), (t.innerHTML = e));
                  t = 0;
                } catch (e) {}
              }
      ...
      new RegExp('^(' + r + ')(?!px)[a-z%]+$', 'i')),
    It = /^--/,
    Rt = function (e) {
      var t = e.ownerDocument.defaultView;
      return (t && t.opener) || (t = oe), t.getComputedStyle(e);
    },
    Ot = function (e, t, n) {
      var r,
        i = {};
  ...
  function e() {
    ...
    s &&
      ...
      b.appendChild(mt).appendChild(s),
      (e = oe.getComputedStyle(s)),
      (st = '1%' !== e.top),
      (ft = 12 === t(e.marginLeft)),
      (s.style.right = '60%'),
      (ut = 36 === t(e.right)),
      (lt = 36 === t(e.width)),
      (s.style.position = 'absolute'),
      (ct = 12 === t(s.offsetWidth / 3)),
      b.removeChild(mt),
      (s = null));
  }
  function t(e) {
        ...
        reliableTrDimensions: function () {
          ...
          return (
            null == pt &&
              ...
              b.appendChild(e).appendChild(t).appendChild(n),
              (n = oe.getComputedStyle(t)),
              (pt =
  ...
  de.extend({
    cssHooks: {
      opacity: {
        get: function (e, t) {
          if (t) return (t = Ge(e, 'opacity')), '' === t ? '1' : t;
        },
      },
    },
    cssNumber: {
    ...
    de.each(['height', 'width'], function (e, s) {
      de.cssHooks[s] = {
        get: function (e, t, n) {
          if (t)
            return !jt.test(de.css(e, 'display')) ||
        ...
        set: function (e, t, n) {
          var r = Rt(e),
            i = !ce.scrollboxSize() && 'absolute' === r.position,
            o = (i || n) && 'border-box' === de.css(e, 'boxSizing', !1, r),
            n = n ? it(e, s, n, o, r) : 0;
          return (
            o &&
              i &&
            ...
            n &&
              (o = Je.exec(t)) &&
              'px' !== (o[3] || 'px') &&
              ((e.style[s] = t), (t = de.css(e, s))),
            rt(0, t, n)
          );
        },
      };
    }),
    (de.cssHooks.marginLeft = Ye(ce.reliableMarginLeft, function (e, t) {
      if (t)
        return (
    ...
    de.each({ margin: '', padding: '', border: 'Width' }, function (i, o) {
      (de.cssHooks[i + o] = {
        expand: function (e) {
          for (
            ...
            n[i + u[t] + o] = r[t] || r[t - 2] || r[0];
          return n;
        },
      }),
        'margin' !== i && (de.cssHooks[i + o].set = rt);
    }),
    de.fn.extend({
      css: function (e, t) {
        return d(
      ...
      _default: {
        ...
        set: function (e) {
          de.fx.step[e.prop]
            ? de.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
                (!de.cssHooks[e.prop] && null == e.elem.style[Ze(e.prop)])
              ? (e.elem[e.prop] = e.now)
  ...
  var zt,
    ...
    qt = /^(?:toggle|show|hide)$/,
    Yt = /queueHooks$/;
  (de.Animation = de.extend(yt, {
    tweeners: {
      '*': [
        function (e, t) {
          var n = this.createTween(e, t);
          return te(n.elem, e, Je.exec(t), n), n;
        },
      ],
    },
        ...
        if ((l = !de.isEmptyObject(t)) || !de.isEmptyObject(h))
          ...
          h))
            l ||
              ...
              f && re([e], !0),
              u.done(function () {
                for (r in (f || re([e]), v.remove(e, 'fxshow'), h))
                  de.style(e, r, h[r]);
              })),
              (l = vt(f ? g[r] : 0, r, u)),
              r in g ||
    ...
    (de.speed = function (e, t, n) {
      ...
      return (
        ...
        (r.old = r.complete),
        (r.complete = function () {
          y(r.old) && r.old.call(this), r.queue && de.dequeue(this, r.queue);
        }),
        r
      );
    }),
      ...
      stop: function (i, e, o) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (t in r) r[t] && r[t].stop && Yt.test(t) && s(r[t]);
            for (t = n.length; t--; )
              n[t].elem !== this ||
                (null != i && n[t].queue !== i) ||
    ...
    (de.fx.tick = function () {
      var e,
        t = 0,
        n = de.timers;
      for (zt = Date.now(); t < n.length; t++)
        (e = n[t])() || n[t] !== e || n.splice(t--, 1);
      n.length || de.fx.stop(), (zt = void 0);
    }),
    ...
    (h = S.createElement('select').appendChild(S.createElement('option'))),
    (w.type = 'checkbox'),
    (ce.checkOn = '' !== w.value),
    (ce.optSelected = h.selected),
    ((w = S.createElement('input')).value = 't'),
    (w.type = 'radio'),
    (ce.radioValue = 't' === w.value);
  var Qt,
    Zt = de.expr.attrHandle,
    Xt =
      (de.fn.extend({
        attr: function (e, t) {
          return d(this, de.attr, e, t, 1 < arguments.length);
        },
      ...
      de.extend({
            ...
            return void 0 === e.getAttribute
              ...
              : ((1 === o && de.isXMLDoc(e)) ||
                  (i =
                    ...
                    (de.expr.match.bool.test(t) ? Qt : void 0)),
                void 0 !== n
                  ? null === n
        ...
        attrHooks: {
          type: {
            set: function (e, t) {
              var n;
              if (!ce.radioValue && 'radio' === t && fe(e, 'input'))
                return (
                  (n = e.value),
    ...
    Kt =
      (de.fn.extend({
        prop: function (e, t) {
          return d(this, de.prop, e, t, 1 < arguments.length);
        },
        ...
        propHooks: {
          tabIndex: {
            get: function (e) {
              ...
              return t
                ? parseInt(t, 10)
                : Xt.test(e.nodeName) || (Jt.test(e.nodeName) && e.href)
                  ? 0
                  : -1;
            },
          },
      ...
      de.fn.extend({
        addClass: function (t) {
          ...
          return y(t)
            ? this.each(function (e) {
                de(this).addClass(t.call(this, e, Ct(this)));
              })
            : (e = kt(t)).length
              ? this.each(function () {
                  if (
        ...
        removeClass: function (t) {
          ...
          return y(t)
            ? this.each(function (e) {
                de(this).removeClass(t.call(this, e, Ct(this)));
              })
            : arguments.length
              ? (e = kt(t)).length
                ? this.each(function () {
        ...
        toggleClass: function (t, n) {
          ...
          return y(t)
            ? this.each(function (e) {
                de(this).toggleClass(t.call(this, e, Ct(this), n), n);
              })
            : 'boolean' == typeof n && a
              ? n
                ? this.addClass(t)
              ...
              : ((e = kt(t)),
                this.each(function () {
                  if (a)
                    for (o = de(this), i = 0; i < e.length; i++)
                      (r = e[i]),
                        o.hasClass(r) ? o.removeClass(r) : o.addClass(r);
                  else
                    (void 0 !== t && 'boolean' !== s) ||
                      ((r = Ct(this)) && v.set(this, '__className__', r),
                      this.setAttribute &&
                        this.setAttribute(
                          'class',
        ...
        val: function (t) {
          ...
          return arguments.length
            ? ((r = y(t)),
              this.each(function (e) {
                1 === this.nodeType &&
                  (null == (e = r ? t.call(this, e, de(this).val()) : t)
                    ? (e = '')
                    : 'number' == typeof e
                      ? (e += '')
                      : Array.isArray(e) &&
                        (e = de.map(e, function (e) {
                          return null == e ? '' : e + '';
                        })),
                  ((n =
          ...
          select: {
            get: function (e) {
              for (
                ...
                if (
                  ((t = n[a]).selected || a === r) &&
                  !t.disabled &&
                  (!t.parentNode.disabled || !fe(t.parentNode, 'optgroup'))
                ) {
                  if (((t = de(t).val()), i)) return t;
                  o.push(t);
                }
              return o;
            },
            set: function (e, t) {
              for (
                ...
                ((r = i[s]).selected =
                  -1 < de.inArray(de.valHooks.option.get(r), o)) && (n = !0);
    ...
    rn =
      ((de.parseXML = function (e) {
        ...
        try {
          t = new oe.DOMParser().parseFromString(e, 'text/xml');
        } catch (e) {}
        return (
      ...
      (de.extend(de.event, {
        trigger: function (e, t, n, r) {
          ...
          if (
            ...
            if (!r && !c.noBubble && !g(n)) {
              for (
                s = c.delegateType || h, rn.test(s + h) || (f = f.parentNode);
                f;
                f = f.parentNode
              )
                u.push(f), (o = f);
              o === (n.ownerDocument || S) &&
                u.push(o.defaultView || o.parentWindow || oe);
            }
            for (i = 0; (f = u[i++]) && !e.isPropagationStopped(); )
              (d = f),
                (e.type = 1 < i ? s : c.bindType || h),
                (l =
                  (v.get(f, 'events') || Object.create(null))[e.type] &&
            ...
            return (
              ...
              r ||
                ...
                (a &&
                  ...
                  e.isPropagationStopped() && d.addEventListener(h, on),
                  n[h](),
                  e.isPropagationStopped() && d.removeEventListener(h, on),
        ...
        simulate: function (e, t, n) {
          n = de.extend(new de.Event(), n, { type: e, isSimulated: !0 });
    ...
    wn =
      ...
      de.extend({
        ...
        ajaxSetup: function (e, t) {
          return t ? Gt(Gt(e, de.ajaxSettings), t) : Gt(de.ajaxSettings, e);
        },
        ajaxPrefilter: Ut(mn),
        ajaxTransport: Ut(vn),
        ajax: function (e, t) {
          function l(e, t, n, r) {
            ...
            p ||
              ...
              !r &&
                -1 < de.inArray('script', g.dataTypes) &&
                de.inArray('json', g.dataTypes) < 0 &&
              ...
              (E.status = e),
              (E.statusText = (t || a) + ''),
              r ? y.resolveWith(m, [i, a, E]) : y.rejectWith(m, [E, a, o]),
              E.statusCode(w),
              (w = void 0),
              f &&
                v.trigger(r ? 'ajaxSuccess' : 'ajaxError', [E, g, r ? i : o]),
              b.fireWith(m, [E, a]),
              f &&
          ...
          var c,
            ...
            g = de.ajaxSetup({}, t),
            m = g.context || g,
            v = g.context && (m.nodeType || m.jquery) ? de(m) : de.event,
            y = de.Deferred(),
          ...
          if (
            (y.promise(E),
            (g.url = ((e || g.url || en.href) + '').replace(
              gn,
              en.protocol + '//'
            )),
            (g.type = t.method || t.type || g.method || g.type),
            (g.dataTypes = (g.dataType || '*').toLowerCase().match(C) || ['']),
            null == g.crossDomain)
          ) {
            i = S.createElement('a');
            try {
              (i.href = g.url),
                (i.href = i.href),
                (g.crossDomain =
                  bn.protocol + '//' + bn.host != i.protocol + '//' + i.host);
            } catch (e) {
              g.crossDomain = !0;
            }
          }
          if (
            (g.data &&
              ...
              (g.data = de.param(g.data, g.traditional)),
            Vt(mn, g, t, E),
            !p)
          ) {
            for (r in ((f = de.event && g.global) &&
              0 == de.active++ &&
              de.event.trigger('ajaxStart'),
            (g.type = g.type.toUpperCase()),
            (g.hasContent = !fn.test(g.type)),
            (d = g.url.replace(un, '')),
            g.hasContent
              ? g.data &&
                g.processData &&
                ...
                (g.data = g.data.replace(dn, '+'))
              : ((i = g.url.slice(d.length)),
                g.data &&
                  (g.processData || 'string' == typeof g.data) &&
                  ((d += (nn.test(d) ? '&' : '?') + g.data), delete g.data),
                !1 === g.cache &&
                  ((d = d.replace(hn, '$1')),
                  (i = (nn.test(d) ? '&' : '?') + '_=' + tn.guid++ + i)),
                (g.url = d + i)),
            g.ifModified &&
              (de.lastModified[d] &&
                E.setRequestHeader('If-Modified-Since', de.lastModified[d]),
              de.etag[d]) &&
              E.setRequestHeader('If-None-Match', de.etag[d]),
            ...
            E.setRequestHeader(
              ...
              g.dataTypes[0] && g.accepts[g.dataTypes[0]]
                ? g.accepts[g.dataTypes[0]] +
                    ('*' !== g.dataTypes[0] ? ', ' + yn + '; q=0.01' : '')
                : g.accepts['*']
            ),
            g.headers))
              E.setRequestHeader(r, g.headers[r]);
            if (g.beforeSend && (!1 === g.beforeSend.call(m, E, g) || p))
              return E.abort();
            if (
              ((a = 'abort'),
              b.add(g.complete),
              ...
              if (((E.readyState = 1), f && v.trigger('ajaxSend', [E, g]), p))
                return E;
              g.async &&
                0 < g.timeout &&
                (h = oe.setTimeout(function () {
                  E.abort('timeout');
                }, g.timeout));
              try {
                (p = !1), c.send(o, l);
    ...
    _n =
      (de.ajaxSetup({
        ...
        jsonpCallback: function () {
          var e = xn.pop() || de.expando + '_' + tn.guid++;
          return (this[e] = !0), e;
        },
      }),
      de.ajaxPrefilter('json jsonp', function (e, t, n) {
        ...
        if (s || 'jsonp' === e.dataTypes[0])
          return (
            ...
            s
              ? (e[s] = e[s].replace(Sn, '$1' + r))
              : !1 !== e.jsonp &&
                (e.url += (nn.test(e.url) ? '&' : '?') + e.jsonp + '=' + r),
            ...
            n.always(function () {
              void 0 === i ? de(oe).removeProp(r) : (oe[r] = i),
      ...
      (ce.createHTMLDocument =
        (((r = S.implementation.createHTMLDocument('').body).innerHTML =
          '<form></form><form></form>'),
      ...
      (de.fn.load = function (e, t, n) {
        var r,
          ...
          a = e.indexOf(' ');
        return (
          -1 < a && ((r = Tt(e.slice(a))), (e = e.slice(0, a))),
          y(t)
            ? ((n = t), (t = void 0))
          ...
          if (this[0]) {
            ...
            if ('fixed' === de.css(r, 'position'))
              ...
              e &&
                e !== r &&
                1 === e.nodeType &&
                (((i = de(e).offset()).top += de.css(e, 'borderTopWidth', !0)),
      ...
      de.each(['top', 'left'], function (e, n) {
        de.cssHooks[n] = Ye(ce.pixelPosition, function (e, t) {
          if (t)
            return (t = Ge(e, n)), Mt.test(t) ? de(e).position()[n] + 'px' : t;
        });
      }),
      de.each({ Height: 'height', Width: 'width' }, function (s, a) {
        de.each(
  ...
  return (
    (de.noConflict = function (e) {
      return (
        oe.$ === de && (oe.$ = Dn),
        e && oe.jQuery === de && (oe.jQuery = Cn),
        de
      );
    }),
    void 0 === E && (oe.jQuery = oe.$ = de),
    de
  );
});
var calendar,
  FullCalendar = (function (t) {
    ...
    function p(e, t, n) {
      ...
      if (
        (2 < arguments.length &&
          (s.children = 3 < arguments.length ? V.call(arguments, 2) : n),
        'function' == typeof e && null != e.defaultProps)
      )
        for (o in e.defaultProps) void 0 === s[o] && (s[o] = e.defaultProps[o]);
      return m(e, s, r, i, null);
    }
    function m(e, t, n, r, i) {
      ...
      return null == i && null != L.vnode && L.vnode(e), e;
    }
    function v() {
      return { current: null };
    }
    ...
    function b(e, t, n) {
      '-' === t[0]
        ...
        : (e[t] =
            null == n ? '' : 'number' != typeof n || G.test(t) ? n : n + 'px');
    }
    function E(e, t, n, r, i) {
      ...
      e: if ('style' === t)
        ...
        (o = t !== (t = t.replace(/Capture$/, ''))),
          ...
          (e.l[t + o] = n),
          n
            ? r || e.addEventListener(t, o ? A : S, o)
            : e.removeEventListener(t, o ? A : S, o);
    ...
    function x(e) {
      ((e.__d || ((e.__d = !0), !a.push(e)) || _.__r++) &&
        n === L.debounceRendering) ||
        ((n = L.debounceRendering) || R)(_);
    }
    function _() {
      var e, t, n, r, i, o, s;
      for (
        ...
        if (
            ...
            null == (p = t[d]) || 'boolean' == typeof p
              ...
              : 'string' == typeof p ||
                ...
                : Array.isArray(p)
                  ...
                  : 0 < p.__b
                    ? m(p.type, p.props, p.key, p.ref || null, p.__v)
                    : p)
        ) {
          if (
            ((p.__ = n),
            (p.__b = n.__b + 1),
            null === (h = b[d]) || (h && p.key == h.key && p.type === h.type))
          )
            b[d] = void 0;
          else
            for (u = 0; u < E; u++) {
          ...
          N(e, p, (h = h || W), i, o, s, a, l, c),
            ...
            null != f
              ...
              : l && h.__e == l && l.parentNode != e && (l = w(h));
        }
      for (n.__e = g, d = E; d--; )
        null != b[d] &&
          ...
          j(b[d], b[d]));
      if (v) for (d = 0; d < v.length; d++) B(v[d], v[++d], v[++d]);
    }
    function k(e, t, n) {
    ...
    function O(e) {
      ...
      if (e.__k)
        for (t = e.__k.length - 1; 0 <= t; t--)
          if ((n = e.__k[t]) && (n = O(n))) return n;
      return null;
    }
    function N(e, t, n, r, i, o, s, a, l) {
      var c,
        d,
        u,
        h,
        ...
        e: if ('function' == typeof A) {
          if (
            ...
            null != A.getDerivedStateFromProps &&
              ...
              f(d.__s, A.getDerivedStateFromProps(v, d.__s))),
            (h = d.props),
            (p = d.state),
            (d.__v = t),
            u)
          ...
          (d.state = d.__s),
            ...
            u ||
              ...
              (g = d.getSnapshotBeforeUpdate(h, p)),
            (C =
              null != c && c.type === y && null == c.key
                ? c.props.children
                : c),
            T(e, Array.isArray(C) ? C : [C], t, n, r, i, o, s, a, l),
            (d.base = t.__e),
            (t.__h = null),
    ...
    function H(e, t, n, r, i, o, s, a) {
      ...
      if (null === p) u === h || (a && e.data === h) || (e.data = h);
      else {
        if (
          ((o = o && V.call(e.childNodes)),
          (c = (u = n.props || W).dangerouslySetInnerHTML),
          (d = h.dangerouslySetInnerHTML),
          !a)
        ) {
          if (null != o)
            for (u = {}, f = 0; f < e.attributes.length; f++)
              u[e.attributes[f].name] = e.attributes[f].value;
          (!d && !c) ||
        ...
        var m,
          ...
          S = a;
        for (m in b)
          'children' === m || 'key' === m || m in y || E(v, m, null, b[m], x);
        for (m in y)
          (S && 'function' != typeof y[m]) ||
            'children' === m ||
            'key' === m ||
            'value' === m ||
            'checked' === m ||
        ...
        if (d) t.__k = [];
          ...
          for (f = o.length; f--; ) null != o[f] && g(o[f]);
        a ||
          ('value' in h &&
            void 0 !== (f = h.value) &&
            (f !== e.value ||
              ('progress' === p && !f) ||
              ('option' === p && f !== u.value)) &&
            E(e, 'value', f, u.value, !1),
          'checked' in h &&
            void 0 !== (f = h.checked) &&
            f !== e.checked &&
            E(e, 'checked', f, u.checked, !1));
      }
      return e;
    }
    function B(e, t, n) {
    ...
    function j(e, t, n) {
      ...
      if (
        ...
        !(r = e.ref) || (r.current && r.current !== e.__e) || B(r, null, t),
        null != (r = e.__c))
      ) {
      ...
      if ((r = e.__k))
        for (i = 0; i < r.length; i++)
          r[i] && j(r[i], t, n || 'function' != typeof e.type);
    ...
    function U(e, t, n) {
      ...
      L.__ && L.__(e, t),
        ...
        N(
          t,
          (e = ((!r && n) || t).__k = p(y, null, [e])),
          i || W,
          W,
          void 0 !== t.ownerSVGElement,
          !r && n ? [n] : !i && t.firstChild ? V.call(t.childNodes) : null,
          o,
      ...
      (n.componentWillUnmount = function () {
        ...
        e.__v
          ? (n.l ||
            ...
            U(p(ue, { context: n.context }, e.__v), n.l))
    ...
    function _e(e) {
      ...
      if (!t || !t.isConnected) {
        if (((t = e.querySelector('style[data-fullcalendar]')), !t)) {
          ...
          const r = At,
            i = (r && (t.nonce = r), e === document ? document.head : e),
            o =
              e === document
                ? i.querySelector(
    ...
    function Pe(e, n) {
      let r = e instanceof HTMLElement ? [e] : e,
        i = [];
      for (let e = 0; e < r.length; e += 1) {
        let t = r[e].querySelectorAll(n);
    ...
    function bt(n, r) {
      ...
      for (let e = 0; e < Xt.length; e += 1) {
        ...
        if (r[t]) {
          let e = n[t] / r[t];
          if (!ct(e) || (null !== i && i !== e)) return null;
          i = e;
    ...
    function Gt(n, r, i) {
      ...
      return function (...t) {
        if (e) {
          if (!St(e, t)) {
            i && i(o);
            let e = n.apply(this, t);
            (r && r(e, o)) || (o = e);
          }
        } else o = n.apply(this, t);
        return (e = t), o;
      };
    }
    function Qt(n, r, i) {
      ...
      let t = Object.keys(e).length;
      {
          ...
          return (t) => {
            {
              ...
              return (
                'long' === o
                  ? e.push(r)
                  : ('short' !== o && 'narrow' !== o) || e.push(n),
                ('long' !== o && 'short' !== o) || e.push(' '),
          ...
          };
        {
          ...
          (d = Object.assign({}, d)),
            ...
            (d.timeZone = 'UTC');
          let a,
            l = new Intl.DateTimeFormat(h.locale.codes, d);
          if (u.omitZeroMinute) {
            let e = Object.assign({}, d);
            delete e.minute, (a = new Intl.DateTimeFormat(h.locale.codes, e));
          }
          return (e) => {
            let t,
              n = e['marker'];
            return (
              (t = a && !n.getUTCMinutes() ? a : l),
              (r = t.format(n)),
              (e = e),
              (i = d),
              (o = u),
              ...
              'short' === i.timeZoneName &&
                (r = (function (e, t) {
                  let n = !1;
                  return (
                    (e = e.replace(bn, () => ((n = !0), t))),
                    n || (e += ' ' + t),
                    e
                  );
                })(
                  r,
                  'UTC' === s.timeZone || null == e.timeZoneOffset
                    ? 'UTC'
                    : Vt(e.timeZoneOffset)
                )),
              o.omitCommas && (r = r.replace(un, '').trim()),
              o.omitZeroMinute && (r = r.replace(':00', '')),
              !1 === o.meridiem
                ? (r = r.replace(dn, '').trim())
                : 'narrow' === o.meridiem
                  ? (r = r.replace(dn, (e, t) => t.toLocaleLowerCase()))
                  : 'short' === o.meridiem
                    ? (r = r.replace(dn, (e, t) => t.toLocaleLowerCase() + 'm'))
                    : 'lowercase' === o.meridiem &&
                      (r = r.replace(dn, (e) => e.toLocaleLowerCase())),
              (r = r.replace(hn, ' ')).trim()
            );
            var r, i, o, s;
          };
        ...
        for (var o in e)
          if (e[o] === fn) {
            ...
            for (let t = r.length - 1; 0 <= t; --t) {
              let e = r[t][o];
              if ('object' == typeof e && e) n.unshift(e);
              else if (void 0 !== e) {
                i[o] = e;
                break;
              }
    ...
    function Cn(e, t) {
      if (e !== t) {
        for (var n in e) if (Ln.call(e, n) && !(n in t)) return !1;
        for (var r in t) if (Ln.call(t, r) && e[r] !== t[r]) return !1;
      }
      return !0;
    }
    function xn(e, t) {
      let n = [];
      for (var r in e) !Ln.call(e, r) || r in t || n.push(r);
      for (var i in t) Ln.call(t, i) && e[i] !== t[i] && n.push(i);
      return n;
    }
    function _n(e, t, n = {}) {
      if (e !== t) {
        for (var r in t) if (!(r in e && Tn(e[r], t[r], n[r]))) return !1;
    ...
    function kn(n, e = 0, r, i = 1) {
      let o = [];
      null == r && (r = Object.keys(n).length);
      for (let t = e; t < r; t += i) {
        let e = n[t];
        void 0 !== e && o.push(e);
      }
        ...
        if (jt(t)) {
          ...
          return (
            n[13] &&
              (e =
                ('-' === n[15] ? -1 : 1) *
                (60 * Number(n[16] || 0) + Number(n[18] || 0))),
            { marker: t, isTimeUnspecified: !n[6], timeZoneOffset: e }
          );
        }
      }
      return null;
    ...
    function Fn(e, t, n, r, i, o, s, a, l, c, d, u, h) {
      return {
        dateEnv: i,
        options: n,
        pluginHooks: s,
    ...
    function dr(t, n = ft(0)) {
      let e = null,
        r = null;
      if (t.end) {
        r = Mt(t.end);
        let e = t.end.valueOf() - r.valueOf();
        e && e >= yt(n) && (r = wt(r, 1));
      }
      return (
        t.start && ((e = Mt(t.start)), r) && r <= e && (r = wt(e, 1)),
        { start: e, end: r }
      );
    }
    function ur(e) {
      let t = dr(e);
      return 1 < xt(t.start, t.end);
    }
    function hr(e, t, n, r) {
      return 'year' === r
    ...
    function mr(e, r, t) {
      let { dateEnv: i, pluginHooks: o, options: s } = t,
        { defs: a, instances: l } = e;
      for (var c in ((l = Sn(l, (e) => !a[e.defId].recurringDef)), a)) {
        let n = a[c];
        if (n.recurringDef) {
          let t = n.recurringDef['duration'],
            e =
              ((t =
                t ||
                (n.allDay
              ...
              vr(n, t, r, i, o.recurringTypes));
          for (var d of e) {
            let e = pr(c, { start: d, end: i.add(d, t) });
            l[e.instanceId] = e;
          }
        }
      }
      return { defs: a, instances: l };
    }
    ...
    function Sr(e, n, r, t, i = Dr(r), o, s) {
      let { refined: a, extra: l } = Ar(e, r, i),
        c = (function (e, t) {
          let n = null;
          return (
            e && (n = e.defaultAllDay),
        ...
        d = (function (r, i, e, o) {
          ...
          return null;
        })(a, c, r.dateEnv, r.pluginHooks.recurringTypes);
      if (d) {
        let e = wr(
          a,
          l,
      ...
      let u = (function (e, t, n, r) {
        ...
        return (
          ...
          s && (a = a && Mt(a)),
          o && ((c = o.marker), s && (c = Mt(c)), a) && c <= a && (c = null),
          c
            ? (l = !0)
            : r ||
      ...
      if (u) {
        let e = wr(a, l, n ? n.sourceId : '', u.allDay, u.hasEnd, r, o),
          t = pr(e.defId, u.range, u.forcedStartTzo, u.forcedEndTzo);
        return (
          s && e.publicId && s[e.publicId] && (t.instanceId = s[e.publicId]),
          { def: e, instance: t }
        );
      }
      return null;
    ...
    function Dr(e) {
      return Object.assign(
        Object.assign(Object.assign({}, Qr), Br),
    ...
    function wr(e, t, n, r, i, o, s) {
      ...
      for (var l of o.pluginHooks.eventDefMemberAdders) Object.assign(a, l(e));
    ...
    function xr(t, e) {
      ...
      if (r) {
        let n = t.defs[r.defId],
          e = kr(t, (e) => {
            return (
              (t = n), (e = e), Boolean(t.groupId && t.groupId === e.groupId)
            );
            var t;
          });
    ...
    function jr(r, i, o = zr(i)) {
      ...
      if (
        ...
        let { refined: e, extra: t } = vn(s, o),
          n = (function (n, e) {
            let r = e.pluginHooks.eventSourceDefs;
            for (let t = r.length - 1; 0 <= t; --t) {
              let e = r[t].parseMeta(n);
              if (e) return { sourceDefId: t, meta: e };
            }
            return null;
          })(e, i);
        if (n)
          return {
            ...
            latestFetchId: '',
            fetchRange: null,
            defaultAllDay: e.defaultAllDay,
            eventDataTransform: e.eventDataTransform,
            success: e.success,
            failure: e.failure,
            publicId: e.id || '',
            sourceId: Ze(),
    ...
    function zr(e) {
      return Object.assign(
        Object.assign(Object.assign({}, Qr), _i),
        e.pluginHooks.eventSourceRefiners
      );
    }
    function Ur(i, o, e, t, n) {
      switch (o.type) {
        case 'RECEIVE_EVENTS':
          var r = i,
            s = e[o.sourceId],
            ...
            c = o.rawEvents,
            d = n;
          if (s && a === s.latestFetchId) {
            let e = Cr(Wr(c, s, d), s, d);
            return l && (e = mr(e, l, d)), Tr(Vr(r, s.sourceId), e);
          }
          return r;
        case 'RESET_RAW_EVENTS': {
          ...
          d = t.activeRange;
          s = n;
          const { defIdMap: v, instanceIdMap: y } = (function (e) {
          ...
          return mr(Cr(Wr(l, c, s), c, s, !1, v, y), d, s);
          return;
        }
        case 'ADD_EVENTS':
          return (
        ...
        case 'RESET_EVENTS':
          return o.eventStore;
        case 'MERGE_EVENTS':
          return Tr(i, o.eventStore);
        case 'PREV':
        case 'NEXT':
        case 'CHANGE_DATE':
        case 'CHANGE_VIEW_TYPE':
          return t ? mr(i, t.activeRange, n) : i;
        case 'REMOVE_EVENTS': {
          g = i;
          var u = o.eventStore;
          let { defs: e, instances: t } = g,
            n = {},
            r = {};
          for (var h in e) u.defs[h] || (n[h] = e[h]);
          for (var p in t) !u.instances[p] && n[t[p].defId] && (r[p] = t[p]);
          return { defs: n, instances: r };
          return;
        }
        case 'REMOVE_EVENT_SOURCE':
          return Vr(i, o.sourceId);
        case 'REMOVE_ALL_EVENT_SOURCES':
          return kr(i, (e) => !e.sourceId);
              ...
              !0 === e
                ...
                : Array.isArray(e)
                  ...
                  : 'object' == typeof e && e
                    ? [e]
                    : []),
            (t = t.map((e) => Object.assign(Object.assign({}, Oi), e))),
            t
          );
        })(e),
        null,
    ...
    function Zr(e, t) {
      let n = {};
      for (var r of t.pluginHooks.dateSpanTransforms) Object.assign(n, r(e, t));
      var i, o;
      return (
        Object.assign(
          n,
          ((i = e),
          (o = t.dateEnv),
          Object.assign(Object.assign({}, wi(i.range, o, i.allDay)), {
            allDay: i.allDay,
          }))
        ),
        n
    ...
    function Xr(e, t, n) {
      ...
      return (
        (o = e
          ? ((o = Mt(o)), r.add(o, i.defaultAllDayEventDuration))
          : r.add(o, i.defaultTimedEventDuration)),
        o
      );
    }
    function $r(n, e, r, i) {
      ...
      for (var t in n.defs) {
        let e = n.defs[t];
        s.defs[t] = Jr(e, o[t], r, i);
      }
      for (var a in n.instances) {
        let e = n.instances[a],
          t = s.defs[e.defId];
        s.instances[a] = Kr(e, t, o[e.defId], r, i);
      }
      return s;
    }
    function Jr(e, t, n, r) {
      ...
      for (var s of r.pluginHooks.eventDefMutationAppliers) s(o, n, r);
    ...
    function ri(e, n, t) {
      ...
      for (var a in i) {
        let e = i[a],
          t = r[e.defId];
        e.instanceId !== s && o.push(new ti(n, t, e));
      }
      return o;
    }
    function ii(s, e, a, l) {
      ...
      for (var t in s.defs) {
        let e = s.defs[t];
        'inverse-background' === p[e.defId].display &&
          (e.groupId
            ? ((c[e.groupId] = []), n[e.groupId] || (n[e.groupId] = e))
            : (d[t] = []));
      }
      for (var f in s.instances) {
        let e = s.instances[f],
          t = s.defs[e.defId],
          n = p[t.defId],
          r = e.range,
          i = !t.allDay && l ? dr(r, l) : r,
          o = ir(i, a);
        o &&
          ('inverse-background' === n.display
            ? (t.groupId ? c[t.groupId] : d[e.defId]).push(o)
            : 'none' !== n.display &&
              ('background' === n.display ? u : h).push({
                def: t,
                ui: n,
                instance: e,
                range: o,
                isStart: i.start && i.start.valueOf() === o.start.valueOf(),
                isEnd: i.end && i.end.valueOf() === o.end.valueOf(),
              }));
      }
      for (var r in c) {
        let e = nr(c[r], a);
    ...
    function di(e, n) {
      let t = e.map(ui);
      return t.sort((e, t) => rt(e, t, n)), t.map((e) => e._seg);
    }
    function ui(e) {
      let t = e['eventRange'],
        n = t.def,
    ...
    function pi(e, t, n, r, i, o, s) {
      let { dateEnv: a, options: l } = n,
        ...
        v = Mt(p).valueOf() === Mt(g).valueOf(),
        y = Mt(Ct(f, -1)).valueOf() === Mt(Ct(m, -1)).valueOf();
    ...
    function bi(e, t) {
      ...
      let { emitter: o, options: s } = t,
        a = s['eventInteractive'];
      return (
        null == a &&
          ((a = n.interactive), null == a) &&
          (a = Boolean(o.hasHandlers('eventClick'))),
        a
          ? qe((e) => {
        ...
        fetch(t, r).then((t) => {
          if (t.ok)
            return t.json().then(
              (e) => [e, t],
              () => {
                throw new Ri('Failure parsing JSON', t);
              }
            );
          throw new Ri('Request failed', t);
        })
      );
    }
    function Ti() {
    ...
    function qi(e, n, r = 'day', t = !0) {
      const { dateEnv: i, options: o, calendarApi: s } = e;
      let a = i.format(n, 'week' === r ? lo : Zi);
      if (o.navLinks) {
        let e = i.toDate(n);
        const l = (e) => {
          let t =
            'day' === r
              ...
              : 'week' === r
                ...
                : null;
          'function' == typeof t
            ? t.call(s, i.toDate(n), e)
            : ('string' == typeof t && (r = t), s.zoomTo(n, r));
        };
        return Object.assign(
          { title: at(o.navLinkHint, [a, e], a), 'data-navlink': '' },
          t ? Qe(l) : { onClick: l }
        );
      }
      return { 'aria-label': a };
    ...
    function ns(t) {
      ...
      for (; t instanceof HTMLElement; ) {
        ...
        /(auto|scroll)/.test(e.overflow + e.overflowY + e.overflowX) &&
          n.push(t),
          (t = t.parentNode);
      }
      return n;
    ...
    function ps(n, r, i) {
      let o = 0,
        s = n.length;
      if (!s || r < i(n[o])) return [0, 0];
      if (r > i(n[s - 1])) return [s, 0];
      for (; o < s; ) {
        let e = Math.floor(o + (s - o) / 2),
          t = i(n[e]);
        if (r < t) s = e;
        else {
          if (!(r > t)) return [e, 1];
    ...
    function Ns(e, t, n) {
      let r = e.mutatedEvents['instances'];
      for (var i in r) if (!ar(t.validRange, r[i].range)) return !1;
    ...
    function Bs(e, t, n = {}, r) {
      return !(
        (e.eventDrag &&
          !(function (a, l, c, e) {
            let d = l.getCurrentData(),
              u = a.eventDrag,
              t = u.mutatedEvents,
              h = t.defs,
              p = t.instances,
              f = li(h, u.isEvent ? a.eventUiBases : { '': d.selectionConfig }),
              g =
                (e && (f = An(f, e)),
                (e = a.eventStore),
                (n = u.affectedEvents.instances),
                {
                  defs: e.defs,
                  instances: Sn(e.instances, (e) => !n[e.instanceId]),
                }),
              m = g.defs,
              v = g.instances,
              y = li(m, a.eventUiBases);
            var n, b;
            for (b in p) {
              let i = p[b],
                t = i.range,
                n = f[i.defId],
                o = h[i.defId];
              if (!js(n.constraints, t, g, a.businessHours, l)) return;
              let e = l.options['eventOverlap'],
                r = 'function' == typeof e ? e : null;
              for (var w in v) {
                let e = v[w];
                if (or(t, e.range)) {
                  if (!1 === y[e.defId].overlap && u.isEvent) return;
                  if (!1 === n.overlap) return;
                  if (r && !r(new ti(l, m[e.defId], e), new ti(l, o, i)))
                    return;
                }
              }
              let s = d.eventStore;
              for (var E of n.allows) {
                let e,
                  ...
                  n = s.defs[o.defId],
                  r = s.instances[b];
                if (((e = n ? new ti(l, n, r) : new ti(l, o)), !E(Zr(t, l), e)))
                  return;
              }
            }
            return 1;
        ...
        (e.dateSelection &&
          !(function (e, n, r, t) {
            let i = e.eventStore,
              ...
              a = e.dateSelection,
              l = a.range,
              c = n.getCurrentData()['selectionConfig'];
            if (
              (t && (c = t(c)), js(c.constraints, l, i, e.businessHours, n))
            ) {
              let e = n.options['selectOverlap'],
                t = 'function' == typeof e ? e : null;
              for (var d in s) {
                let e = s[d];
                if (or(l, e.range)) {
                  if (!1 === c.overlap) return;
                  if (t && !t(new ti(n, o[e.defId], e), null)) return;
                }
              }
              for (var u of c.allows) {
                let e = Object.assign(Object.assign({}, r), a);
                if (!u(Zr(e, n), null)) return;
              }
              return 1;
            }
          })(e, t, n, r))
    ...
    function js(e, t, n, r, i) {
      for (var o of e) if (!Ws(zs(o, t, n, r, i), t)) return !1;
      return !0;
    }
    ...
    function Ws(e, t) {
      for (var n of e) if (ar(n, t)) return !0;
      return !1;
    }
    function Gs(e) {
      let t = Pe(e, '.fc-scrollgrid-shrink'),
        n = 0;
      for (var r of t) n = Math.max(n, dt(r));
      return Math.ceil(n);
    }
    function Qs(e, t) {
      ...
      for (var i of e) {
        ...
        for (let e = 0; e < t; e += 1)
          r.push(
            p('col', {
              style: {
                width: 'shrink' === i.width ? $s(n) : i.width || '',
                minWidth: i.minWidth || '',
              },
            })
          );
    ...
    function fo(e) {
      let { date: t, dateEnv: n, dateProfile: r, isMonthStart: i } = e,
        o = Fi(t, e.todayRange, null, r),
        s = e.showDayNumber ? n.format(t, i ? e.monthStartFormat : vs) : '';
      return Object.assign(
        Object.assign(
    ...
    function Do(e) {
      ...
      return {
        start: wo(t),
        end: ((e = t), e.reduce(Ro).eventRange.range.end),
      };
    }
    function wo(e) {
    ...
    function Io(e) {
      let t = 0 < e.length ? e[0].code : 'en',
        n = Ls.concat(e),
        r = { en: Ia };
      for (var i of n) r[i.code] = i;
    ...
    function Oo(n, r) {
          ...
          t =
            (function (t, r) {
              for (let e = 0; e < t.length; e += 1) {
                let n = t[e].toLocaleLowerCase().split('-');
                for (let t = n.length; 0 < t; --t) {
                  let e = n.slice(0, t).join('-');
                  if (r[e]) return r[e];
                }
              }
              return null;
      ...
      return No(n.code, [n.code], n);
    }
    function No(e, t, n) {
      let r = En([ca, n], ['buttonText']),
        i = (delete r.code, r)['week'];
      return (
        delete r.week,
        {
          codeArg: e,
                  ...
                  ? ((s[e] = t.id),
                    ...
                    (a = {
                      premiumReleaseDate: Bo(
                        (n = a).premiumReleaseDate,
                        r.premiumReleaseDate
                      ),
                      reducers: n.reducers.concat(r.reducers),
                      isLoadingFuncs: n.isLoadingFuncs.concat(r.isLoadingFuncs),
                      contextInit: n.contextInit.concat(r.contextInit),
                      eventRefiners: Object.assign(
                        Object.assign({}, n.eventRefiners),
                        r.eventRefiners
                      ),
                      eventDefMemberAdders: n.eventDefMemberAdders.concat(
                        r.eventDefMemberAdders
                      ),
                      eventSourceRefiners: Object.assign(
                        Object.assign({}, n.eventSourceRefiners),
                        r.eventSourceRefiners
                      ),
                      isDraggableTransformers: n.isDraggableTransformers.concat(
                        r.isDraggableTransformers
                      ),
                      eventDragMutationMassagers:
                        n.eventDragMutationMassagers.concat(
                          r.eventDragMutationMassagers
                        ),
                      eventDefMutationAppliers:
                        n.eventDefMutationAppliers.concat(
                          r.eventDefMutationAppliers
                        ),
                      dateSelectionTransformers:
                        n.dateSelectionTransformers.concat(
                          r.dateSelectionTransformers
                        ),
                      datePointTransforms: n.datePointTransforms.concat(
                        r.datePointTransforms
                      ),
                      dateSpanTransforms: n.dateSpanTransforms.concat(
                        r.dateSpanTransforms
                      ),
                      views: Object.assign(Object.assign({}, n.views), r.views),
                      viewPropsTransformers: n.viewPropsTransformers.concat(
                        r.viewPropsTransformers
                      ),
                      isPropsValid: r.isPropsValid || n.isPropsValid,
                      externalDefTransforms: n.externalDefTransforms.concat(
                        r.externalDefTransforms
                      ),
                      viewContainerAppends: n.viewContainerAppends.concat(
                        r.viewContainerAppends
                      ),
                      eventDropTransformers: n.eventDropTransformers.concat(
                        r.eventDropTransformers
                      ),
                      calendarInteractions: n.calendarInteractions.concat(
                        r.calendarInteractions
                      ),
                      componentInteractions: n.componentInteractions.concat(
                        r.componentInteractions
                      ),
                      themeClasses: Object.assign(
                        Object.assign({}, n.themeClasses),
                        r.themeClasses
                      ),
                      eventSourceDefs: n.eventSourceDefs.concat(
                        r.eventSourceDefs
                      ),
                      cmdFormatter: r.cmdFormatter || n.cmdFormatter,
                      recurringTypes: n.recurringTypes.concat(r.recurringTypes),
                      namedTimeZonedImpl:
                        r.namedTimeZonedImpl || n.namedTimeZonedImpl,
                      initialView: n.initialView || r.initialView,
                      elementDraggingImpl:
                        n.elementDraggingImpl || r.elementDraggingImpl,
                      optionChangeHandlers: Object.assign(
                        Object.assign({}, n.optionChangeHandlers),
                        r.optionChangeHandlers
                      ),
                      scrollGridImpl: r.scrollGridImpl || n.scrollGridImpl,
        ...
        (a) => {
          {
            ...
            if (
              ...
              ((t = (function (e) {
                let t = JSON.stringify(e),
                  n = Oa[t];
                return void 0 === n && ((n = ft(e)), (Oa[t] = n)), n;
              })(e)),
              t)
            ) {
              let e = Et(t);
              (n = e.unit),
                1 === e.value && ((r = n), (i = a[n] ? a[n].rawOptions : {}));
            }
            let o = (e) => {
                let t = e.buttonText || {},
                  n = l.defaults.buttonTextKey;
            ...
            return {
              ...
              optionOverrides: Object.assign(Object.assign({}, i), l.overrides),
              buttonTextOverride: o(d) || o(c) || l.overrides.buttonText,
              buttonTextDefault:
                o(u) || l.defaults.buttonText || o(F) || l.type,
              buttonTitleOverride: s(d) || s(c) || l.overrides.buttonHint,
              buttonTitleDefault: s(u) || l.defaults.buttonHint || s(F),
            };
          }
        }
      );
    ...
    function Qo(t, n, e, r) {
      ...
      switch (n.type) {
        case 'ADD_EVENT_SOURCES':
          return Yo(t, n.sources, i, r);
        case 'REMOVE_EVENT_SOURCE':
          return (l = t), (c = n.sourceId), Sn(l, (e) => e.sourceId !== c);
        case 'PREV':
        case 'NEXT':
        case 'CHANGE_DATE':
        case 'CHANGE_VIEW_TYPE':
        ...
        case 'FETCH_EVENT_SOURCES':
          return Xo(
            t,
            n.sourceIds ? Dn(n.sourceIds) : Jo(t, r),
            i,
            n.isRefetch || !1,
            r
          );
    ...
    function Xo(t, n, r, i, o) {
      let s = {};
      for (var a in t) {
        let e = t[a];
        n[a] ? (s[a] = $o(e, r, i, o)) : (s[a] = e);
      }
      return s;
    }
    function $o(n, r, e, i) {
      let { options: o, calendarApi: s } = i,
        ...
        t.fetch(
          ...
          (e) => {
            ...
            o.eventSourceSuccess &&
              (t = o.eventSourceSuccess.call(s, t, e.response) || t),
              n.success && (t = n.success.call(s, t, e.response) || t),
              i.dispatch({
                type: 'RECEIVE_EVENTS',
                sourceId: n.sourceId,
                fetchId: a,
          ...
          (e) => {
            let t = !1;
            o.eventSourceFailure && (o.eventSourceFailure.call(s, e), (t = !0)),
    ...
    function sa(t, n, r, i, o, s) {
      let a = {},
        l = [],
        c = !1;
      for (var d in t) {
        let e = oa(t[d], n, r, i, o, s);
        (a[d] = e.widgets),
          l.push(...e.viewsWithButtons),
          (c = c || e.hasTitle);
      }
      return { sectionWidgets: a, viewsWithButtons: l, hasTitle: c };
    }
    function oa(e, l, t, c, d, u) {
          ...
          e.split(',').map((t) => {
            ...
            if ((n = p[t]))
              (i = (e) => {
                ...
                (o =
                  (o = c.getCustomButtonIconClass(n)) ||
              ...
              y.push(t),
                ...
                (s = r.buttonTextOverride) ||
                  (o = c.getIconClass(t, h)) ||
                  (s = r.buttonTextDefault);
              let e = r.buttonTextOverride || r.buttonTextDefault;
              a = at(
                r.buttonTitleOverride || r.buttonTitleDefault || l.viewHint,
                [e, t],
                e
              );
            } else if (u[t])
              if (
                ...
                (s = f[t]) || (o = c.getIconClass(t, h)) || (s = g[t]),
                'prevYear' === t || 'nextYear' === t)
              ) {
                let e = 'prevYear' === t ? 'prev' : 'next';
                a = at(m[e] || v[e], [g.year || 'year', 'year'], g[t]);
              } else a = (e) => at(m[t] || v[t], [g[e] || e, e], g[t]);
            return {
              buttonName: t,
              buttonClick: i,
              buttonIcon: o,
    ...
    function la(t, n) {
      let r = wn(n.getCurrentData().eventSources);
      if (
        1 === r.length &&
        1 === t.length &&
        ...
        for (var s of e) n.calendarApi.addEventSource(s);
      }
    }
    function ua(e, t, n) {
      let r;
    ...
    function fa(e, t, n, r, i, o, s, a) {
      let l = Oo(t || s.defaultCode, s.map);
      return new Hn({
    ...
    function ya(t, e, n) {
      ...
      for (var i in t) {
        let e = t[i];
        e.sourceId && n[e.sourceId] && (r[i] = n[e.sourceId]);
      }
      return r;
    }
    function ba(e) {
    ...
    function Ta(e, t, n, r, i, o) {
      ...
      return {
        ...
        isTodayEnabled: s.isValid && !lr(t.currentRange, i),
    ...
    function Ma(e) {
      ...
      return new Hn(
        Object.assign(
          Object.assign({ timeZone: F.timeZone, calendarSystem: 'gregory' }, e),
          { locale: t }
        )
      );
    }
    ...
    function Ya(e, t) {
      let n = {};
      for (var r of t.pluginHooks.datePointTransforms)
      ...
      return (
        Object.assign(
          ...
          ((i = e),
          {
            date: (o = t.dateEnv).toDate(i.range.start),
            dateStr: o.formatIso(i.range.start, { omitTime: i.allDay }),
            allDay: i.allDay,
          })
        ),
        n
    ...
    function ml(r, e, t, n, i, o, s) {
      let a = new yl((e) => {
          let t =
            r[e.index].eventRange.instance.instanceId +
            ':' +
            e.span.start +
            ':' +
            (e.span.end - 1);
        ...
        l =
          ...
          !0 === e || !0 === t
            ...
            : 'number' == typeof e
              ? (a.maxStackCnt = e)
              : 'number' == typeof t &&
                ((a.maxStackCnt = t), (a.hiddenConsumes = !0)),
          []),
        c = [];
      for (let n = 0; n < r.length; n += 1) {
        ...
        null != i[t]
          ? l.push({
              index: n,
              span: { start: e.firstCol, end: e.lastCol + 1 },
            })
          : c.push(e);
      }
      let d = a.addSegs(l),
          ...
          for (let s = 0; s < l.length; s += 1) {
            ...
            for (var h of e) {
              ...
              t.push({
                ...
                marginTop: h.levelCoord - r,
              }),
                (r = h.levelCoord + h.thickness);
            }
            let o = [];
            (r = 0), (i = 0);
            for (var p of e) {
              let e = a[p.index],
                t = 1 < p.span.end - p.span.start,
                n = p.span.start === s;
              (i += p.levelCoord - r),
                (r = p.levelCoord + p.thickness),
                t
                  ? ((i += p.thickness),
                    n &&
                      o.push({
                        seg: vl(e, p.span.start, p.span.end, l),
                        isVisible: !0,
                        isAbsolute: !0,
      ...
      for (var v of c) {
        ...
        for (let e = v.firstCol; e <= v.lastCol; e += 1)
          h[e].push({
            seg: vl(v, e, e + 1, s),
            isVisible: !1,
            isAbsolute: !1,
      ...
      for (var y of d) {
        let t = r[y.index],
          n = y.span;
        p[n.start].push({
          seg: vl(t, n.start, n.end, s),
          isVisible: !1,
          isAbsolute: !0,
          absoluteTop: 0,
          marginTop: 0,
        });
        for (let e = n.start; e < n.end; e += 1)
          (g[e] += 1),
            h[e].push({
              seg: vl(t, e, e + 1, s),
              isVisible: !1,
      ...
      for (let e = 0; e < s.length; e += 1) m.push(f[e]);
      return {
        singleColPlacements: h,
        multiColPlacements: p,
        moreCnts: g,
    ...
    function vl(e, t, n, r) {
      ...
      let i = e.eventRange,
        o = i.range,
        s = ir(o, { start: r[t].date, end: wt(r[n - 1].date, 1) });
    ...
    function Il(s) {
      let a = [
        ...
        s.isLabeled ? 'fc-scrollgrid-shrink' : 'fc-timegrid-slot-minor',
      ];
      return p(h.Consumer, null, (e) => {
        if (!s.isLabeled)
          return p('td', { className: a.join(' '), 'data-time': s.isoTimeStr });
        let { dateEnv: t, options: n, viewApi: r } = e,
          i =
            null == n.slotLabelFormat
              ? lc
              : Array.isArray(n.slotLabelFormat)
                ? an(n.slotLabelFormat[0])
                : an(n.slotLabelFormat),
          o = {
            level: 0,
            time: s.time,
            date: t.toDate(s.date),
            view: r,
            text: t.format(s.date, i),
          };
        return p(
          Jn,
          {
    ...
    function Gl(e, t, n) {
      let r = new cs(),
        i =
          ...
          hs(r.addSegs(e))),
        o = (function (i) {
          const o = i['entriesByLevel'],
            s = Zl(
              (e, t) => e + ':' + t,
              (e, t) => {
                let n = Ql(
                    (function (e, t, n) {
                      let { levelCoords: r, entriesByLevel: o } = e,
                        s = o[t][n],
                        i = r[t] + s.thickness,
                        a = r.length,
                        l = t;
                      ...
                      for (; l < a; l += 1) {
                        let e,
                          ...
                          r = n[0] + n[1],
                          i = r;
                        for (; (e = t[i]) && e.span.start < s.span.end; )
                          i += 1;
                        if (r < i)
                          return { level: l, lateralStart: r, lateralEnd: i };
                      }
                      return null;
                    })(i, e, t),
                    s
                  ...
                  r = o[e][t];
                return [
                  Object.assign(Object.assign({}, r), { nextLevelNodes: n[0] }),
                  r.thickness + n[1],
                ];
              }
            );
      ...
      return (
        (o = (function (e, u) {
          const h = Zl(
            ...
            (e, t, n) => {
              let r,
                { nextLevelNodes: i, thickness: o } = e,
                s = o + n,
                a = o / s,
                l = [];
              if (i.length)
            ...
            const s = Zl(
              ...
              (e, t, n) => {
                ...
                return (
                  o.push(i),
                  (i.stackForward =
                    r(e.nextLevelNodes, t + e.thickness, n + 1) + 1)
                );
              }
            );
            return r(e, 0, 0), o;
    ...
    function Ql(e, t) {
      ...
      let { level: n, lateralStart: r, lateralEnd: i } = e,
        o = r,
        s = [];
      for (; o < i; ) s.push(t(n, o)), (o += 1);
      return s.sort(ql), [s.map(Yl), s[0][1]];
    }
    function ql(e, t) {
      return t[1] - e[1];
    }
    ...
    function Xl(i, o, s = null, a = 0) {
      let l = [];
      if (s)
        for (let r = 0; r < i.length; r += 1) {
          let e = i[r],
            t = s.computeDateTop(e.start, o),
            n = Math.max(t + (a || 0), s.computeDateTop(e.end, o));
          l.push({ start: Math.round(t), end: Math.round(n) });
        }
      return l;
    }
    function ec(
      ...
      return p(
        ...
        null,
        e.map((e) => {
          let t = e.eventRange.instance.instanceId;
          return p(
            'div',
            { key: t, style: { visibility: s[t] ? 'hidden' : '' } },
            p(
              Jl,
              Object.assign(
                {
    ...
    function cc(e, t, n, r, i) {
      let o = new Date(0),
        ...
        l =
          ...
          (function (e) {
            let t, n, r;
            for (t = wc.length - 1; 0 <= t; --t)
              if (((n = ft(wc[t])), (r = bt(n, e)), null !== r && 1 < r))
                return n;
            return e;
          })(r),
        c = [];
    ...
    function Dc(t, n, r, i, o) {
      const { start: s, end: a } = n.currentRange;
      let l = s;
      const c = [];
      for (; l.valueOf() < a.valueOf(); ) {
        const s = r.add(l, Cc),
          a = { start: t.skipHiddenDays(l), end: t.skipHiddenDays(s, -1, !0) };
        let e = Rl({
          currentRange: a,
          snapToWeek: !0,
          fixedWeekCount: i,
        ...
        e = {
          start: t.skipHiddenDays(e.start),
          end: t.skipHiddenDays(e.end, -1, !0),
        };
        const d = n.activeRange ? ir(n.activeRange, o ? e : a) : null;
        c.push({
    ...
    var a,
            ...
            (d === o
              ? ((e.__h = []),
                ...
                e.__.forEach(function (e) {
                  e.__N && (e.__ = e.__N), (e.__V = ie), (e.__N = e.i = void 0);
                }))
              : (e.__h.forEach(ee), e.__h.forEach(te), (e.__h = []))),
            (d = o);
        }),
        (L.diffed = function (e) {
          de && de(e);
          ...
          e &&
            e.__H &&
            (!e.__H.__h.length ||
              (1 !== J.push(e) && u === L.requestAnimationFrame) ||
              ((u = L.requestAnimationFrame) || K)($),
      ...
      Ce =
        ...
        ((ae.prototype = new D()).__c = function (e, t) {
          var n = t.__c,
            r = this,
            i = (null == r.t && (r.t = []), r.t.push(n), le(r.__v)),
            o = !1,
            s = function () {
            ...
            t = !0 === t.__h;
          r.__u++ || t || r.setState({ __a: (r.__b = r.__v.__k[0]) }),
            e.then(s, s);
        }),
        ...
        (ae.prototype.render = function (e, t) {
          this.__b &&
            ...
            (this.__b = null));
          var n,
            r = t.__a && p(y, null, e.fallback);
          return (
            r && (r.__h = null), [p(y, null, t.__a ? null : e.children), r]
          );
        }),
        function (e, t, n) {
          if (
      ...
      De =
        (((ce.prototype = new D()).__a = function (n) {
          var r = this,
            i = le(r.__v),
            o = r.o.get(n);
          return (
            ...
            function (e) {
              var t = function () {
                r.props.revealOrder ? (o.push(e), Ce(r, n, o)) : e();
              };
              i ? i(t) : t();
            }
          );
      ...
      Ye =
        ((L.vnode = function (e) {
          ...
          if ('string' == typeof t) {
            ...
            for (i in n) {
              var s = n[i];
              (ke && 'children' === i && 'noscript' === t) ||
                ('value' === i && 'defaultValue' in n && null == s) ||
                ('defaultValue' === i && 'value' in n && null == n.value
                  ...
                  : 'download' === i && !0 === s
                    ...
                    : /ondoubleclick/i.test(i)
                      ? (i = 'ondblclick')
                      : /^onchange(textarea|input)/i.test(i + t) && !Re(n.type)
                        ? (i = 'oninput')
                        : /^onfocus$/i.test(i)
                          ? (i = 'onfocusin')
                          : /^onblur$/i.test(i)
    ...
    let Zt = 0;
    const Xt = ['years', 'months', 'days', 'milliseconds'],
      Jt = /^(-?)(?:(\d+)\.)?(\d+):(\d\d)(?::(\d\d)(?:\.(\d\d\d))?)?/,
      Kt = ['sun', 'mon', 'tue', 'wed', 'thu', 'fri', 'sat'],
      ln = {
        week: 3,
        separator: 0,
        omitZeroMinute: 0,
    ...
    class en {
      constructor(e) {
        ...
        for (var i in e)
          i in ln
            ? ((n[i] = e[i]), (r = Math.max(ln[i], r)))
            : ((t[i] = e[i]), i in cn && (r = Math.max(cn[i], r)));
      ...
      formatRange(e, t, n, r) {
        let { standardDateProps: i, extendedSettings: o } = this,
          s =
            ...
            (l = t.marker),
            (c = n.calendarSystem),
            c.getMarkerYear(a) !== c.getMarkerYear(l)
              ? 5
        ...
        let p = tn(
            (function (e, t) {
              let n = {};
              for (var r in e) (r in cn && !(cn[r] <= t)) || (n[r] = e[r]);
              return n;
            })(i, d),
            o,
            n
          ...
          m = (function (t, n, s, a) {
            ...
            for (; l < t.length; ) {
              ...
              if (-1 === e) break;
              let r = t.substr(0, e),
                i = ((l = e + n.length), t.substr(l)),
                o = 0;
              for (; o < s.length; ) {
                let e = s.indexOf(a, o);
                if (-1 === e) break;
                let t = s.substr(0, e),
                  n = ((o = e + a.length), s.substr(o));
                if (r === t && i === n) return { before: r, after: i };
              }
            }
            return null;
          })(u, f, h, g),
          v = o.separator || r || n.defaultSeparator || '';
        return m ? m.before + f + v + g + m.after : u + v + h;
      }
      getLargestUnit() {
    ...
    class Hn {
      constructor(e) {
        ...
        e.namedTimeZoneImpl &&
          ...
          (this.calendarSystem = ((r = e.calendarSystem), new yr[r]())),
          ...
          (this.weekText = (
            null != e.weekText ? e : e.locale.options
          ).weekText),
          (this.weekTextLong =
                  ...
                  : ((n = kt(e, t)),
                    null !== n
                      ...
                      : ((n =
                          ((r = e),
                          (i = t),
                          (i.valueOf() - r.valueOf()) / 36e5)),
                        ct(n)
                          ? { unit: 'hour', value: n }
                          : ((n =
                              ((i = e),
                              (r = t),
                              (r.valueOf() - i.valueOf()) / 6e4)),
                            ct(n)
                              ? { unit: 'minute', value: n }
                              : ((n =
                                  ((r = e),
                                  (i = t),
                                  (i.valueOf() - r.valueOf()) / 1e3)),
                                ct(n)
                                  ? { unit: 'second', value: n }
                                  : {
                                      unit: 'millisecond',
      ...
      computeWeekNumber(r) {
        if (this.weekNumberFunc) return this.weekNumberFunc(this.toDate(r));
        {
          var i = this.weekDow,
            o = this.weekDoy;
          let e = r.getUTCFullYear(),
            t = It(r, e, i, o);
          if (t < 1) return It(r, e - 1, i, o);
          let n = It(r, e + 1, i, o);
          return 1 <= n ? Math.min(t, n) : t;
        }
      }
      format(e, t, n = {}) {
        return t.format(
    ...
    qn.addPropsEquality({
      ...
      elAttrs: function (e, t) {
        const n = xn(e, t);
        for (var r of n) if (!$n.test(r)) return !1;
        return !0;
      },
      renderProps: Cn,
    });
    ...
    class gr {
      ...
      adjustActiveRange(e) {
        ...
        return (
          n &&
            (vt(r) < 0 && ((o = Mt(o)), (o = t.add(o, r))), 1 < vt(i)) &&
            ((s = Mt(s)), (s = wt(s, -1)), (s = t.add(s, i))),
          { start: o, end: s }
        );
      }
      buildRangeFromDuration(e, t, n, r) {
        ...
        if (!l) {
          let e = this.props['dateIncrement'];
      ...
      buildRangeFromDayCount(e, t, n) {
        ...
        for (
          o && (a = i.startOf(a, o)),
            ...
            r = a;
          (r = wt(r, 1)), this.isHiddenDay(r) || (s += 1), s < n;
      ...
      buildDateIncrement(e) {
        ...
        return (
          n ||
          ((t = this.props.dateAlignment) ? ft(1, t) : e || ft({ days: 1 }))
        );
      }
      refineRange(t) {
        if (t) {
    ...
    const Ir = {
      ...
      Or = { start: yn, end: yn, date: yn, allDay: Boolean },
      Br = Object.assign(Object.assign(Object.assign({}, Ir), Or), {
        extendedProps: yn,
      }),
      Qr = {
        display: String,
    ...
    class Gr {
      ...
      on(e, t) {
        var n;
        (n = this.handlers), (e = e), (t = t), (n[e] || (n[e] = [])).push(t);
      }
      off(e, t) {
        var n, r;
        (n = this.handlers),
          (e = e),
          (r = t),
          r ? n[e] && (n[e] = n[e].filter((e) => e !== r)) : delete n[e];
      }
      trigger(e, ...t) {
        let n = this.handlers[e] || [],
          r = this.options && this.options[e],
          i = [].concat(r || [], n);
        for (var o of i) o.apply(this.thisContext, t);
      }
      hasHandlers(e) {
        return Boolean(
    ...
    class ti {
      ...
      setProp(t, n) {
        if (t in Or)
          ...
          (n = Ir[t](n)), this.mutate({ standardProps: { publicId: n } });
        else if (t in Ir)
          (n = Ir[t](n)), this.mutate({ standardProps: { [t]: n } });
        else if (t in Qr) {
          let e = Qr[t](n);
          (e =
            'color' === t
          ...
          console.warn(
            `Could not set prop '${t}'. Use setExtendedProp instead.`
          );
      }
      setExtendedProp(e, t) {
      ...
      setDates(r, i, o = {}) {
        ...
        if (
          e &&
          (null == i || ((s = a.createMarker(i)), s)) &&
          this._instance
        ) {
          let t = this._instance.range,
            n =
              (!0 === o.allDay && (t = cr(t)),
              hr(t.start, e, a, o.granularity));
          if (s) {
            let e = hr(t.end, s, a, o.granularity);
            (r = e),
              (i = n).years === r.years &&
              i.months === r.months &&
              i.days === r.days &&
              i.milliseconds === r.milliseconds
                ? this.mutate({ datesDelta: n, standardProps: l })
                : this.mutate({ startDelta: n, endDelta: e, standardProps: l });
          } else
            (l.hasEnd = !1), this.mutate({ datesDelta: n, standardProps: l });
        }
      }
      moveStart(e) {
        let t = ft(e);
    ...
    const Ui = { start: yn, end: yn, allDay: Boolean };
    ...
    class ki extends Gn {
      ...
      render() {
        ...
        return Ti() || o.push('fc-liquid-hack'), e.children(o, i, r, n);
      }
      componentDidMount() {
    ...
    class Ni {
      ...
      addEvent(n, t) {
        if (n instanceof ti) {
          ...
          return (
            this.getCurrentData().eventStore.defs[e.defId] ||
              (this.dispatch({
                type: 'ADD_EVENTS',
                eventStore: Rr({ def: e, instance: t }),
              }),
        ...
        if (t instanceof ei) r = t.internalEventSource;
        else if ('boolean' == typeof t) t && ([r] = wn(i.eventSources));
        else if (null != t) {
        ...
        let o = Sr(n, r, i, !1);
        if (o) {
          let e = new ti(i, o.def, o.def.recurringDef ? null : o.instance);
          return (
            this.dispatch({ type: 'ADD_EVENTS', eventStore: Rr(o) }),
      ...
      getEventById(e) {
        ...
        for (var o in ((e = String(e)), r)) {
          let t = r[o];
          if (t.publicId === e) {
            if (t.recurringDef) return new ti(n, t, null);
            for (var s in i) {
              let e = i[s];
              if (e.defId === t.defId) return new ti(n, t, e);
            }
          }
        }
        return null;
      ...
      getEventSources() {
        let e = this.getCurrentData(),
          t = e.eventSources,
          n = [];
        for (var r in t) n.push(new ei(e, t[r]));
        return n;
      }
    ...
    class Wi {
      ...
      splitProps(r) {
        let i = this.getKeyInfo(r),
          e = this.getKeysForEventDefs(r.eventStore),
          o = this.splitDateSelection(r.dateSelection),
          s = this.splitIndividualUi(r.eventUiBases, e),
          a = this.splitEventStore(r.eventStore, e),
          l = this.splitEventDrag(r.eventDrag),
          c = this.splitEventResize(r.eventResize),
          d = {};
        for (var u in ((this.eventUiBuilders = An(
          i,
        ...
        i)) {
          let e = i[u],
            t = a[u] || Qi,
            n = this.eventUiBuilders[u];
          d[u] = {
            businessHours: e.businessHours || r.businessHours,
            dateSelection: o[u] || null,
            eventStore: t,
            eventUiBases: n(r.eventUiBases[''], e.ui, s[u]),
            eventSelection: t.instances[r.eventSelection]
              ? r.eventSelection
              : '',
            eventDrag: l[u] || null,
      ...
      _splitDateSpan(t) {
        let n = {};
        if (t) {
          let e = this.getKeysForDateSpan(t);
          for (var r of e) n[r] = t;
        }
        return n;
      }
      ...
      _splitEventStore(e, t) {
        ...
        for (var o in n)
          for (var s of t[o])
            i[s] || (i[s] = { defs: {}, instances: {} }), (i[s].defs[o] = n[o]);
        for (var a in r) {
          let e = r[a];
          for (var l of t[e.defId]) i[l] && (i[l].instances[a] = e);
        }
        return i;
      }
        ...
        if (i) {
          let t = this._splitEventStore(
            ...
            r = (e) => {
              o[e] ||
                (o[e] = {
                  affectedEvents: t[e] || Qi,
                  mutatedEvents: n[e] || Qi,
                  isEvent: i.isEvent,
                });
            };
          for (var s in t) r(s);
    ...
    const Zi = an({ year: 'numeric', month: 'long', day: 'numeric' }),
      lo = an({ week: 'long' });
    let co,
      vo = null;
    class rs {
      ...
      buildElHorizontals(t) {
        let n = [],
          r = [];
        for (var i of this.els) {
          let e = i.getBoundingClientRect();
          n.push(e.left - t), r.push(e.right - t);
        }
      ...
      buildElVerticals(t) {
        ...
        for (var i of this.els) {
          let e = i.getBoundingClientRect();
          n.push(e.top - t), r.push(e.bottom - t);
        }
    ...
    class cs {
      ...
      addSegs(e) {
        let t = [];
        for (var n of e) this.insertEntry(n, t);
        return t;
      }
      insertEntry(e, t) {
      ...
      splitEntry(e, t, n) {
        ...
        return (
          ...
          r
            ? (n.push(
                { index: e.index, thickness: e.thickness, span: fs(s, o) },
                ...i
              ),
              r)
            : (n.push(e), 0)
      ...
      findInsertion(s) {
        ...
        for (let o = 0; o < e; o += 1) {
          let t = a[o];
          if (!c && t >= u + this.getEntryThickness(s)) break;
          let n,
            e = l[o],
            r = ps(e, s.span.start, ds),
            i = r[0] + r[1];
          for (; (n = e[i]) && n.span.start < s.span.end; ) {
            let e = t + this.getEntryThickness(n);
            e > u && ((u = e), (f = n), (h = o), (p = i)),
              e === u && (g = Math.max(g, d[us(n)] + 1)),
              (i += 1);
          }
        }
        let t = 0;
        if (f) for (t = h + 1; t < e && a[t] < u; ) t += 1;
        let n = -1;
        return (
          t < e && a[t] === u && (n = ps(l[t], s.span.end, ds)[0]),
          {
            touchingLevel: h,
            touchingLateral: p,
            touchingEntry: f,
    ...
    const xo = {},
      _o = { startTime: ft, duration: ft, create: Boolean, sourceId: String },
      To = 'fc-col-header-cell';
    class Ds extends Gn {
      render() {
        let { dateEnv: e, options: t, theme: n, viewApi: r } = this.context,
          i = this['props'],
          { date: o, dateProfile: s } = i,
          a = Fi(o, i.todayRange, null, s),
          l = [To].concat(Vi(a, n)),
          c = e.format(o, i.dayHeaderFormat),
          d = !a.isDisabled && 1 < i.colCnt ? qi(this.context, o) : {},
          u = Object.assign(
            Object.assign(
            ...
            elAttrs: Object.assign(
              {
                role: 'columnheader',
                colSpan: i.colSpan,
                'data-date': a.isDisabled ? void 0 : Wt(o),
              },
              i.extraDataAttrs
            ),
            renderProps: u,
    ...
    const ko = an({ weekday: 'long' });
    class Cs extends Gn {
      render() {
        let t = this['props'],
          { dateEnv: n, theme: e, viewApi: r, options: i } = this.context,
          o = wt(new Date(2592e5), t.dow),
          s = {
            dow: t.dow,
            isDisabled: !1,
            isFuture: !1,
        ...
        return p(
          ...
          {
            elTag: 'th',
            elClasses: [To, ...Vi(s, e), ...(t.extraClassNames || [])],
            elAttrs: Object.assign(
          ...
          (e) =>
            p(
              ...
              p(e, {
                ...
                elAttrs: { 'aria-label': n.format(o, ko) },
              })
            )
        );
      }
    ...
    class Ms {
      ...
      sliceRange(e) {
        let o = this['colCnt'],
          s = this.daySeries.sliceRange(e),
          a = [];
        if (s) {
          let { firstIndex: n, lastIndex: r } = s,
            i = n;
          for (; i <= r; ) {
            let e = Math.floor(i / o),
              t = Math.min((e + 1) * o, r + 1);
            a.push({
              row: e,
              firstCol: i % o,
              lastCol: (t - 1) % o,
              isStart: s.isStart && i === n,
              isEnd: s.isEnd && t - 1 === r,
            }),
              (i = t);
          }
    ...
    class Is {
      ...
      _sliceBusinessHours(e, t, n, r, ...i) {
        return e
          ? this._sliceEventStore(mr(e, Os(t, Boolean(n)), r), {}, t, n, ...i)
              .bg
          : [];
      }
      _sliceEventStore(t, n, r, i, ...o) {
        if (t) {
          let e = ii(t, n, Os(r, Boolean(i)), i);
          return {
            bg: this.sliceEventRanges(e.bg, o),
            fg: this.sliceEventRanges(e.fg, o),
          };
        }
        return { bg: [], fg: [] };
      }
      _sliceInteraction(e, t, n, r, ...i) {
        if (!e) return null;
        let o = ii(e.mutatedEvents, t, Os(n, Boolean(r)), r);
        return {
      ...
      _sliceDateSpan(r, t, i, o, s, ...a) {
        if (r) {
          let e = Os(t, Boolean(i)),
            n = ir(r.range, e);
          if (n) {
            let e = (function (e, t, n) {
              ...
              })((r = Object.assign(Object.assign({}, r), { range: n })), o, s),
              t = this.sliceRange(r.range, ...a);
            for (var l of t) l.eventRange = e;
            return t;
          }
        }
        return [];
      ...
      sliceEventRange(e, t) {
        ...
        for (var i of r)
          (i.eventRange = e),
            (i.isStart = e.isStart && i.isStart),
            (i.isEnd = e.isEnd && i.isEnd);
        return r;
      }
    }
    const Mo = /^(visible|hidden)$/;
    class Fs extends Gn {
      constructor() {
        super(...arguments),
          (this.handleEl = (e) => {
      ...
      needsXScrolling() {
        if (!Mo.test(this.props.overflowX)) {
          let e = this['el'],
            t =
      ...
      needsYScrolling() {
        if (!Mo.test(this.props.overflowY)) {
          let e = this['el'],
            t =
      ...
      getXScrollbarWidth() {
        return Mo.test(this.props.overflowX)
          ? 0
          : this.el.offsetHeight - this.el.clientHeight;
      }
      getYScrollbarWidth() {
        return Mo.test(this.props.overflowY)
          ? 0
        ...
        (this.masterCallback = e),
          ...
          (this.handleValue = (e, t) => {
            ...
            null !== e
              ...
              this.masterCallback &&
                (i && this.masterCallback(null, String(t)), o) &&
    ...
    class io extends Gn {
      ...
      render() {
        ...
        for (; c < l && 'header' === (a = r[c]).type; )
          d.push(this.renderSection(a, o, !0)), (c += 1);
        for (; c < l && 'body' === (a = r[c]).type; )
          u.push(this.renderSection(a, o, !1)), (c += 1);
      ...
      renderChunkTd(e, t, n, r) {
        ...
        let i = this['props'],
          ...
          l = qs(i, e),
          c = Qs(i, e),
          d = i.liquid ? (o ? 'scroll' : l ? 'auto' : 'hidden') : 'visible',
          u = e.key,
          h = Ys(
            e,
            n,
      ...
      computeScrollerDims() {
        let r = $i(),
          { scrollerRefs: t, scrollerElRefs: e } = this,
          i = !1,
          o = {},
          s = {};
        for (var n in t.currentMap) {
          let e = t.currentMap[n];
        ...
        for (var a of this.props.sections) {
          ...
          if (n) {
            let e = n.parentNode;
            (o[t] = Math.floor(
              e.getBoundingClientRect().width - (i ? r.y : 0)
            )),
              (s[t] = Math.floor(e.getBoundingClientRect().height));
          }
        }
        return {
          forceYScrollbars: i,
    ...
    const ys = (s) =>
      p(h.Consumer, null, (e) => {
        let { dateEnv: t, options: n } = e,
          r = s['date'],
          i = n.weekNumberFormat || s.defaultFormat,
          o = { num: t.computeWeekNumber(r), text: t.format(r, i), date: r };
        return p(
          Jn,
          Object.assign({}, s, {
            renderProps: o,
    ...
    class bo extends Gn {
      ...
      updateSize() {
        let i = this.context['isRtl'],
          { alignmentEl: o, alignGridTop: s } = this.props,
          a = this['rootEl'],
          l = (function (e) {
            let t = ns(e),
              n = e.getBoundingClientRect();
            for (var r of t) {
              let e = Hi(n, r.getBoundingClientRect());
              if (!e) return null;
              n = e;
            }
            return n;
        ...
        if (l) {
          let e = a.getBoundingClientRect(),
            t = (s ? Oe(o, '.fc-scrollgrid').getBoundingClientRect() : l).top,
            n = i ? l.right - e.width : l.left,
            r =
              ((t = Math.max(t, 10)),
              (n = Math.min(
                n,
                document.documentElement.clientWidth - 10 - e.width
              )),
              (n = Math.max(n, 10)),
              a.offsetParent.getBoundingClientRect());
          Be(a, { top: t - r.top, left: n - r.left });
        }
      }
    }
    class Eo extends ls {
      ...
      render() {
        let { options: r, dateEnv: e } = this.context,
          i = this['props'],
          { startDate: t, todayRange: n, dateProfile: o } = i,
          s = e.format(t, r.dayPopoverFormat);
        return p(
          uo,
          { elRef: this.handleRootEl, date: t, dateProfile: o, todayRange: n },
          (e, t, n) =>
            p(
              bo,
              {
              ...
              ho(r) &&
                p(e, { elTag: 'div', elClasses: ['fc-more-popover-misc'] }),
              i.children
            )
        );
      }
    ...
    class So extends Gn {
      constructor() {
        super(...arguments),
          ...
          (this.handleClick = (e) => {
            function s(e) {
              let { def: t, instance: n, range: r } = e.eventRange;
              return {
                event: new ti(i, t, n),
      ...
      render() {
        let { props: d, state: u } = this;
        return p(h.Consumer, null, (e) => {
          let { viewApi: t, options: n, calendarApi: r } = e,
            i = n['moreLinkText'],
            o = d['moreCnt'],
            s = Do(d),
            a = 'function' == typeof i ? i.call(r, o) : `+${o} ` + i,
            l = at(n.moreLinkHint, [o], a),
            c = { num: o, shortText: '+' + o, text: a, view: t };
          return p(
            y,
            null,
            Boolean(d.moreCnt) &&
              p(
                Jn,
                {
                  ...
                  elClasses: [...(d.elClasses || []), 'fc-more-link'],
                  elStyle: d.elStyle,
                  elAttrs: Object.assign(
                    Object.assign(
                      Object.assign({}, d.elAttrs),
                      Qe(this.handleClick)
                    ),
                    {
                      title: l,
                      'aria-expanded': u.isPopoverOpen,
                      'aria-controls': u.isPopoverOpen ? u.popoverId : '',
                    }
                  ),
                  renderProps: c,
                  generatorName: 'moreLinkContent',
                  customGenerator: n.moreLinkContent,
                  defaultGenerator: d.defaultGenerator || Ao,
            ...
            u.isPopoverOpen &&
              p(
                Eo,
                {
                  ...
                  alignmentEl: d.alignmentElRef
                    ? d.alignmentElRef.current
                    : this.linkEl,
                  alignGridTop: d.alignGridTop,
                  forceTimed: d.forceTimed,
    ...
    var ws = {
        ...
        filterHash: Sn,
        findDirectChildren: function (e, r) {
        ...
        getSlotClassNames: function (e, t) {
          let n = ['fc-slot', 'fc-slot-' + Kt[e.dow]];
          return (
            e.isDisabled
        ...
        mapHash: An,
        memoize: Gt,
        memoizeArraylike: function (i, o, s) {
          let a = [],
            l = [];
          return (t) => {
            let e = a.length,
            ...
            for (; r < e; r += 1)
              if (t[r]) {
                if (!St(a[r], t[r])) {
                  s && s(l[r]);
                  let e = i.apply(this, t[r]);
                  (o && o(e, l[r])) || (l[r] = e);
                }
              } else s && s(l[r]);
            for (; r < n; r += 1) l[r] = i.apply(this, t[r]);
            return (a = t), l.splice(n), l;
          };
        },
        memoizeHashlike: function (i, o, s) {
          let e = {},
            a = {};
          return (t) => {
            let n = {};
            for (var r in t)
              if (a[r])
                if (St(e[r], t[r])) n[r] = a[r];
                else {
                  s && s(a[r]);
                  let e = i.apply(this, t[r]);
                  n[r] = o && o(e, a[r]) ? a[r] : e;
                }
              else n[r] = i.apply(this, t[r]);
            return (e = t), (a = n), n;
          };
        },
        memoizeObjArg: Qt,
      ...
      Ss = {
        ...
        cloneElement: function (e, t, n) {
          ...
          return (
            2 < arguments.length &&
              (s.children = 3 < arguments.length ? V.call(arguments, 2) : n),
            m(e.type, s, r || e.key, i || e.ref, null)
          );
        },
        createElement: p,
        createRef: v,
    ...
    const Ls = [],
      ...
      Ia = Object.assign(Object.assign({}, ca), {
        buttonHints: {
          prev: 'Previous $0',
          next: 'Next $0',
        ...
        recurringTypes: [
          {
            ...
            expand(i, o, s) {
              let a = ir(o, { start: i.startRecur, end: i.endRecur });
              if (a) {
                var o = i.daysOfWeek,
                  l = i.startTime,
                  i = a,
    ...
    class da {
      ...
      drain() {
        ...
        for (; n.length; ) {
          let e,
            t = [];
          for (; (e = n.shift()); ) this.runTask(e), t.push(e);
          this.drained(t);
        }
      }
      runTask(e) {
    ...
    class ha {
      constructor(e) {
        ...
        let t = {},
          ...
          a =
            (lr(s.activeRange, o) || (o = s.currentRange.start),
            {
              dateEnv: n.dateEnv,
        ...
        for (var l of n.pluginHooks.contextInit) l(a);
        let c = Go(n.calendarOptions, s, a),
          d = {
        ...
        for (var h of n.pluginHooks.reducers)
          Object.assign(d, h(null, null, u));
      ...
      _handleAction(e) {
        let { props: t, state: n, emitter: r } = this,
          ...
          s =
            ((c = n.currentViewType),
            (l = e),
            'CHANGE_VIEW_TYPE' === l.type && (c = l.viewType),
            c),
        ...
        let u = {
          ...
          { currentDate: h, dateProfile: p } = n,
          f =
            (this.data &&
              this.data.dateProfileGenerator !== a.dateProfileGenerator &&
              (p = a.dateProfileGenerator.build(h)),
            (h =
              ((l = h), (c = e), 'CHANGE_DATE' !== c.type ? l : c.dateMarker)),
            (p = (function (e, t, n, r) {
              let i;
              switch (t.type) {
                case 'CHANGE_VIEW_TYPE':
              ...
              return e;
            })(p, e, h, a.dateProfileGenerator)),
            ('PREV' !== e.type && 'NEXT' !== e.type && lr(p.currentRange, h)) ||
              (h = p.currentRange.start),
            Qo(n.eventSources, e, p, u)),
          g = Ur(n.eventStore, e, f, p, u),
          m =
            (qo(f) &&
              !a.options.progressiveEventRendering &&
              n.renderableEventStore) ||
            g,
          { eventUiSingleBase: v, selectionConfig: y } =
          ...
          w = {
            ...
            selectionConfig: y,
            eventUiBases: this.buildEventUiBases(m.defs, v, b),
          ...
          E = Object.assign(Object.assign({}, u), w);
        for (d of o.pluginHooks.reducers) Object.assign(w, d(n, e, E));
        let x = Ea(n, u),
          S = Ea(w, u);
        !x && S
          ? r.trigger('loading', !0)
          : x && !S && r.trigger('loading', !1),
          (this.state = w),
        ...
        if (a && a !== l)
          for (var c in (a.timeZone !== l.timeZone &&
            ...
            (t.eventStore = o.eventStore =
              Fr(o.eventStore, n.dateEnv, o.dateEnv)),
            (t.renderableEventStore = o.renderableEventStore =
              Fr(o.renderableEventStore, n.dateEnv, o.dateEnv))),
          s))
      ...
      processRawCalendarOptions(e, t) {
        let { locales: n, locale: r } = mn([F, e, t]),
          ...
          l = (this.currentCalendarOptionsRefiners = Object.assign(
            Object.assign(
              Object.assign(Object.assign(Object.assign({}, Mn), In), Rn),
              a.listenerRefiners
            ),
            a.optionRefiners
          )),
          ...
          f = !1;
        for (var g in d)
          -1 === this.optionsForRefining.indexOf(g) &&
          (d[g] === h[g] || (On[g] && g in h && On[g](h[g], d[g])))
            ? (u[g] = p[g])
            : l[g]
              ? ((u[g] = l[g](d[g])), (f = !0))
              : (c[g] = h[g]);
      ...
      processRawViewOptions(e, t, n, r, i) {
        let o = mn([F, e.optionDefaults, n, r, e.optionOverrides, i]),
          s = Object.assign(
            Object.assign(
              Object.assign(
                Object.assign(Object.assign(Object.assign({}, Mn), In), Rn),
          ...
          u = {};
        for (var h in o)
          o[h] === l[h] || (On[h] && On[h](o[h], l[h]))
            ? (a[h] = c[h])
            : (o[h] === this.currentCalendarOptionsInput[h] ||
              (On[h] && On[h](o[h], this.currentCalendarOptionsInput[h]))
    ...
    class Da extends Gn {
      ...
      renderWidgetGroup(e) {
          ...
          if ('title' === r)
            (t = !1),
              d.push(
                p(
                  'h2',
                  { className: 'fc-toolbar-title', id: l.titleId },
                  l.title
                )
              );
          else {
            let e = r === l.activeButton,
              t =
                (!l.isTodayEnabled && 'today' === r) ||
                (!l.isPrevEnabled && 'prev' === r) ||
                (!l.isNextEnabled && 'next' === r),
              n = [`fc-${r}-button`, c.getClass('button')];
            e && n.push(c.getClass('buttonActive')),
              d.push(
                p(
                  'button',
                  {
                    type: 'button',
                    title: 'function' == typeof a ? a(l.navUnit) : a,
                    disabled: t,
                    'aria-pressed': e,
                    className: n.join(' '),
                    onClick: i,
                  },
                  o || (s ? p('span', { className: s }) : '')
                )
              );
          }
        }
        return 1 < d.length
          ? p(
              'div',
              { className: (t && c.getClass('buttonGroup')) || '' },
              ...d
            )
          : d[0];
      }
    ...
    class wa extends Gn {
      render() {
        let e,
          ...
          s = o.center;
        return (
          (e = o.left ? ((i = !0), o.left) : o.start),
          (t = o.right ? ((i = !0), o.right) : o.end),
          p(
            'div',
            {
              className: [
        ...
        super(e),
          (this.handleSegClick = (n, r) => {
            let i = this['component'],
              o = i['context'],
              s = ai(r);
            if (s && i.isValidSegDownEl(n.target)) {
              let e = Oe(n.target, '.fc-event-forced-url'),
                t = e ? e.querySelector('a[href]').href : '';
              o.emitter.trigger('eventClick', {
                ...
                t && !n.defaultPrevented && (window.location.href = t);
            }
          }),
    ...
    class xa extends Mi {
      constructor(e) {
        super(e),
          ...
          (this.removeHoverListeners = (function (e, t, r, i) {
            let o;
            return Fe(e, 'mouseover', t, (e, n) => {
              if (n !== o) {
                (o = n), r(e, n);
                let t = (e) => {
                  (o = null), i(e, n), n.removeEventListener('mouseleave', t);
                };
      ...
      triggerEvent(e, t, n) {
        ...
        (t && !r.isValidSegDownEl(t.target)) ||
          i.emitter.trigger(e, {
            el: n,
            event: new ti(i, o.eventRange.def, o.eventRange.instance),
            jsEvent: t,
            view: i.viewApi,
          });
      }
    ...
    class _a extends Vn {
          ...
          (this.registerInteractiveComponent = (e, t) => {
            ...
            let n = {
              ...
              r = [Ra, xa]
                ...
                .map((e) => new e(n));
            var i;
            (this.interactionsStore[e.uid] = r), (Yi[e.uid] = n);
          }),
      ...
      buildAppendContent() {
        let t = this['props'];
        return p(y, {}, ...t.pluginHooks.viewContainerAppends.map((e) => e(t)));
      }
      renderView(e) {
        let t = e['pluginHooks'],
          n = e['viewSpec'],
        ...
        for (var o of i) Object.assign(r, o.transform(r, e));
        ...
        (this.subjectEl = null),
          ...
          (this.handleTouchStart = (n) => {
            if (this.tryStart(n)) {
              ...
              let e = this.createEventFromTouch(n, !0),
                t =
                  (this.emitter.trigger('pointerdown', e),
                  this.initScrollWatch(e),
                  n.target);
          ...
          (this.handleScroll = (n) => {
            if (!this.shouldIgnoreMove) {
              let e = window.pageXOffset - this.prevScrollX + this.prevPageX,
                t = window.pageYOffset - this.prevScrollY + this.prevPageY;
          ...
          (Wa += 1),
          1 === Wa && window.addEventListener('touchmove', Ha, { passive: !1 });
      }
      destroy() {
        this.containerEl.removeEventListener('mousedown', this.handleMouseDown),
          ...
          --Wa,
          Wa || window.removeEventListener('touchmove', Ha, { passive: !1 });
      }
      tryStart(e) {
        ...
        return !(
          !t ||
          (this.handleSelector && !Oe(n, this.handleSelector)) ||
          ((this.subjectEl = t),
          (this.isDragging = !0),
          (this.wasTouchScroll = !1),
          0)
    ...
    const el = ('function' == typeof performance ? performance : Date).now;
    class La {
      constructor() {
        (this.isEnabled = !0),
        ...
        if (this.isEnabled) {
          ...
          n < 0 ? (this.everMovedUp = !0) : 0 < n && (this.everMovedDown = !0),
            r < 0
              ...
              : 0 < r && (this.everMovedRight = !0),
            (this.pointerScreenX = e),
            (this.pointerScreenY = t),
            this.isAnimating ||
              ((this.isAnimating = !0), this.requestAnimation(el()));
        }
      }
      stop() {
        if (this.isEnabled) {
        ...
        for (var c of e) {
          ...
          0 <= t &&
            ...
            (r <= a &&
              ...
              c.canScrollUp() &&
              (!l || l.distance > r) &&
              (l = { scrollCache: c, name: 'top', distance: r }),
            i <= a &&
              this.everMovedDown &&
              c.canScrollDown() &&
              (!l || l.distance > i) &&
              (l = { scrollCache: c, name: 'bottom', distance: i }),
            t <= a &&
              this.everMovedLeft &&
              c.canScrollLeft() &&
              (!l || l.distance > t) &&
              (l = { scrollCache: c, name: 'left', distance: t }),
            n <= a) &&
            this.everMovedRight &&
            c.canScrollRight() &&
            (!l || l.distance > n) &&
            (l = { scrollCache: c, name: 'right', distance: n });
        }
        return l;
      }
      buildCaches(e) {
        ...
        super(e),
          ...
          (this.onPointerMove = (i) => {
            if (this.isInteracting) {
              if (
                (this.emitter.trigger('pointermove', i),
                ...
                let e,
                  ...
                  { deltaX: n, deltaY: r } = i;
                (e = n * n + r * r),
                  e >= t * t && this.handleDistanceSurpassed(i);
              }
              this.isDragging &&
                ('scroll' !== i.origEvent.type &&
    ...
    class Va {
      ...
      isWithinClipping(e, t) {
        let n = { left: e, top: t };
        for (var r of this.scrollCaches)
          if (!Ga(r.getEventTarget()) && !Pi(n, r.clientRect)) return !1;
        return !0;
      }
    }
    class Qa {
      ...
      processFirstCoord(e) {
        let t,
          ...
          o =
            ...
            (this.initialHit = this.queryHitForOffset(r.left, r.top)));
        if (o) {
      ...
      queryHitForOffset(c, d) {
        let { droppableStore: e, offsetTrackers: t } = this,
          u = null;
        for (var h in e) {
          let a = e[h].component,
            l = t[h];
          if (l && l.isWithinClipping(c, d)) {
            let t = l.computeLeft(),
              n = l.computeTop(),
              r = c - t,
              i = d - n,
    ...
    class Za extends Mi {
      constructor(e) {
        super(e),
          ...
          (this.handlePointerDown = (e) => {
            let t = e.origEvent.target,
              ...
              a =
                ...
                (this.subjectSeg = ai(e.subjectEl))),
              l = (this.eventRange = a.eventRange).instance.instanceId,
              c =
                ((this.relevantEvents = xr(s.getCurrentData().eventStore, l)),
          ...
          (this.handleHitUpdate = (c, e) => {
            if (this.isDragging) {
              let t = this.relevantEvents,
                n = this.hitDragging.initialHit,
                  ...
                  ? ((o = (function (e, t, n) {
                      let r = e.dateSpan,
                        ...
                        c =
                          ...
                          { datesDelta: l, standardProps: a });
                      for (var d of n) d(c, e, t);
                      return c;
                    })(
                      n,
                      c,
                      i.getCurrentData().pluginHooks.eventDragMutationMassagers
                    )),
                    o &&
                      ((s = $r(t, i.getCurrentData().eventUiBases, o, i)),
                      (l.mutatedEvents = s),
                      Ns(l, c.dateProfile, i) ||
                        ((a = !0),
                        (o = null),
                        (s = null),
          ...
          (this.handleDragEnd = (f) => {
            if (this.isDragging) {
              let o = this.component.context,
                s = o.viewApi,
                { receivingContext: a, validMutation: r } = this,
                l = this.eventRange.def,
                c = this.eventRange.instance,
                d = new ti(o, l, c),
                u = this.relevantEvents,
                h = this.mutatedRelevantEvents,
                p = this.hitDragging['finalHit'];
              if (
                (this.clearDrag(),
                ...
                if (a === o) {
                  let e = new ti(
                      o,
                      h.defs[l.defId],
                      c ? h.instances[c.instanceId] : null
                    ),
                    t =
                      (o.dispatch({ type: 'MERGE_EVENTS', eventStore: h }),
                      {
                        oldEvent: d,
                        event: e,
                        relatedEvents: ri(h, o, c),
                        revert() {
                          o.dispatch({ type: 'MERGE_EVENTS', eventStore: u });
                        },
                      }),
                    n = {};
                  for (var i of o.getCurrentData().pluginHooks
                    .eventDropTransformers)
                    Object.assign(n, i(r, o));
                  o.emitter.trigger(
                    'eventDrop',
                    ...
                    o.emitter.trigger('eventChange', t);
                } else if (a) {
                  let e = {
                      event: d,
                      relatedEvents: ri(u, o, c),
                      revert() {
                        o.dispatch({ type: 'MERGE_EVENTS', eventStore: u });
                      },
                    },
                  ...
                  a.emitter.trigger('eventAdd', i),
                    ...
                    a.emitter.trigger(
                      'drop',
                      Object.assign(Object.assign({}, Ya(p.dateSpan, a)), {
                        draggedEl: f.subjectEl,
                        jsEvent: f.origEvent,
        ...
        let t = this['component'],
          ...
          i =
            ...
            (this.hitDragging = new Qa(this.dragging, Yi)));
    ...
    class Ja {
      constructor(e, t) {
              ...
              ((o = (function (e, t, n) {
                ...
                let { refined: o, extra: s } = Ar(r, n),
                  ...
                  c =
                    (e.allDay &&
                      t.startTime &&
                      (l = n.dateEnv.add(l, t.startTime)),
                    t.duration
                      ? n.dateEnv.add(l, t.duration)
                      : Xr(e.allDay, l, n)),
                  d = pr(a.defId, { start: l, end: c });
                return { def: a, instance: d };
              })(e.dateSpan, this.dragMeta, i)),
              (a.mutatedEvents = Rr(o)),
              (s = !Ns(a, e.dateProfile, i)),
              s) &&
              ((a.mutatedEvents = { defs: {}, instances: {} }), (o = null)),
              this.displayDrag(i, a),
              r.setMirrorIsVisible(
                t || !o || !document.querySelector('.fc-event-mirror')
              ),
              (s ? Xe : $e)(),
              t ||
                (r.setMirrorNeedsRevert(!o),
                (this.receivingContext = i),
                (this.droppableEvent = o));
          }),
          (this.handleDragEnd = (r) => {
            let { receivingContext: i, droppableEvent: o } = this;
            if ((this.clearDrag(), i && o)) {
              let e = this.hitDragging.finalHit,
                t = e.context.viewApi,
                n = this.dragMeta;
              if (
                (i.emitter.trigger(
                  'drop',
                  Object.assign(Object.assign({}, Ya(e.dateSpan, i)), {
                    draggedEl: r.subjectEl,
                    jsEvent: r.origEvent,
                    view: t,
                  })
                ),
                ...
                let e = Rr(o);
                i.dispatch({ type: 'MERGE_EVENTS', eventStore: e }),
                  r.isTouch &&
                    i.dispatch({
                      type: 'SELECT_EVENT',
                  ...
                  i.emitter.trigger('eventReceive', {
                    event: new ti(i, o.def, o.instance),
                    relatedEvents: [],
                    revert() {
                      i.dispatch({ type: 'REMOVE_EVENTS', eventStore: e });
                    },
                    draggedEl: r.subjectEl,
                    view: t,
                  });
        ...
        let n = (this.hitDragging = new Qa(e, Yi));
        (n.requireInitial = !1),
      ...
      buildDragMeta(t) {
        {
          if ('object' == typeof this.suppliedDragMeta)
            return bs(this.suppliedDragMeta);
          if ('function' == typeof this.suppliedDragMeta)
            return bs(this.suppliedDragMeta(t));
          {
            let e = (function (e, t) {
              let n = xo.dataAttrPrefix,
                r = (n ? n + '-' : '') + t;
              return e.getAttribute('data-' + r) || '';
            })(t, 'event');
            return bs(e ? JSON.parse(e) : { create: !1 });
          }
        }
      }
      displayDrag(e, t) {
        ...
        class extends Mi {
          constructor(e) {
            super(e),
              ...
              (this.handleDragEnd = (r) => {
                let i = this['component'],
                  e = this.dragging['pointer'];
                if (!e.wasTouchScroll) {
                  let { initialHit: n, finalHit: e } = this.hitDragging;
                  if (n && e && qa(n, e)) {
                    let e = i['context'],
                      t = Object.assign(Object.assign({}, Ya(n.dateSpan, e)), {
                        dayEl: n.dayEl,
                        jsEvent: r.origEvent,
                        view: e.viewApi || e.calendarApi.view,
                      });
                    e.emitter.trigger('dateClick', t);
                  }
                }
              }),
          ...
          constructor(e) {
            ...
            let t = e['component'],
              ...
              i =
                ...
                (r.autoScroller.isEnabled = n.dragScroll),
                (this.hitDragging = new Qa(this.dragging, Ii(e))));
            i.emitter.on('pointerdown', this.handlePointerDown),
              i.emitter.on('dragstart', this.handleDragStart),
              i.emitter.on('hitupdate', this.handleHitUpdate),
              i.emitter.on('pointerup', this.handlePointerUp);
          ...
          constructor(e) {
            super(e),
              ...
              (this.handleDragEnd = (n) => {
                ...
                if (
                  (r.emitter.trigger('eventResizeStop', {
                  ...
                  let e = new ti(
                    ...
                    t =
                      (r.dispatch({ type: 'MERGE_EVENTS', eventStore: l }),
                      {
                        oldEvent: s,
                        event: e,
                        relatedEvents: ri(l, r, o),
                        revert() {
                          r.dispatch({ type: 'MERGE_EVENTS', eventStore: a });
                        },
                      });
                  r.emitter.trigger(
                    'eventResize',
                    ...
                    r.emitter.trigger('eventChange', t);
                } else r.emitter.trigger('_noEventResize');
                (this.draggingSeg = null),
                  (this.relevantEvents = null),
                  (this.validMutation = null);
              });
          ...
          constructor(e) {
            (this.context = e),
              ...
              (this.onDocumentPointerUp = (t) => {
                let n = this['context'],
                  e = this['documentPointer'],
                  r = n.getCurrentData();
                if (!e.wasTouchScroll) {
                  if (r.dateSelection && !this.isRecentPointerDateSelect) {
                    let e = n.options.unselectAuto;
                    !e ||
                      (e && this.matchesCancel) ||
                      n.calendarApi.unselect(t);
                  }
                  r.eventSelection &&
                    !this.matchesEvent &&
    ...
    class al extends Gn {
      render() {
        let { props: e, context: t } = this,
          n = t['options'],
          r = e['seg'],
          i = pi(r, n.eventTimeFormat || Ml, t, !0, e.defaultDisplayEventEnd);
        return p(
          so,
          Object.assign({}, e, {
            elTag: 'a',
    ...
    class cl extends Gn {
      ...
      render() {
        let r = this['props'],
          { allSegs: e, invisibleSegs: t } = this.compileSegs(
            r.singlePlacements
          );
        return p(So, {
    ...
    class hl extends ls {
      ...
      render() {
        let { context: n, props: r, state: i, rootElRef: o } = this,
          { options: s, dateEnv: e } = n,
        ...
        return p(
          ...
          (e, t) =>
            p(
              ...
              !t.isDisabled && (r.showDayNumber || ho(s) || r.forceDayTop)
                ? p(
                    'div',
                    ...
                    p(e, {
                      ...
                      elAttrs: Object.assign(Object.assign({}, qi(n, a)), {
                        id: i.dayNumberId,
                      }),
                    })
                  )
              ...
              p('div', { className: 'fc-daygrid-day-bg' }, r.bgContent)
            )
        );
      }
    }
          ...
          if (!i[e])
            if (this.allowReslicing) {
              const e = Object.assign(Object.assign({}, o), {
                span: fs(o.span, t.span),
              });
              (i[us(e)] = !0), (r[s][a] = e), this.splitEntry(o, t, n);
            } else (i[e] = !0), n.push(o);
        }
    ...
    class bl extends ls {
      ...
      render() {
        let { props: i, state: e, context: t } = this,
          n = t['options'],
          r = i.cells.length,
          o = nl(i.businessHourSegs, r),
          s = nl(i.bgEventSegs, r),
          a = nl(this.getHighlightSegs(), r),
          l = nl(this.getMirrorSegs(), r),
          {
            singleColPlacements: c,
            multiColPlacements: d,
            moreCnts: u,
        ...
        return p(
          ...
          i.cells.map((e, t) => {
            ...
            return p(hl, {
              ...
              fgContent: p(y, null, p(y, null, n), p(y, null, r)),
              bgContent: p(
                y,
                null,
                this.renderFillSegs(a[t], 'highlight'),
                this.renderFillSegs(o[t], 'non-business'),
                this.renderFillSegs(s[t], 'bg-event')
              ),
      ...
      renderFgSegs(e, t, s, a, l, c, d) {
        ...
        if (f)
          for (var y of t) {
            ...
            r &&
              (u.isRtl
                ? ((o = 0), (i = f.lefts[e.lastCol] - f.lefts[e.firstCol]))
                : ((i = 0), (o = f.rights[e.firstCol] - f.rights[e.lastCol]))),
              v.push(
                p(
                  'div',
                  {
                    className:
                      ...
                      (r ? ' fc-daygrid-event-harness-abs' : ''),
                    key: gl(e),
                    ref: m ? null : this.segHarnessRefs.createRef(pl(e)),
                    style: {
                      visibility: n ? '' : 'hidden',
                      marginTop: r ? '' : y.marginTop,
                      top: r ? y.absoluteTop : '',
                      left: i,
                      right: o,
                    },
          ...
          for (var s of e) {
            ...
            o.push(
              p(
                ...
                'bg-event' === t
                  ? p(go, Object.assign({ seg: s }, mi(s, r)))
                  : mo(t)
              )
            );
          }
      ...
      updateSizing(e) {
        ...
        if (!t.forPrint && null !== t.clientWidth) {
          if (e) {
            let n = t.cells.map((e) => i.currentMap[e.key]);
            if (n.length) {
              let e = this.rootElRef.current,
                t = new rs(e, n, !0, !1);
              (r.framePositions && r.framePositions.similarTo(t)) ||
                this.setState({ framePositions: new rs(e, n, !0, !1) });
            }
          }
          const n = this.state.segHeights,
      ...
      querySegHeights() {
        let t = this.segHarnessRefs.currentMap,
          n = {};
        for (var r in t) {
          let e = Math.round(t[r].getBoundingClientRect().height);
          n[r] = Math.max(n[r] || 0, e);
        }
        return n;
      }
    ...
    class El extends ls {
      ...
      render() {
        let { props: r, context: e } = this,
          i = r.cells.length,
          o = this.splitBusinessHourSegs(r.businessHourSegs, i),
          s = this.splitBgEventSegs(r.bgEventSegs, i),
          ...
          component: class extends xl {
            ...
            render() {
              ...
              return t.dayMinWidth
                ? this.renderHScrollLayout(i, o, r.colCnt, t.dayMinWidth)
    ...
    class jl {
      ...
      safeComputeTop(n) {
        let r = this['dateProfile'];
        if (lr(r.currentRange, n)) {
          let e = Mt(n),
            t = n.valueOf() - e.valueOf();
          if (t >= yt(r.slotMinTime) && t < yt(r.slotMaxTime))
            return this.computeTimeTop(ft(t));
        }
        return null;
      }
      computeDateTop(e, t) {
      ...
      computeTimeTop(e) {
        let t,
          ...
          o = r.els.length,
          s = (e.milliseconds - yt(i.slotMinTime)) / yt(this.slotDuration);
        return (
          (s = Math.max(0, s)),
          (s = Math.min(o, s)),
          (t = Math.floor(s)),
      ...
      render() {
        ...
        return p(
          ...
          r.slatMetas.map((e, t) => {
            ...
            return p(
              'tr',
              { key: e.key, ref: s.createRef(e.key) },
              r.axis && p(Il, Object.assign({}, e)),
              p(Jn, {
                elTag: 'td',
                elClasses: [
                  'fc-timegrid-slot',
                ...
                customGenerator: o.slotLaneContent,
                classNameGenerator: o.slotLaneClassNames,
    ...
    const gc = an({ hour: 'numeric', minute: '2-digit', meridiem: !1 });
    class Jl extends Gn {
      render() {
        return p(
          oo,
    ...
    class Kl extends Gn {
      ...
      render() {
        let { props: t, context: e } = this,
          ...
          o =
            ...
            {},
          s = this.sortEventSegs(t.fgEventSegs, n.eventOrder);
        return p(
          uo,
          {
            elTag: 'td',
          ...
          (e) =>
            p(
              ...
              ho(n) &&
                p(e, { elTag: 'div', elClasses: ['fc-timegrid-col-misc'] })
            )
        );
      }
      renderFgSegs(e, t, n, r, i, o) {
        ...
        return s.forPrint
          ? ec(e, s)
          : this.renderPositionedFgSegs(e, t, n, r, i, o);
      }
      renderPositionedFgSegs(e, c, d, u, h, f) {
        let {
            eventMaxStack: t,
            eventShortHeight: g,
            eventOrderStrict: n,
          ...
          w = d || u || h,
          s = Xl(e, i, o, r),
          { segPlacements: a, hiddenGroups: l } = (function (n, r, e, t) {
            let i = [],
              o = [];
            for (let t = 0; t < n.length; t += 1) {
              let e = r[t];
              e ? i.push({ index: t, thickness: 1, span: e }) : o.push(n[t]);
            }
            let { segRects: s, hiddenGroups: a } = Gl(i, e, t),
              l = [];
            for (var c of s) l.push({ seg: n[c.index], rect: c });
            for (var d of o) l.push({ seg: d, rect: null });
        ...
        return p(
          ...
          a.map((e) => {
            let { seg: t, rect: n } = e,
              ...
              i = w || Boolean(!c[r] && n),
              o = tc(n && n.span),
              s = !w && n ? this.computeSegHStyle(n) : { left: 0, right: 0 },
              a = Boolean(n) && 0 < n.stackForward,
              l = Boolean(n) && n.span.end - n.span.start < g;
            return p(
              'div',
              {
                className:
                  'fc-timegrid-event-harness' +
                  (a ? ' fc-timegrid-event-harness-inset' : ''),
                key: f || r,
                style: Object.assign(
                  Object.assign({ visibility: i ? '' : 'hidden' }, o),
                  s
                ),
              },
              p(
      ...
      renderHiddenGroups(e, i) {
        ...
        return p(
          ...
          e.map((e) => {
            let t = tc(e.span),
              n = ((e = e.entries), (r = i), e.map((e) => r[e.index]));
            var r;
            return p(Fl, {
              key: Ut(wo(n)),
              hiddenSegs: n,
      ...
      renderFillSegs(r, i) {
        let { props: o, context: e } = this,
          t = Xl(r, o.date, o.slatCoords, e.options.eventMinHeight).map(
            (e, t) => {
              let n = r[t];
              return p(
                'div',
                ...
                'bg-event' === i
                  ? p(
                      go,
                      Object.assign({ seg: n }, mi(n, o.todayRange, o.nowDate))
                    )
                  : mo(i)
              );
            }
      ...
      computeSegHStyle(e) {
        ...
        return (
          o && !e.stackForward && (l[r ? 'marginLeft' : 'marginRight'] = 20), l
        );
      }
    }
    class nc extends Gn {
      ...
      render() {
        let { props: n, context: e } = this,
          ...
          o = this.splitBgEventSegs(n.bgEventSegs, r),
          s = this.splitBusinessHourSegs(n.businessHourSegs, r),
    ...
    class rc extends ls {
      ...
      queryHit(e, c) {
        let { dateEnv: d, options: t } = this.context,
          u = this['colCoords'],
          h = this.props['dateProfile'],
          p = this.state['slatCoords'],
          { snapDuration: f, snapsPerSlot: g } = this.processSlotOptions(
            this.props.slotDuration,
            t.snapDuration
          ),
          m = u.leftToIndex(e),
          v = p.positions.topToIndex(c);
        if (null == m || null == v) return null;
        {
          let e = this.props.cells[m],
            t = p.positions.tops[v],
            n = p.positions.getHeight(v),
            r = (c - t) / n,
            i = v * g + Math.floor(r * g),
            o = this.props.cells[m].date,
            s = pt(h.slotMinTime, mt(f, i)),
            a = d.add(o, s),
            l = d.add(a, f);
          return {
            dateProfile: h,
            dateSpan: Object.assign(
              { range: { start: a, end: l }, allDay: !1 },
              e.extraDateSpan
            ),
            dayEl: u.els[m],
            rect: {
    ...
    class oc extends ls {
      ...
      render() {
        let { props: n, context: r } = this,
          { dateProfile: i, dayTableModel: o } = n,
          { nowIndicator: s, nextDayThreshold: a } = r.options,
          l = this.buildDayRanges(o, i, r.dateEnv);
        return p(Rs, { unit: s ? 'minute' : 'day' }, (e, t) =>
          p(
            rc,
            Object.assign(
              ...
              this.slicer.sliceProps(n, i, null, r, l),
              {
                ...
                nowDate: e,
                nowIndicatorSegs: s && this.slicer.sliceNowDate(e, i, a, r, l),
                todayRange: t,
    ...
    class hc extends Gn {
      ...
      render() {
        let { theme: t, dateEnv: e, options: n, viewApi: r } = this.context,
          ...
          a = this.state['textId'],
          l = Fi(o, s),
          c = n.listDayFormat ? e.format(o, n.listDayFormat) : '',
          d = n.listDaySideFormat ? e.format(o, n.listDaySideFormat) : '',
          u = Object.assign(
            {
              date: e.toDate(o),
              view: r,
              ...
              text: c,
              sideText: d,
              navLinkAttrs: qi(this.context, o),
              sideNavLinkAttrs: qi(this.context, o, 'day', !1),
            },
            l
          );
        return p(
          ...
          {
            elTag: 'tr',
            elClasses: ['fc-list-day', ...Vi(l, t)],
            elAttrs: { 'data-date': Wt(o) },
            renderProps: u,
            generatorName: 'dayHeaderContent',
    ...
    const xc = an({ hour: 'numeric', minute: '2-digit', meridiem: 'short' });
    class pc extends Gn {
      render() {
        let { props: e, context: r } = this,
          t = r['options'],
          { seg: i, timeHeaderId: n, eventHeaderId: o, dateHeaderId: s } = e,
          a = t.eventTimeFormat || xc;
        return p(
          so,
          Object.assign({}, e, {
            elTag: 'tr',
            ...
            defaultGenerator: () => {
              {
                var t = i,
                  n = r;
                let e = bi(t, n);
                return p('a', Object.assign({}, e), t.eventRange.def.title);
              }
            },
            seg: i,
            timeText: '',
              ...
              (function (i, o, s, a, l) {
                ...
                if (!1 === c.displayEventTime) return null;
                {
                  ...
                  if (
                    (t.allDay
                      ? (r = !0)
                      : ur(i.eventRange.range)
                        ? i.isStart
                          ? (e = pi(i, o, s, null, null, n.range.start, i.end))
                          : i.isEnd
                            ? (e = pi(
                                i,
                                o,
                    ...
                    let e = { text: s.options.allDayText, view: s.viewApi };
                    return p(Jn, {
                      elTag: 'td',
                  ...
                  return p('td', { className: 'fc-list-event-time' }, e);
                }
              })(i, a, r, n, s),
              p(
                'td',
      ...
      views: {
        list: {
          component: class extends ls {
            ...
            renderSegList(e, l) {
              let { theme: t, options: c } = this.context,
                {
                  timeHeaderId: d,
                  eventHeaderId: u,
                  dateHeaderIdRoot: h,
                ...
                for (let r = 0; r < f.length; r += 1) {
                  ...
                  if (n) {
                    let e = Wt(l[r]),
                      t = h + '-' + e;
                    s.push(
                      p(hc, { key: e, cellId: t, dayDate: l[r], todayRange: o })
                    ),
                      (n = di(n, c.eventOrder));
                    for (var a of n)
                      s.push(
                        p(
                          ...
                          Object.assign(
                            {
                              key: e + ':' + a.eventRange.instance.instanceId,
                              seg: a,
                              isDragging: !1,
                              isResizing: !1,
                              isDateSelecting: !1,
                ...
                return p(
                  ...
                  p(
                    ...
                    p(
                      'tr',
                      null,
                      p('th', { scope: 'col', id: d }, c.timeHint),
                      p('th', { scope: 'col', 'aria-hidden': !0 }),
                      p('th', { scope: 'col', id: u }, c.eventHint)
                    )
                  ),
                  p('tbody', null, s)
                );
          ...
          component: class extends ls {
            ...
            render() {
              const { context: e, props: r, state: t } = this,
                n = e['options'],
                { clientWidth: i, clientHeight: o } = t,
                s = t.monthHPadding || 0,
                a =
                  Math.min(
                    null != i ? Math.floor(i / (n.multiMonthMinWidth + s)) : 1,
              ...
              return p(
                ...
                u.map((e, t) => {
                  const n = Lt(e.currentRange.start);
                  return p(
                    Sc,
                    Object.assign({}, r, {
                      key: n,
            ...
            flushScrollReset() {
              if (this.needsScrollReset && null != this.state.monthHPadding) {
                const e = this.props.dateProfile['currentDate'],
    ...
    return (
      Na.push(Tl, $l, Ec, _c, Mc),
      (t.Calendar = class extends Ni {
        constructor(e, t = {}) {
          var n;
          super(),
            (this.isRendering = !1),
            ...
            (n = e),
            n.isConnected && _e(n.getRootNode()),
            (this.el = e),
        ...
        setClassNames(t) {
          if (!St(t, this.currentClassNames)) {
      ...
      (t.Draggable = class {
        constructor(e, t = {}) {
          (this.handlePointerDown = (e) => {
            ...
            (t.minDistance =
              null != n ? n : e.isTouch ? 0 : F.eventDragMinDistance),
              (t.delay = e.isTouch ? (null != r ? r : F.longPressDelay) : 0);
          }),
            (this.handleDragStart = (e) => {
              e.isTouch &&
                this.dragging.delay &&
      ...
      (t.formatRange = function (e, t, n) {
        ...
        return o && s
          ? r.formatRange(o.marker, s.marker, i, {
              ...
              defaultSeparator: F.defaultRangeSeparator,
            })
          : '';
      }),
      (t.globalLocales = Ls),
      ...
      (() => {
        ...
        var n = {
            ...
            737: (e, n) => {
              ...
              (t.prototype.createCollection = function (e, t) {
                var n;
                e.push({
                  id:
                    (null == (n = null == t ? void 0 : t.el) ? void 0 : n.id) ||
                    e.length + 1,
                  element: t,
                });
              }),
                (t.prototype.fireEvent = function (e, t) {
                  if (
                    (void 0 === t && (t = null), this.events.hasOwnProperty(e))
                  )
                ...
                p =
                    ...
                    (this.el.style.display = 'none'),
                      this.el.children &&
                        Array.from(this.el.children)
                          ...
                          .forEach(function (e) {
                            var t = e.getAttribute('data-hs-select-option');
                            n.selectOptions = c(
                              c([], n.selectOptions, !0),
                              [
                                {
                      ...
                      this.isMultiple &&
                        ((e = Array.from(this.el.options).filter(function (e) {
                          return e.selected;
                        })),
                        e) &&
                        ((t = []),
                  ...
                  (e.prototype.buildTags = function () {
                    (this.tags = document.createElement('div')),
                      ...
                      this.tagsClasses &&
                        (0, d.classToClassList)(this.tagsClasses, this.tags),
                      this.buildTagsInput(),
                      this.buildTagsItems(),
                      this.setTagsItems(),
                  ...
                  (e.prototype.buildTagsItem = function (t) {
                    var e,
                      ...
                      i,
                      o = this,
                      s = this.getItemByValue(t),
                      a = document.createElement('div');
                    this.tagsItemClasses &&
                      (0, d.classToClassList)(this.tagsItemClasses, a),
                      this.tagsItemTemplate &&
                        ((e = (0, d.htmlToElement)(this.tagsItemTemplate)),
                        a.append(e)),
                      null != (i = null == s ? void 0 : s.options) &&
                        i.icon &&
                        ((i = (0, d.htmlToElement)(
                          null == (i = null == s ? void 0 : s.options)
                            ? void 0
                        ...
                        (r = e
                          ? e.querySelector('[data-icon]')
                          : document.createElement('span')).append(i),
                        e || a.append(r)),
                      !e ||
                        !e.querySelector('[data-icon]') ||
                        (null != (i = null == s ? void 0 : s.options) &&
                          i.icon) ||
                        e.querySelector('[data-icon]').classList.add('hidden'),
                      ((r = e
                        ? e.querySelector('[data-title]')
                        : document.createElement('span')).textContent =
                        s.title || ''),
                      e || a.append(r),
                      e
                        ? (n = e.querySelector('[data-remove]'))
                      ...
                      n.addEventListener('click', function () {
                        (o.value = o.value.filter(function (e) {
                          ...
                          o.unselectMultipleItems(),
                          o.setTagsItems(),
                          o.selectMultipleItems();
                      }),
                      this.tagsItems.append(a);
                  }),
                  ...
                  (e.prototype.buildTagsInput = function () {
                    ...
                    (this.tagsInput = document.createElement('input')),
                      ...
                      this.tagsInput.addEventListener(
                        'input',
                        (0, d.debounce)(function (e) {
                          return n.searchOptions(e.target.value);
                        })
                      ),
                      this.tagsInput.addEventListener('keydown', function (e) {
                        if ('Enter' === e.key && n.isAddTagOnEnter) {
                          var t = e.target.value;
                          if (
                            n.selectOptions.find(function (e) {
                              return e.val === t;
                            })
                          )
                            return !1;
                          n.addSelectOption(t, t),
                            n.buildOption(t, t),
                            n.dropdown
                              .querySelector('[data-value="'.concat(t, '"]'))
                              .click(),
                            n.resetTagsInputField(),
                            n.close();
                        }
                      }),
                  ...
                  (e.prototype.buildDropdown = function () {
                    var n = this;
                    (this.dropdown = (0, d.htmlToElement)(
                      ...
                      this.selectOptions &&
                        this.selectOptions.forEach(function (e, t) {
                          return n.buildOption(
                            e.title,
                            e.val,
                            e.options,
                            ''.concat(t)
                  ...
                  (e.prototype.buildSearch = function () {
                    var e,
                      t = this;
                    (this.searchWrapper = (0, d.htmlToElement)(
                      ...
                      (e || this.searchWrapper).append(this.search),
                      this.dropdown.append(this.searchWrapper);
                  }),
                  (e.prototype.buildOption = function (e, t, n, r) {
                    var i = this,
                      o = (void 0 === r && (r = '1'), null),
                      s = (0, d.htmlToElement)(this.optionTag || '<div></div>');
                    s.setAttribute('data-value', t),
                      s.setAttribute('data-title-value', e),
                      s.setAttribute('tabIndex', r),
                      s.classList.add('cursor-pointer'),
                      this.optionTemplate &&
                        ((o = (0, d.htmlToElement)(this.optionTemplate)),
                        s.append(o)),
                      o
                        ? (o.querySelector('[data-title]').textContent =
                            e || '')
                        : (s.textContent = e || ''),
                      n &&
                        (n.icon &&
                          ((r = (0, d.htmlToElement)(n.icon)),
                          r.classList.add('mw-full'),
                          o
                            ? o.querySelector('[data-icon]').append(r)
                            : ((e = (0, d.htmlToElement)('<div></div>')),
                              this.iconClasses &&
                                (0, d.classToClassList)(this.iconClasses, e),
                              e.append(r),
                              s.append(e))),
                        n.description) &&
                        (o
                          ...
                          : ((r = (0, d.htmlToElement)('<div></div>')),
                            (r.textContent = n.description),
                            ...
                            s.append(r))),
                      !o ||
                        !o.querySelector('[data-icon]') ||
                        n ||
                        (null != n && n.icon) ||
                        o.querySelector('[data-icon]').classList.add('hidden'),
                      this.value &&
                        (this.isMultiple
                      ...
                      s.addEventListener('click', function () {
                        return i.onSelectOption(t);
                      }),
                      this.optionClasses &&
                        (0, d.classToClassList)(this.optionClasses, s),
                      this.dropdown && this.dropdown.append(s);
                  }),
                  (e.prototype.destroyOption = function (e) {
                    e = this.dropdown.querySelector(
                      '[data-value="'.concat(e, '"]')
                    );
                    if (!e) return !1;
                    e.remove();
                  }),
                  (e.prototype.buildOriginalOption = function (e, t, n) {
                    var r = (0, d.htmlToElement)('<option></option>');
                  ...
                  (e.prototype.destroyOriginalOption = function (e) {
                    e = this.el.querySelector('[value="'.concat(e, '"]'));
                    if (!e) return !1;
                    e.remove();
                  }),
                    ...
                    this.clearSelections(),
                      this.isMultiple
                        ? ((this.value = this.value.includes(t)
                            ...
                            : c(c([], Array.from(this.value), !0), [t], !1)),
                          this.selectMultipleItems())
                        : ((this.value = t), this.selectSingleItem()),
                      this.setNewValue(),
                      this.fireEvent('change', this.value),
                      (0, d.dispatch)('change.hs.select', this.el, this.value),
                  ...
                  (e.prototype.addSelectOption = function (e, t, n) {
                    this.selectOptions = c(
                      c([], this.selectOptions, !0),
                      [{ title: e, val: t, options: n }],
                      !1
                    );
                  }),
                  ...
                  (e.prototype.clearSelections = function () {
                    Array.from(this.dropdown.children).forEach(function (e) {
                  ...
                  (e.prototype.stringFromValue = function () {
                    var t = this,
                      n = [];
                    return (
                      this.selectOptions.forEach(function (e) {
                        t.isMultiple
                          ? t.value.includes(e.val) && n.push(e.title)
                          : t.value === e.val && n.push(e.title);
                      }),
                      this.toggleCountText &&
                      '' !== this.toggleCountText &&
                      n.length >= this.toggleCountTextMinItems
                        ? ''.concat(n.length, ' ').concat(this.toggleCountText)
                        : n.join(', ')
                    );
                  }),
                  ...
                  (e.prototype.searchOptions = function (t) {
                    this.searchNoResult &&
                      ...
                      (this.searchNoResult = (0, d.htmlToElement)(
                        '<span></span>'
                      )),
                  ...
                  (e.prototype.eraseToggleIcon = function () {
                    var e = this.toggle.querySelector('[data-icon]');
                    e && ((e.innerHTML = null), e.classList.add('hidden'));
                  }),
                  (e.prototype.eraseToggleTitle = function () {
                    var e = this.toggle.querySelector('[data-title]');
                    e
                  ...
                  (e.prototype.close = function () {
                    ...
                    (this.animationInProcess = !0),
                      ...
                      (0, d.afterTransition)(this.dropdown, function () {
                        t.dropdown.classList.add('hidden'),
                          t.hasSearch &&
                            ((t.search.value = ''),
                            t.search.dispatchEvent(
                      ...
                      null !=
                        ...
                        e.classList.remove('hs-select-option-highlighted'),
                      (this.isOpened = !1);
                  }),
                    ...
                    var r = this,
                      ...
                      t = function (e) {
                        var t = e.title,
                          n = e.val,
                          e = e.options;
                        r.selectOptions.some(function (e) {
                          return e.val === n;
                        }) ||
                          (r.addSelectOption(t, n, e),
                          r.buildOption(t, n, e, i),
                          r.buildOriginalOption(t, n, e));
                      };
                    Array.isArray(e)
                      ? e.forEach(function (e) {
                          t(e);
                  ...
                  (e.prototype.removeOption = function (e) {
                    var n = this,
                      t = function (t) {
                        n.selectOptions.some(function (e) {
                          return e.val === t;
                        }) &&
                          (n.removeSelectOption(t),
                          n.destroyOption(t),
                          n.destroyOriginalOption(t),
                          n.value === t) &&
                          ((n.value = null),
                          n.eraseToggleTitle(),
                          n.eraseToggleIcon());
                      ...
                      document
                        ...
                        .forEach(function (t) {
                          ...
                          window.$hsSelectCollection.find(function (e) {
                            return (
                              (null == (e = null == e ? void 0 : e.element)
                                ? void 0
                                : e.el) === t
                            );
                          }) ||
                            ((n = t.getAttribute('data-hs-select')),
                            (n = n ? JSON.parse(n) : {}),
                            new e(t, n));
                        }),
                      window.$hsSelectCollection &&
                  ...
                  (e.closeCurrentlyOpened = function (e) {
                    void 0 === e && (e = null),
                      e.closest('.hs-select.active') ||
                        ((e =
                          window.$hsSelectCollection.filter(function (e) {
                            return e.element.isOpened;
                          }) || null),
                        e &&
                          e.forEach(function (e) {
                            e.element.close();
                  ...
                  (e.accessibility = function (e) {
                    var t = window.$hsSelectCollection.find(function (e) {
                      return e.element.isOpened;
                    });
                    if (
                      t &&
                      h.SELECT_ACCESSIBILITY_KEY_SET.includes(e.code) &&
                      !e.metaKey
                    )
                      switch (
                        (console.log(t),
                  ...
                  (e.onArrow = function (e) {
                    void 0 === e && (e = !0);
                    var t = window.$hsSelectCollection.find(function (e) {
                      return e.element.isOpened;
                    });
                    if (t) {
                      t = t.element.dropdown;
                      if (!t) return !1;
                      var e = (
                          e
                            ? Array.from(
                        ...
                        n = t.querySelector('.hs-select-option-highlighted'),
                        t =
                          (n ||
                            e[0].classList.add('hs-select-option-highlighted'),
                      ...
                      t + 1 < e.length && t++,
                        ...
                        e[t].classList.add('hs-select-option-highlighted');
                    }
                  }),
                  (e.onTab = function (e) {
                    void 0 === e && (e = !0);
                    var t,
                      n,
                      r = window.$hsSelectCollection.find(function (e) {
                        return e.element.isOpened;
                      });
                    if (r)
                      return (
                        (n = r.element.dropdown),
                        !!n &&
                          ((e = (
                            e
                              ? Array.from(
                          ...
                          n + 1 < e.length
                            ...
                            : (t &&
                              ...
                              r.element.close(),
                              r.element.toggle.focus(),
                              !1))
                      );
                  }),
                  (e.onStartEnd = function (e) {
                    void 0 === e && (e = !0);
                    var t = window.$hsSelectCollection.find(function (e) {
                      return e.element.isOpened;
                    });
                    if (t) {
                      ...
                      (e = (
                        ...
                        (t = t.querySelector('.hs-select-option-highlighted'));
                      e.length &&
                        (e[0].focus(),
                        t && t.classList.remove('hs-select-option-highlighted'),
                        e[0].classList.add('hs-select-option-highlighted'));
                    }
                  }),
                  (e.onEnter = function (e) {
                    var t,
                      n,
                      r = e.target.previousSibling;
                    window.$hsSelectCollection.find(function (e) {
                      return e.element.el === r;
                    })
                      ? ((t = window.$hsSelectCollection.find(function (e) {
                          return e.element.isOpened;
                        })),
                        (n = window.$hsSelectCollection.find(function (e) {
                          return e.element.el === r;
                        })),
                        t.element.close(),
                        n.element.open())
                      : (n = window.$hsSelectCollection.find(function (e) {
                        ...
                        n.element.onSelectOption(e.target.dataset.value || '');
                  }),
                  e);
              function e(e, t) {
                var n = o.call(this, e, t) || this,
                  e = e.getAttribute('data-hs-select'),
                  e = e ? JSON.parse(e) : {},
                  e = l(l({}, e), t);
                return (
                  (n.value =
                    (null == e ? void 0 : e.value) || n.el.value || null),
                  (n.placeholder =
                    (null == e ? void 0 : e.placeholder) || 'Select...'),
                  (n.hasSearch = (null == e ? void 0 : e.hasSearch) || !1),
                  (n.mode = (null == e ? void 0 : e.mode) || 'default'),
                  (n.viewport =
                    void 0 !== (null == e ? void 0 : e.viewport)
                      ? document.querySelector(null == e ? void 0 : e.viewport)
                      : null),
                  (n.isOpened = Boolean(null == e ? void 0 : e.isOpened) || !1),
                  (n.isMultiple = n.el.hasAttribute('multiple') || !1),
                  (n.isDisabled = n.el.hasAttribute('disabled') || !1),
                  (n.toggleTag = (null == e ? void 0 : e.toggleTag) || null),
                  (n.toggleClasses =
                    (null == e ? void 0 : e.toggleClasses) || null),
                  (n.toggleCountText =
                    (null == e ? void 0 : e.toggleCountText) || null),
                  (n.toggleCountTextMinItems =
                    (null == e ? void 0 : e.toggleCountTextMinItems) || 1),
                  (n.tagsClasses =
                    (null == e ? void 0 : e.tagsClasses) || null),
                  (n.tagsItemTemplate =
                    (null == e ? void 0 : e.tagsItemTemplate) || null),
                  (n.tagsItemClasses =
                    (null == e ? void 0 : e.tagsItemClasses) || null),
                  (n.tagsInputClasses =
                    (null == e ? void 0 : e.tagsInputClasses) || null),
                  (n.dropdownTag =
                    (null == e ? void 0 : e.dropdownTag) || null),
                  (n.dropdownClasses =
                    (null == e ? void 0 : e.dropdownClasses) || null),
                  (n.dropdownDirectionClasses =
                    (null == e ? void 0 : e.dropdownDirectionClasses) || null),
                  (n.dropdownSpace =
                    (null == e ? void 0 : e.dropdownSpace) || 10),
                  (n.searchWrapperTemplate =
                    (null == e ? void 0 : e.searchWrapperTemplate) || null),
                  (n.searchWrapperClasses =
                    (null == e ? void 0 : e.searchWrapperClasses) ||
                    'bg-white p-2 sticky top-0'),
                  (n.searchClasses =
                    (null == e ? void 0 : e.searchClasses) ||
                  ...
                  (n.searchPlaceholder =
                    (null == e ? void 0 : e.searchPlaceholder) || 'Search...'),
                  (n.searchNoResultText =
                    (null == e ? void 0 : e.searchNoResultText) ||
                    'No options found...'),
                  (n.searchNoResultClasses =
                    (null == e ? void 0 : e.searchNoResultClasses) ||
                    'px-4 text-sm'),
                  (n.optionTemplate =
                    (null == e ? void 0 : e.optionTemplate) || null),
                  (n.optionTag = (null == e ? void 0 : e.optionTag) || null),
                  (n.optionClasses =
                    (null == e ? void 0 : e.optionClasses) || null),
                  (n.descriptionClasses =
                    (null == e ? void 0 : e.descriptionClasses) || null),
                  (n.iconClasses =
                    (null == e ? void 0 : e.iconClasses) || null),
                  (n.isAddTagOnEnter =
                    null == (t = null == e ? void 0 : e.isAddTagOnEnter) || t),
            ...
            969: function (e, t) {
              var o = this,
                n =
                  ...
                  (t.isEnoughSpace = function (e, t, n, r, i) {
                    void 0 === n && (n = 'auto'),
                      void 0 === r && (r = 10),
                      void 0 === i && (i = null);
                    var t = t.getBoundingClientRect(),
                      ...
                      a = o ? t.top - o.top : t.top,
                      i = (i ? o.bottom : s) - t.bottom,
                      o = e.clientHeight + r;
                    return 'bottom' === n
                      ? o <= i
                      : 'top' === n
        ...
        var r = {
            ...
            371: function (t, r, i) {
                ...
                c =
                  ...
                  (e.prototype.changeValue = function (e) {
                    ...
                    (t.inputValue = this.inputValue),
                      ...
                      (0, l.dispatch)('change.hs.inputNumber', this.el, t);
                  }),
                  (e.prototype.disableButtons = function (e) {
                    void 0 === e && (e = 'all'),
                      'all' === e
                  ...
                  (e.prototype.enableButtons = function (e) {
                    void 0 === e && (e = 'all'),
                      'all' === e
                        ? (('BUTTON' !== this.increment.tagName &&
                            'INPUT' !== this.increment.tagName) ||
                  ...
                  e);
              function e(e, t) {
                e = s.call(this, e, t) || this;
                return (
                  (e.input =
                    e.el.querySelector('[data-hs-input-number-input]') || null),
                  (e.increment =
                    e.el.querySelector('[data-hs-input-number-increment]') ||
                    null),
                  (e.decrement =
                    e.el.querySelector('[data-hs-input-number-decrement]') ||
                    null),
                  (e.inputValue = e.input ? parseInt(e.input.value) : 0),
                  e.init(),
                  e
                );
              }
              window.addEventListener('load', function () {
                ...
                'undefined' != typeof window && (window.HSInputNumber = c),
                (r.default = c);
            },
            969: function (e, t) {
              var o = this,
    ...
    !(function (n) {
      ...
      t && t.fn && t.fn.select2 && t.fn.select2.amd && (e = t.fn.select2.amd),
          ...
          (o = function (e, t, n, r) {
            ...
            if ('undefined' == d || 'function' == d) {
              for (
                ...
                if ('require' === (o = (s = p(t[a], u)).f)) c[a] = f.require(e);
                else if ('exports' === o) (c[a] = f.exports(e)), (l = !0);
                else if ('module' === o) i = c[a] = f.module(e);
                else if (w(g, o) || w(m, o) || w(y, o)) c[a] = D(o);
                else {
                  if (!s.p) throw new Error(e + ' missing ' + o);
                  s.p.load(s.n, x(r, !0), A(o), {}), (c[a] = g[o]);
                }
              (d = n ? n.apply(g[e], c) : void 0),
                e &&
                  (i && i.exports !== h && i.exports !== g[e]
                    ? (g[e] = i.exports)
                    : (d === h && l) || (g[e] = d));
            } else e && (g[e] = n);
          }),
        ...
        e.define('select2/utils', ['jquery'], function (o) {
          function u(e) {
            var t,
              ...
              r = [];
            for (t in n)
              'function' == typeof n[t] && 'constructor' !== t && r.push(t);
            return r;
          }
          function e() {
            this.listeners = {};
          ...
          return (
            ...
            (r.copyNonInternalCssClasses = function (e, t) {
              var n = e.getAttribute('class').trim().split(/\s+/),
                ...
                t = t.getAttribute('class').trim().split(/\s+/),
          ...
          return (
            ...
            (i.prototype.option = function (e) {
              ...
              if (e.children) {
                ...
                d.append(a), i.append(s), i.append(d);
              ...
              this.$results.attr('id', n),
                ...
                t.on('results:next', function () {
                  var e,
                    ...
                    r = i.$results.find('.select2-results__option--selectable'),
                    n = r.index(n) + 1;
                  n >= r.length ||
                    ((r = r.eq(n)),
                    r.trigger('mouseenter'),
                    (e = i.$results.offset().top + i.$results.outerHeight(!1)),
                    (r = r.offset().top + r.outerHeight(!1)),
                    (t = i.$results.scrollTop() + r - e),
                    0 === n
                      ? i.$results.scrollTop(0)
                      : e < r && i.$results.scrollTop(t));
                }),
              ...
              (r.prototype.update = function (e) {
                ...
                0 !== e.length
                  ? ((e = e[0]),
                    ...
                    t.empty().append(n),
                    (n = e.title || e.text),
                    n ? t.attr('title', n) : t.removeAttr('title'))
                  : this.clear();
              }),
              r
            );
                ...
                if (!this.isDisabled()) {
                  ...
                  if (0 !== n.length) {
                    ...
                    var r = a.GetData(n[0], 'data'),
                      i = this.$element.val(),
                      o = (this.$element.val(this.placeholder.id), { data: r });
              ...
              (e.prototype.render = function (e) {
                var t = n(
                  ...
                  t =
                    ...
                    e.call(this));
                return (
                  this._transferTabIndex(), t.append(this.$searchContainer), t
                );
              }),
              (e.prototype.bind = function (e, t, n) {
                var r = this,
                  ...
                  e =
                    (e.call(this, t, n),
                    r.$search.attr('aria-describedby', o),
                    t.on('open', function () {
        ...
        e.define('select2/data/tags', ['jquery'], function (t) {
          ...
          return (
            (e.prototype.query = function (t, c, d) {
              var u = this;
              this._removeOldTags(),
                null != c.term && null == c.page
                  ? t.call(this, c, function e(t, n) {
            ...
            (e.prototype.createTag = function (e, t) {
              return null == t.term || ((t = t.term.trim()), '' === t)
                ? null
                : { id: t, text: t };
            }),
          ...
          function (
            ...
            return (
              (n.prototype.apply = function (e) {
                ...
                null == (e = l.extend(!0, {}, this.defaults, e)).dataAdapter &&
                  ...
                  0 < e.minimumInputLength &&
                    (e.dataAdapter = g.Decorate(e.dataAdapter, x)),
                  0 < e.maximumInputLength &&
                    (e.dataAdapter = g.Decorate(e.dataAdapter, S)),
                  0 < e.maximumSelectionLength &&
                    (e.dataAdapter = g.Decorate(e.dataAdapter, _)),
                  e.tags && (e.dataAdapter = g.Decorate(e.dataAdapter, w)),
                  (null == e.tokenSeparators && null == e.tokenizer) ||
                    (e.dataAdapter = g.Decorate(e.dataAdapter, E))),
                  null == e.resultsAdapter &&
                    ((e.resultsAdapter = o),
                    null != e.ajax &&
                      (e.resultsAdapter = g.Decorate(e.resultsAdapter, T)),
                    null != e.placeholder &&
                      (e.resultsAdapter = g.Decorate(e.resultsAdapter, A)),
                    e.selectOnClose) &&
                    (e.resultsAdapter = g.Decorate(e.resultsAdapter, I)),
                  null == e.dropdownAdapter &&
                    (e.multiple
                      ? (e.dropdownAdapter = C)
                      : ((t = g.Decorate(C, D)), (e.dropdownAdapter = t)),
                    0 !== e.minimumResultsForSearch &&
                      (e.dropdownAdapter = g.Decorate(e.dropdownAdapter, M)),
                    e.closeOnSelect &&
                      (e.dropdownAdapter = g.Decorate(e.dropdownAdapter, R)),
                    null != e.dropdownCssClass &&
                      (e.dropdownAdapter = g.Decorate(e.dropdownAdapter, O)),
                    (e.dropdownAdapter = g.Decorate(e.dropdownAdapter, k))),
                  null == e.selectionAdapter &&
                    (e.multiple
                      ? (e.selectionAdapter = c)
                      : (e.selectionAdapter = s),
                    null != e.placeholder &&
                      (e.selectionAdapter = g.Decorate(e.selectionAdapter, d)),
                    e.allowClear &&
                      (e.selectionAdapter = g.Decorate(e.selectionAdapter, u)),
                    e.multiple &&
                      (e.selectionAdapter = g.Decorate(e.selectionAdapter, h)),
                    null != e.selectionCssClass &&
                      (e.selectionAdapter = g.Decorate(e.selectionAdapter, p)),
                    (e.selectionAdapter = g.Decorate(e.selectionAdapter, f))),
                ...
                this.defaults = {
                  ...
                  matcher: function e(t, n) {
                    ...
                    if (n.children && 0 < n.children.length) {
                      for (
                        var r = l.extend(!0, {}, n), i = n.children.length - 1;
                        0 <= i;
                        i--
                      )
              ...
              (n.prototype._resolveLanguage = function (e) {
                ...
                for (
                  var t, n = Array.isArray(e) ? e : [e], r = [], i = 0;
                  i < n.length;
                  i++
                )
                  r.push(n[i]),
              ...
              (n.prototype._processTranslations = function (e, t) {
                for (var n = new m(), r = 0; r < e.length; r++) {
                  var i = new m(),
                    o = e[r];
                  if ('string' == typeof o)
                    try {
                  ...
                  else i = l.isPlainObject(o) ? new m(o) : o;
                  n.extend(i);
                }
                return n;
              }),
              (n.prototype.set = function (e, t) {
                var n = {},
                  e = ((n[l.camelCase(e)] = t), g._convertData(n));
          ...
          function (t, i, o, r) {
            var s = function (e, t) {
              ...
              var t = e.attr('tabindex') || 0,
                ...
                t =
                  ((this.dataAdapter = new t(e, this.options)), this.render()),
                n =
            ...
            return (
              ...
              (s.prototype._resolveWidth = function (e, t) {
                ...
                if ('resolve' == t)
                  return (
                    (r = this._resolveWidth(e, 'style')),
                    null != r ? r : this._resolveWidth(e, 'element')
                  );
                if ('element' == t)
                  return (r = e.outerWidth(!1)), r <= 0 ? 'auto' : r + 'px';
                if ('style' != t)
      ...
      function D(e) {
        var t;
        if (
          (w(m, e) && ((t = m[e]), delete m[e], (y[e] = !0), o.apply(h, t)),
          w(g, e) || w(y, e))
        )
          return g[e];
      ...
      (calendar = new FullCalendar.Calendar(e, {
        ...
        eventSources: [
          function (e, t, r) {
            ajaxCall(
              ...
              function (e, t, n) {
                console.error('Erreur lors du chargement des événements:', n),
                  r(n);
              }
            );
          },
        ...
        datesSet: function () {
          document
            ...
            .forEach(function (e) {
              if (!e.querySelector('.calendarLegend')) {
                ...
                (i.className =
                  ...
                  n.forEach((e) => {
                    const t = document.createElement('div'),
                      n =
                        ((t.className = 'flex items-center'),
                        document.createTextNode(e.text + ' : ')),
                      r = (t.appendChild(n), document.createElement('span'));
                    (r.className = `w-4 h-4 inline-block ${e.color} border border-slate-200 ml-1`),
                      t.appendChild(r),
                      i.appendChild(t);
                  }),
                  t.appendChild(i),
        ...
        customButtons: {
          ...
          SearchIpunt: {
            text: 'Rechercher',
            click: function () {
              openModal('SearchListEventModal'), inputField.focus();
            },
          },
        },
        buttonText: {
        ...
        eventContent: function (e) {
          let t = e.event.extendedProps.bookings;
          const n = services_list.reduce(
            (e, t) => (
              (e[t.Service_id] = {
                Title: t.Title,
                fullblocked: t.fullblocked,
              }),
              e
            ),
            {}
          ...
          let o = null,
            ...
            i =
              (Object.entries(t).forEach(([, e]) => {
                let t = e.Date == e.FirstDay.substring(0, 10),
                  r = e.Date == e.LastDay.substring(0, 10),
                  i = e.services_titles,
                  n =
                    (Object.entries(u).forEach(([e, t]) => {
                      if (t.Title === i)
                        if ('1' !== t.fullblocked || r) {
                          if (!r) {
                            for (var n in u)
                              '1' === u[n].fullblocked && delete u[n];
                            delete u[e];
                          }
                        } else
                ...
                (d =
                  0 < n
                    ? ((c = 'bg-green-500 dark:bg-green-800'), 'available')
                    : ((c =
                        n <= 0
              ...
              (r.className = 'absolute w-full h-full'),
              document.createElement('div')),
            h =
              ((i.className =
                'relative h-full pt-2 pl-1 flex justify-start items-start ' +
                c),
              r.appendChild(i),
              document.createElement('div'));
          return (
            (h.className =
              'group relative flex justify-center items-end w-full h-full text-black dark:text-white overflow-hidden ' +
              (e.isPast ? 'opacity-30' : '')),
            h.appendChild(r),
            s && h.appendChild(s),
            o && h.appendChild(o),
        ...
        eventClick: function (e) {
          const t = e.event.startStr;
          showDateCalendarFromClic(t);
        },
...
<path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>
  ...
  send_ico = `<svg class="w-4 h-4 mr-2 text-slate-400 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 17 8 2L9 1 1 19l8-2Zm0 0V9"/>
</svg>`,
  download_ico = `<svg class="w-4 h-4 mr-2 text-slate-400 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 19">
      ...
      document
        ...
        .addEventListener('click', function (e) {
          return (
            e.preventDefault(),
            verifyToken(!0),
            showBanner('Token étendu de 12h00', !0)
          );
        }),
        verifyToken();
    else if (!e) return void (window.location.href = baseurl + 'auth');
    e &&
      ((t = document.getElementById('loginForm')), t) &&
      t.addEventListener('submit', function (e) {
        ...
        e.forEach(function (e, t) {
          ...
          ajaxCall(
            ...
            function (e) {
              e.jwt
                ? (localStorage.setItem('token', e.jwt),
                  showBanner('Connexion réussi', !0),
                  setTimeout(() => {
                    window.location.href = baseurl;
                  }, 1500))
                : alert(e.error || 'Échec de la connexion');
            },
            function (e, t, n) {
              e.success
                ? (showBanner('Échec de la requete de connexion : ' + n, !1),
                  'function' == typeof errorCallback
                    ? errorCallback(e, t, n || 'Erreur inconnue')
                    : (console.error(
